...
class GDPRSettings(TranslatableModel):
    shop = models.OneToOneField("E-Commerce.Shop", related_name="gdpr_settings")
    ...
    def set_default_content(self):
        ...
        for code, name in settings.LANGUAGES:
            ...
            self.cookie_banner_content = settings.E-Commerce_GDPR_DEFAULT_BANNER_STRING
            self.cookie_privacy_excerpt = settings.E-Commerce_GDPR_DEFAULT_EXCERPT_STRING
            self.save()
...
class GDPRCookieCategory(TranslatableModel):
    shop = models.ForeignKey("E-Commerce.Shop", related_name="gdpr_cookie_categories")
...
class GDPRUserConsentDocument(models.Model):
    page = models.ForeignKey("E-Commerce_simple_cms.Page")
