...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('E-Commerce', '0047_contactgroup_shop'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='price_display_options', to='E-Commerce.ContactGroup'),
        ),
        migrations.AddField(
            model_name='contactgrouppricedisplay',
            name='shop',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='price_display_options', to='E-Commerce.Shop'),
        ),
