...
from E-Commerce.utils import i18n
from E-Commerce.reports.forms import DateRangeChoices
from E-Commerce.reports.utils import parse_date_range_preset
...
def test_parse_date_range_presets():
    ...
    with mock.patch("E-Commerce.utils.dates.local_now", side_effect=local_now):
...
def test_parse_date_range_presets_running_week(locale):
    ...
    with mock.patch("E-Commerce.utils.i18n.get_current_babel_locale", side_effect=get_locale):
