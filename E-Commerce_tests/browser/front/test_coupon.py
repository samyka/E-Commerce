...
from E-Commerce.core.models import Category, CategoryStatus, Product
...
def _add_product_to_basket_from_category(live_server, browser, first_category, shop):
    url = reverse("E-Commerce:category", kwargs={"pk": first_category.pk, "slug": first_category.slug})
