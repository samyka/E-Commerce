...
const Picotable = (function (m, storage) {
    ...
    function getMobileFilterModal(ctrl) {
        ...
        return m("div.mobile-filters.E-Commerce-modal-bg", { key: "mobileFilterModal" }, [
            m("div.E-Commerce-modal-container", [
                m("div.E-Commerce-modal-header.d-flex.align-items-center", [
    ...
    function buildEmptyState(ctrl) {
        ...
        const button = $('.E-Commerce-toolbar').find('.btn-primary');
