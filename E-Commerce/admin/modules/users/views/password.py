...
from E-Commerce.front.apps.auth.views import RecoverPasswordForm
...
class UserChangePasswordView(UpdateView):
    ...
    template_name = "E-Commerce/admin/users/change_password.jinja"
...
class UserResetPasswordView(DetailView):
    model = settings.AUTH_USER_MODEL
    template_name = "E-Commerce/admin/users/reset_password.jinja"
