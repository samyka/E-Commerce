...
from E-Commerce.core.signals import context_cache_item_bumped
...
def bump_product_signal_handler(sender, instance, **kwargs):
    ...
    :param instance: E-Commerce product
    :type instance: E-Commerce.core.models.Product
    """
...
def bump_shop_product_signal_handler(sender, instance, **kwargs):
    ...
    :param instance: E-Commerce shop product
    :type instance: E-Commerce.core.models.ShopProduct
    """
