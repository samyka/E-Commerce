...
class CurrencyModule(AdminModule):
    name = _("Currencies")
    breadcrumbs_menu_entry = MenuEntry(name, url="E-Commerce_admin:currency.list")
    ...
    def get_menu_entries(self, request):
        return [
            MenuEntry(
                text=self.name,
                icon="fa fa-money",
                url="E-Commerce_admin:currency.list",
    ...
    def get_model_url(self, object, kind, shop=None):
        return derive_model_url(Currency, "E-Commerce_admin:currency", object, kind)
