...
from E-Commerce.admin.modules.shops.forms import (
    ShopAddressWizardForm, ShopWizardForm
)
from E-Commerce.admin.views.wizard import (
    TemplatedWizardFormDef, WizardFormDef, WizardPane
)
from E-Commerce.core.models import TaxClass
    ...
    def get_form_defs(self):
        return [
            TemplatedWizardFormDef(
                name="shop",
                template_name="E-Commerce/admin/shops/_wizard_base_shop_form.jinja",
                extra_js="E-Commerce/admin/shops/_wizard_base_shop_script.jinja",
