...
from E-Commerce.admin.modules.orders.json_order_creator import JsonOrderCreator
from E-Commerce.admin.modules.orders.views.edit import encode_address
from E-Commerce.api.mixins import PermissionHelperMixin, ProtectedModelViewSetMixin
from E-Commerce.core.api.address import AddressSerializer
from E-Commerce.core.api.mixins import AvailableOrderMethodsMixin
from E-Commerce.core.api.refunds import RefundMixin
...
class OrderTaxesMixin(object):
    ...
    def taxes(self, request, pk=None):
        ...
        Get taxes for order
        """
        from E-Commerce.core.api.tax import OrderLineTaxSerializer, TaxSummarySerializer
        order = self.get_object()
