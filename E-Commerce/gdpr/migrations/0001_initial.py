    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gdpr_cookie_categories', to='E-Commerce.Shop')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='E-Commerce_gdpr.GDPRCookieCategory')),
            ],
            options={
                'db_tablespace': '',
                'default_permissions': (),
                ...
                'managed': True,
                'db_table': 'E-Commerce_gdpr_gdprcookiecategory_translation',
            },
        ),
        migrations.CreateModel(
            name='GDPRSettings',
            fields=[
                ...
                ('shop', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='gdpr_settings', to='E-Commerce.Shop')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='E-Commerce_gdpr.GDPRSettings')),
            ],
            options={
                'db_tablespace': '',
                'default_permissions': (),
                ...
                'managed': True,
                'db_table': 'E-Commerce_gdpr_gdprsettings_translation',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documents', models.ManyToManyField(blank=True, editable=False, to='E-Commerce_simple_cms.Page', verbose_name='consent documents')),
                ('shop', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='gdpr_consents', to='E-Commerce.Shop')),
