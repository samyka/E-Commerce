...
from E-Commerce.admin.views.wizard import TemplatedWizardFormDef
...
class ManualShippingWizardFormDef(ServiceWizardFormDef):
    ...
    def __init__(self, request):
        super(ManualShippingWizardFormDef, self).__init__(
            ...
            template_name="E-Commerce/admin/service_providers/_wizard_manual_shipping_form.jinja",
            request=request
        )
...
class ManualPaymentWizardFormDef(ServiceWizardFormDef):
    ...
    def __init__(self, request):
        super(ManualPaymentWizardFormDef, self).__init__(
            ...
            template_name="E-Commerce/admin/service_providers/_wizard_manual_payment_form.jinja",
            request=request
        )
