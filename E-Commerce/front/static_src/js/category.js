...
window.refreshFilters = debounce(function refreshFilters(pageNumber = 1) {
    ...
    window.dispatchEvent(new CustomEvent("E-Commerce.FiltersRefreshed", {
        detail: {
            state,
            filterString
        }
...
function reloadProducts(filterString, onComplete = null) {
    ...
    window.dispatchEvent(new CustomEvent("E-Commerce.LoadProductList", {
        detail: {
            filterString
        }
    }));
    ...
    $.get(location.pathname + filterString, function (data) {
        ...
        window.dispatchEvent(new CustomEvent("E-Commerce.ProductListLoaded", {
            detail: {
                filterString,
                data
            }
