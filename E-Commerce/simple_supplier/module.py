...
from E-Commerce.core.signals import stocks_updated
from E-Commerce.core.stocks import ProductStockStatus
from E-Commerce.core.suppliers import BaseSupplierModule
from E-Commerce.core.suppliers.enums import StockAdjustmentType
from E-Commerce.core.utils import context_cache
from E-Commerce.simple_supplier.utils import get_current_stock_value
...
class SimpleSupplierModule(BaseSupplierModule):
    ...
    def update_stock(self, product_id):
        ...
        cache and send `E-Commerce.core.signals.stocks_updated` signal.
        """
        ...
        if self.supplier.stock_managed and has_installed("E-Commerce.notify"):
