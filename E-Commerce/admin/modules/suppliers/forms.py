...
from E-Commerce.core.models import MutableAddress, Shop, Supplier


class SupplierBaseForm(E-CommerceAdminForm):
    class Meta:
        model = Supplier
    ...
    def save(self, commit=True):
        ...
        if not settings.E-Commerce_ENABLE_MULTIPLE_SUPPLIERS or "shops" not in self.fields:
