...
from E-Commerce.admin.modules.media.utils import delete_folder
from E-Commerce.admin.shop_provider import get_shop
from E-Commerce.core.models import MediaFile, MediaFolder
from E-Commerce.utils.excs import Problem
from E-Commerce.utils.filer import filer_file_from_upload, filer_image_from_upload
...
class MediaBrowserView(TemplateView):
    ...
    """
    template_name = "E-Commerce/admin/media/browser.jinja"
