...
from E-Commerce.core.excs import ImpossibleProductModeException
from E-Commerce.core.fields import InternalIdentifierField, MeasurementField
from E-Commerce.core.signals import post_clean, pre_clean
from E-Commerce.core.taxing import TaxableItem
from E-Commerce.core.utils.slugs import generate_multilanguage_slugs
...
class Product(TaxableItem, AttributableMixin, TranslatableModel):
    ...
    def get_child_price_range(self, context, quantity=1):
        ...
        :type context: E-Commerce.core.pricing.PricingContextable
        :type quantity: int
        :return: a tuple of prices
        :rtype: (E-Commerce.core.pricing.Price, E-Commerce.core.pricing.Price)
        """
        items = []
    ...
    def get_cheapest_child_price_info(self, context, quantity=1):
        ...
        :type context: E-Commerce.core.pricing.PricingContextable
        :rtype: E-Commerce.core.pricing.PriceInfo
        """
        items = []
        for child in self.variation_children.visible(shop=context.shop, customer=context.customer):
            items.append(child.get_price_info(context, quantity=quantity))
    ...
    def get_price_info(self, context, quantity=1):
        ...
        :rtype: E-Commerce.core.pricing.PriceInfo
        """
        from E-Commerce.core.pricing import get_price_info
    ...
    def get_price(self, context, quantity=1):
        ...
        :type context: E-Commerce.core.pricing.PricingContextable
        :rtype: E-Commerce.core.pricing.Price
        """
    ...
    def simplify_variation(self):
        ...
        :type product: E-Commerce.core.models.Product
        """
