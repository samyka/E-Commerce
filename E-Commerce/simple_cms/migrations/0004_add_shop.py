...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('E-Commerce_simple_cms', '0001_squashed_0003_alter_names'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='page',
            name='shop',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='E-Commerce.Shop', verbose_name='shop'),
        ),
        migrations.AlterField(
            model_name='page',
            name='identifier',
            field=E-Commerce.core.fields.InternalIdentifierField(blank=True, editable=False, max_length=64, null=True, unique=False),
        ),
