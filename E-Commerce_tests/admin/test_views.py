...
@pytest.mark.parametrize("class_spec", [
    "E-Commerce.admin.modules.categories.views.list:CategoryListView",
    "E-Commerce.admin.modules.contacts.views:ContactListView",
    "E-Commerce.admin.modules.orders.views:OrderListView",
    "E-Commerce.admin.modules.products.views:ProductListView",
    "E-Commerce.admin.modules.users.views:UserListView",
    "E-Commerce.campaigns.admin_module.views.BasketCampaignListView",
    "E-Commerce.campaigns.admin_module.views.CouponListView",
    "E-Commerce.campaigns.admin_module.views.CatalogCampaignListView",
    "E-Commerce.admin.modules.contact_groups.views.ContactGroupListView",
    "E-Commerce.gdpr.admin_module.views.GDPRView",
    "E-Commerce.admin.modules.contact_group_price_display.views.ContactGroupPriceDisplayListView",
    "E-Commerce.admin.modules.permission_groups.views.PermissionGroupListView",
    "E-Commerce.admin.modules.settings.views.SystemSettingsView"
])
...
@pytest.mark.parametrize("model_and_class", [
    (get_default_category, "E-Commerce.admin.modules.categories.views:CategoryEditView"),
    (create_random_person, "E-Commerce.admin.modules.contacts.views:ContactDetailView"),
    (random_order, "E-Commerce.admin.modules.orders.views:OrderDetailView"),
    (get_default_product, "E-Commerce.admin.modules.products.views:ProductEditView"),
])
@pytest.mark.django_db
...
def test_product_edit_view(rf, admin_user, settings):
    ...
    if settings.E-Commerce_AUTO_SHOP_PRODUCT_CATEGORIES:
