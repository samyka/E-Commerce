...
from E-Commerce.default_importer.importers import ProductImporter
from E-Commerce.importer.transforms import transform_file
from E-Commerce.importer.utils.importer import ImportMode
...
from E-Commerce.testing.image_generator import generate_image
from E-Commerce.utils.filer import filer_image_from_data
...
def test_sample_import_no_match(stock_managed):
    ...
    if "E-Commerce.simple_supplier" not in settings.INSTALLED_APPS:
        pytest.skip("Need E-Commerce.simple_supplier in INSTALLED_APPS")
    ...
    importer.manually_match("gtiin", "E-Commerce.core.models.Product:gtin")
    importer.do_remap()
    assert len(importer.unmatched_fields) == 0
    importer.do_import(ImportMode.CREATE_UPDATE)
    products = importer.new_objects
...
def test_strange_category_name():
    import_categoryfile(
        ...
        map_from="mycat",
        map_to="E-Commerce.core.models.ShopProduct:categories"
    )
...
PRODUCT_DATA = [
    ...
    },
    {
        ...
        "visibility":"Always Visible",
        "tax_class":"Cheap Tax",
        "manufacturer":"Golden E-Commerce"
    },
    {
        "sku": "test-sku5",
        "name":"Table",
        ...
        "tax_class":"Cheap Tax",
        "manufacturer":"E-Commerce In Space"
    },
    {
        "sku": "test-sku6",
        "name":"Light Bulb",
