...
class LoginView(FormView):
    template_name = 'E-Commerce/user/login.jinja'
...
class LogoutView(TemplateView):
    template_name = "E-Commerce/user/logout.jinja"
...
class RecoverPasswordView(FormView):
    template_name = "E-Commerce/user/recover_password.jinja"
    form_class = RecoverPasswordForm
    success_url = reverse_lazy("E-Commerce:recover_password_sent")
...
class RecoverPasswordConfirmView(FormView):
    template_name = "E-Commerce/user/recover_password_confirm.jinja"
    form_class = SetPasswordForm
    token_generator = default_token_generator
    success_url = reverse_lazy("E-Commerce:recover_password_complete")
...
class RecoverPasswordSentView(TemplateView):
    template_name = "E-Commerce/user/recover_password_sent.jinja"


class RecoverPasswordCompleteView(TemplateView):
    template_name = "E-Commerce/user/recover_password_complete.jinja"
