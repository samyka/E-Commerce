...
class BaseMethodForm(E-CommerceAdminForm):
    class Meta:
        model = None
        exclude = [
...
class FixedCostBehaviorComponentForm(E-CommerceAdminForm):
    class Meta:
...
class WaivingCostBehaviorComponentForm(E-CommerceAdminForm):
    class Meta:
