...
def ensure_registration_shops(apps, schema_editor):
    Contact = apps.get_model("E-Commerce", "Contact")
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='registrations', to='E-Commerce.Shop', verbose_name='registration shop'),
        ),
