...
from E-Commerce.admin.modules.products.views import ProductListView
...
from E-Commerce.core.models import Category, Product, ShopProduct
...
def test_provide_columns():
    with override_provides("provided_columns_ShopProduct", [
            "E-Commerce_tests.admin.test_picotable:CustomProductDataColumn"]):
