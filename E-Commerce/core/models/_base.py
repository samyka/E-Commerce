...
from E-Commerce.utils import text


class E-CommerceModel(models.Model):
    """
    E-Commerce Model.
    """
...
class TranslatableE-CommerceModel(E-CommerceModel, parler.models.TranslatableModel):
    name_attr = 'name'
...
class PolymorphicE-CommerceModel(PolymorphicModel, E-CommerceModel):
    class Meta:
        abstract = True
...
class PolymorphicTranslatableE-CommerceModel(six.with_metaclass(
        PolyTransModelBase,
        PolymorphicE-CommerceModel, TranslatableE-CommerceModel)):
