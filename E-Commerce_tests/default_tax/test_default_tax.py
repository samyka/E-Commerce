...
from E-Commerce.core.taxing import get_tax_module, TaxingContext
from E-Commerce.default_tax.admin_module.views import TaxRuleEditView
from E-Commerce.default_tax.models import TaxRule
from E-Commerce.default_tax.module import (
    DefaultTaxModule, get_taxes_of_effective_rules
)
from E-Commerce.testing.factories import create_product, get_default_shop, get_shop
