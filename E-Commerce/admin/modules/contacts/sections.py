...
from E-Commerce.core.models import PersonContact
...
class BasicInfoContactSection(Section):
    ...
    icon = "fa-info-circle"
    template = "E-Commerce/admin/contacts/_contact_basic_info.jinja"
    order = 1
...
class AddressesContactSection(Section):
    ...
    name = _("Addresses")
    icon = "fa-map-marker"
    template = "E-Commerce/admin/contacts/_contact_addresses.jinja"
    order = 2
...
class OrdersContactSection(Section):
    ...
    name = _("Orders")
    icon = "fa-inbox"
    template = "E-Commerce/admin/contacts/_contact_orders.jinja"
    order = 3
...
class MembersContactSection(Section):
    ...
    name = _("Members")
    icon = "fa-user"
    template = "E-Commerce/admin/contacts/_contact_members.jinja"
    order = 4
