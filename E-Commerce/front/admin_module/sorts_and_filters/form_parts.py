...
from E-Commerce.front.utils.sorts_and_filters import (
...
class ConfigurationShopFormPart(FormPart):
    ...
    def get_form_defs(self):
        ...
        yield TemplatedFormDef(
            ...
            template_name="E-Commerce/front/admin/sorts_and_filters.jinja",
            required=False,
...
class ConfigurationCategoryFormPart(FormPart):
    ...
    def get_form_defs(self):
        ...
        yield TemplatedFormDef(
            name=self.name,
            form_class=self.form,
            template_name="E-Commerce/front/admin/sorts_and_filters_category.jinja",
            required=False,
