...
from E-Commerce.core.models import Order, OrderLine, OrderLineType, Shipment
from E-Commerce.utils.pdf import html_to_pdf, render_html_to_pdf
...
def _get_delivery_html(request, order, shipment, html_mode=False):
    ...
    return render_to_string("E-Commerce/order_printouts/admin/delivery_pdf.jinja", context=context, request=request)
...
def _get_confirmation_html(request, order, html_mode=False):
    ...
    return render_to_string("E-Commerce/order_printouts/admin/confirmation_pdf.jinja", context=context, request=request)
