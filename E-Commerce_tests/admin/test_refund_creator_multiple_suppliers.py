...
from E-Commerce.admin.modules.orders.views.refund import OrderCreateRefundView
from E-Commerce.admin.supplier_provider import get_supplier
from E-Commerce.core.excs import NoRefundToCreateException
from E-Commerce.core.models import OrderLineType, ShippingMode, Supplier
...
def test_refunds_with_multiple_suppliers(rf, admin_user):
    ...
    supplier_provider = "E-Commerce.testing.supplier_provider.RequestSupplierProvider"
