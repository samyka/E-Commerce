...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('E-Commerce', '0052_add_shop_label_descriptions_and_service_label'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'E-Commerce_supplier_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='supplier_addresses', to='E-Commerce.MutableAddress', verbose_name='contact address'),
        ),
        migrations.AddField(
            model_name='supplier',
            name='created_on',
        ...
        migrations.AddField(
            ...
            name='master',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='E-Commerce.Supplier'),
        ),
