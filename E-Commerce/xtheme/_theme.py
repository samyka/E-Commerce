...
from E-Commerce.apps.provides import (
...
from E-Commerce.xtheme.extenders import MenuExtenderLocation
...
class Theme(object):
    ...
    # If `None`, the default `E-Commerce.front` templates is used instead.
    ...
    def settings_obj(self):
        ...
        :rtype: E-Commerce.xtheme.models.ThemeSettings
        """
    ...
    def has_images(self):
        ...
        if isinstance(self.stylesheets[0], dict):
            ...
            warnings.warn(
                ...
                "in E-Commerce 0.5.7. Use list of dictionaries instead.", RemovedInFutureE-CommerceWarning)
        return False
...
def override_current_theme_class(theme_class=_not_set, shop=None):
    ...
    from E-Commerce.xtheme.views.extra import clear_view_cache
