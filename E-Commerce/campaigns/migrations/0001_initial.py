    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', E-Commerce.core.fields.InternalIdentifierField(max_length=64, null=True, unique=True, editable=False, blank=True)),
            ...
            bases=(E-Commerce.utils.properties.MoneyPropped, parler.models.TranslatableModelMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, verbose_name='ID', auto_created=True, primary_key=True)),
                ('min_value', E-Commerce.core.fields.MoneyValueField(blank=True, decimal_places=9, verbose_name='min amount', null=True, max_digits=36)),
                ('max_value', E-Commerce.core.fields.MoneyValueField(blank=True, decimal_places=9, verbose_name='max amount', null=True, max_digits=36)),
                ('group', models.ForeignKey(related_name='+', to='E-Commerce.ContactGroup', verbose_name='group')),
                ('shop', models.ForeignKey(related_name='+', to='E-Commerce.Shop', verbose_name='shop')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, null=True, verbose_name='created by')),
                ('modified_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, null=True, verbose_name='modified by')),
                ('order', models.ForeignKey(related_name='coupon_usages', to='E-Commerce.Order')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_amount', E-Commerce.core.fields.MoneyValueField(blank=True, null=True, verbose_name='discount amount', help_text='Flat amount of discount.', decimal_places=9, default=None, max_digits=36)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_value', E-Commerce.core.fields.MoneyValueField(blank=True, null=True, verbose_name='maximum basket total amount', decimal_places=9, default=None, max_digits=36)),
            ],
            options={
                'abstract': False,
            },
            bases=(E-Commerce.utils.properties.MoneyPropped, 'campaigns.basketcondition'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(to='campaigns.BasketCondition', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
                ('amount_value', E-Commerce.core.fields.MoneyValueField(blank=True, null=True, verbose_name='basket total amount', decimal_places=9, default=None, max_digits=36)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(verbose_name='categories', to='E-Commerce.Category')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(to='campaigns.BasketCondition', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
                ('contacts', models.ManyToManyField(verbose_name='contacts', to='E-Commerce.Contact')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(to='campaigns.BasketCondition', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
                ('contact_groups', models.ManyToManyField(verbose_name='contact groups', to='E-Commerce.ContactGroup')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_amount', E-Commerce.core.fields.MoneyValueField(blank=True, null=True, verbose_name='discount amount', help_text='Flat amount of discount.', decimal_places=9, default=None, max_digits=36)),
                ('products', models.ManyToManyField(verbose_name='product', to='E-Commerce.Product')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('catalogfilter_ptr', models.OneToOneField(to='campaigns.CatalogFilter', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
                ('product_types', models.ManyToManyField(verbose_name='product Types', to='E-Commerce.ProductType')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='catalogcampaign',
            name='shop',
            field=models.ForeignKey(to='E-Commerce.Shop', verbose_name='shop', help_text='The shop where campaign is active.'),
        ),
        migrations.AddField(
