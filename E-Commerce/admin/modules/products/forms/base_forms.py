...
from E-Commerce.admin.forms.fields import (
    Select2ModelField, Select2ModelMultipleField
)
from E-Commerce.admin.forms.widgets import (
...
from E-Commerce.admin.signals import form_post_clean, form_pre_clean
...
from E-Commerce.utils.i18n import get_language_name
from E-Commerce.utils.multilanguage_model_form import (
...
class ProductBaseForm(MultiLanguageModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "sales_unit": QuickAddSalesUnitSelect(editable_model="E-Commerce.SalesUnit"),
            "tax_class": QuickAddTaxClassSelect(editable_model="E-Commerce.TaxClass"),
    ...
    def __init__(self, **kwargs):
        ...
        self.fields["manufacturer"] = Select2ModelField(
            ...
            widget=QuickAddManufacturerSelect(
                initial=(self.instance.manufacturer if self.instance.pk else None),
                editable_model="E-Commerce.Manufacturer",
        ...
        self.fields["type"] = Select2ModelField(
            ...
            widget=QuickAddProductTypeSelect(
                editable_model="E-Commerce.ProductType",
                initial=initial_type
            )
        )
...
class ShopProductForm(MultiLanguageModelForm):
    class Meta:
        ...
        widgets = {
            "display_unit": QuickAddDisplayUnitSelect(editable_model="E-Commerce.DisplayUnit"),
    ...
    def __init__(self, **kwargs):
        ...
        self.fields["primary_category"] = Select2ModelField(
            ...
            widget=QuickAddCategorySelect(
                editable_model="E-Commerce.Category",
                initial=(self.instance.primary_category if self.instance.pk else None),
    ...
    def clean(self):
        ...
        if not getattr(settings, "E-Commerce_AUTO_SHOP_PRODUCT_CATEGORIES", False):
            return data
