...
from E-Commerce.admin.modules.contacts.utils import (
...
from E-Commerce.core.models import CompanyContact, Contact
...
class ContactDetailToolbar(Toolbar):
    ...
    def build_new_user_button(self):
        ...
        return URLActionButton(
            url=reverse("E-Commerce_admin:user.new") + "?contact_id=%s" % self.contact.pk,
            text=_(u"New User"),
    ...
    def build_new_order_button(self):
        return URLActionButton(
            url=reverse("E-Commerce_admin:order.new") + "?contact_id=%s" % self.contact.pk,
            text=_(u"New Order"),
    ...
    def build(self):
        self.append(URLActionButton(
            url=reverse("E-Commerce_admin:contact.edit", kwargs={"pk": self.contact.pk}),
            icon="fa fa-pencil",
            text=_(u"Edit"),
...
class ContactDetailView(DetailView):
    model = Contact
    template_name = "E-Commerce/admin/contacts/detail.jinja"
