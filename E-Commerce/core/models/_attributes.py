...
from E-Commerce.core.templatetags.E-Commerce_common import datetime as format_datetime
from E-Commerce.core.templatetags.E-Commerce_common import number as format_number
from E-Commerce.utils.analog import define_log_model
from E-Commerce.utils.dates import parse_date
from E-Commerce.utils.numbers import parse_decimal_string
from E-Commerce.utils.text import flatten
...
class AppliedAttribute(TranslatableModel):
    ...
    def _set_numeric_value(self, new_value):
        if self.attribute.type == AttributeType.BOOLEAN and new_value is None:
            """
            E-Commerce uses `django.forms.fields.NullBooleanField` in admin.
...
class AttributableMixin(object):
    ...
    def cache_attributes_for_targets(
        ...
        if not settings.E-Commerce_ENABLE_ATTRIBUTES:  # pragma: no cover
            return targets
