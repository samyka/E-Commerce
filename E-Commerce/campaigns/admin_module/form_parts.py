...
from E-Commerce.campaigns.admin_module.forms import (
    BasketCampaignForm, CatalogCampaignForm
)
from E-Commerce.campaigns.models import ContactGroupSalesRange
    ...
    def get_form_defs(self):
        ...
        for shop in self.shops:
            ...
            yield TemplatedFormDef(
                ...
                template_name="E-Commerce/campaigns/admin/sales_ranges_form_part.jinja",
                required=False,
...
class CampaignBaseFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            ...
            self.form,
            required=True,
            template_name="E-Commerce/campaigns/admin/_edit_base_form.jinja",
...
class BaseFormPart(FormPart):
    formset = None
    template_name = "E-Commerce/campaigns/admin/_edit_form.jinja"
