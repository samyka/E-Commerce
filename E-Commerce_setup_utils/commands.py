...
class BuildMessagesCommand(distutils.core.Command):
    ...
    def run(self):
        ...
        # be set to e.g. 'E-Commerce_workbench.settings' but if we're in
        # middle of installing E-Commerce, then management commands will fail
        # because E-Commerce_workbench is not yet installed.
