...
def md_to_html(apps, schema_editor):
    ...
    CategoryTranslation = apps.get_model("E-Commerce", "CategoryTranslation")
    PaymentMethodTranslation = apps.get_model("E-Commerce", "PaymentMethodTranslation")
    ShippingMethodTranslation = apps.get_model("E-Commerce", "ShippingMethodTranslation")
