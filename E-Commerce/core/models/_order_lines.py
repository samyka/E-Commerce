...
from E-Commerce.core.fields import MoneyValueField, QuantityField, UnsavedForeignKey
from E-Commerce.core.pricing import Priceful
from E-Commerce.core.taxing import LineTax
from E-Commerce.core.utils.line_unit_mixin import LineWithUnit
from E-Commerce.utils.analog import define_log_model
from E-Commerce.utils.money import Money
from E-Commerce.utils.properties import MoneyProperty, MoneyPropped, PriceProperty

from ._base import E-CommerceModel
...
class AbstractOrderLine(MoneyPropped, models.Model, Priceful):
    product = UnsavedForeignKey(
        "E-Commerce.Product", blank=True, null=True, related_name="order_lines",
        on_delete=models.PROTECT, verbose_name=_('product')
    )
    supplier = UnsavedForeignKey(
        "E-Commerce.Supplier", blank=True, null=True, related_name="order_lines",
...
@python_2_unicode_compatible
class OrderLineTax(MoneyPropped, E-CommerceModel, LineTax):
