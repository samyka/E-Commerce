...
from E-Commerce.core.pricing import PriceInfo, TaxfulPrice, TaxlessPrice
from E-Commerce.core.taxing import SourceLineTax, TaxedPrice, TaxModule
from E-Commerce.core.utils.prices import convert_taxness
from E-Commerce.utils import babel_precision_provider
from E-Commerce.utils.money import Money, set_precision_provider
from E-Commerce.testing.factories import get_currency



TAX_MODULE_SPEC = __name__ + ':DummyTaxModule'

original_tax_module = settings.E-Commerce_TAX_MODULE
...
def teardown_module(module):
    ...
    settings.E-Commerce_TAX_MODULE = original_tax_module
