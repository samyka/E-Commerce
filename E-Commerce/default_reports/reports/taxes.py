...
from E-Commerce.core.models import OrderLineTax, Tax
from E-Commerce.default_reports.forms import TaxesReportForm
...
class TaxesReport(OrderReportMixin, E-CommerceReportBase):
