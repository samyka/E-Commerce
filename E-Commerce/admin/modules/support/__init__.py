...
class E-CommerceSupportModule(AdminModule):
    name = _("E-Commerce Support")
    ...
    def _get_article_block(self, request):
        ...
        if articles.get("articles"):
            article_block = DashboardContentBlock.by_rendering_template(
                "articles", request, "E-Commerce/admin/support/_articles_dashboard_block.jinja", articles)
    ...
    def _get_support_block(self, request):
        support_block = DashboardContentBlock.by_rendering_template(
            "support", request, "E-Commerce/admin/support/_support_dashboard_block.jinja", {})
