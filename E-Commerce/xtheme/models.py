...
from E-Commerce.core.fields import SeparatedValuesField, TaggedJSONField
...
class SavedViewConfigQuerySet(models.QuerySet):  # doccov: ignore
    def appropriate(self, theme, shop, view_name, draft):
        ...
        * If a PUBLIC SavedViewConfig exists, its data is copied into a new, unsaved CURRENT_DRAFT
        ...
        :type theme: E-Commerce.xtheme.Theme
...
class SavedViewConfig(models.Model):
    ...
    shop = models.ForeignKey("E-Commerce.Shop", related_name="saved_views_config", null=True)
...
class ThemeSettings(models.Model):
    theme_identifier = models.CharField(max_length=64, db_index=True, verbose_name=_("theme identifier"))
    shop = models.ForeignKey("E-Commerce.Shop", related_name="themes_settings", null=True)
...
class Snippet(models.Model):
    ...
    """
    shop = models.ForeignKey("E-Commerce.Shop", related_name="snippets")
