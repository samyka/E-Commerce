...
import E-Commerce_setup_utils as utils

TOPDIR = os.path.abspath(os.path.dirname(__file__))
LONG_DESCRIPTION_FILE = os.path.join(TOPDIR, 'README.rst')
VERSION_FILE = os.path.join(TOPDIR, 'E-Commerce', '_version.py')
...
#        git tag -a -m "E-Commerce X.Y.Z" vX.Y.Z
...
AUTHOR_EMAIL = 'E-Commerce@E-Commerce.com'
URL = 'http://E-Commerce.com/'
DOWNLOAD_URL_TEMPLATE = (
    'https://github.com/E-Commerce/E-Commerce/releases/download/'
    'v{version}/E-Commerce-{version}-py2.py3-none-any.whl')
...
EXCLUDED_PACKAGES = [
    'E-Commerce_tests', 'E-Commerce_tests.*',
]
