...
from E-Commerce.core.models import (
    Category, OrderLineType, PolymorphicE-CommerceModel, Product, ShopProduct
)
from E-Commerce.core.order_creator._source import LineSource


class BasketLineEffect(PolymorphicE-CommerceModel):
    identifier = None
    model = None
...
def _limit_discount_amount_by_min_price(line, order_source):
    ...
    :param E-Commerce.core.order_creator.SourceLine line: the line to limit the discount
    :param E-Commerce.core.order_source.OrderSource order_source: the order source
    """
