...
class EditProductToolbar(Toolbar):
    def __init__(self, view):
        ...
        self.extend(get_default_edit_toolbar(
            ...
            delete_url="E-Commerce_admin:shop_product.delete",
    ...
    def _build_action_menu(self, product):
        ...
        cross_sell_button = DropdownItem(
            ...
            icon="fa fa-random",
            url=reverse("E-Commerce_admin:shop_product.edit_cross_sell", kwargs={"pk": product.pk})
        )
    ...
    def _get_package_url(self, product):
        return reverse("E-Commerce_admin:shop_product.edit_package", kwargs={"pk": product.pk})

    def _get_variation_url(self, product):
        return reverse("E-Commerce_admin:shop_product.edit_variation", kwargs={"pk": product.pk})
