...
from E-Commerce.core.models import ProductVariationResult, Supplier
from E-Commerce.front.views.product import ProductDetailView
from E-Commerce.utils.numbers import parse_simple_decimal


class ProductPriceView(ProductDetailView):
    template_name = "E-Commerce/front/product/detail_order_section.jinja"
    ...
    def get_context_data(self, **kwargs):
        ...
        if quantity is not None:
            ...
            self.template_name = "E-Commerce/front/product/detail_order_section_no_product.jinja"
            return context
