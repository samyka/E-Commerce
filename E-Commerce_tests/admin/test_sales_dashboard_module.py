...
from E-Commerce.admin.modules.sales_dashboard.dashboard import (
    get_recent_orders_block, get_shop_overview_block,
    OrderValueChartDashboardBlock
)
from E-Commerce.core.models import OrderStatus, ShopStatus
...
from E-Commerce.utils.dates import to_aware
