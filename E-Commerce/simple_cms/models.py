...
class Page(MPTTModel, TranslatableModel):
    shop = models.ForeignKey("E-Commerce.Shop", verbose_name=_('shop'))
    supplier = models.ForeignKey("E-Commerce.Supplier", null=True, blank=True, verbose_name=_('supplier'))
    ...
    template_name = models.TextField(
        ...
        default=settings.E-Commerce_SIMPLE_CMS_DEFAULT_TEMPLATE
    )
