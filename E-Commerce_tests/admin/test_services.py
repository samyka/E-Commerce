...
from E-Commerce.admin.modules.services.base_form_part import ServiceBaseFormPart
from E-Commerce.admin.modules.services.forms import PaymentMethodForm, ShippingMethodForm
from E-Commerce.admin.modules.services.views import (
...
from E-Commerce.core.models import Label, PaymentMethod, ShippingMethod
...
def test_method_edit_save(rf, admin_user, view, model, get_object, service_provider_attr):
    ...
    with override_settings(LANGUAGES=[("en", "en")]):
        ...
        methods_before = model.objects.count()
        # Behavior components is tested at E-Commerce.tests.admin.test_service_behavior_components
