...
from E-Commerce.simple_cms.admin_module.views import PageEditView, PageForm
from E-Commerce.testing.factories import get_default_shop
from E-Commerce_tests.simple_cms.utils import create_multilanguage_page, create_page
