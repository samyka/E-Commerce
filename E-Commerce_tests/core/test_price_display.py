...
from E-Commerce.core.order_creator import OrderSource
from E-Commerce.core.pricing import (
    get_pricing_module, PriceDisplayOptions, PriceInfo, PricingModule,
    TaxfulPrice, TaxlessPrice
)
from E-Commerce.front.basket.objects import BaseBasket
...
original_discount_modules = settings.E-Commerce_DISCOUNT_MODULES
pricing_overrider = override_provides("pricing_module", [PRICING_MODULE_SPEC])


def setup_module(module):
    settings.E-Commerce_PRICING_MODULE = "dummy_pricing_module"
    settings.E-Commerce_DISCOUNT_MODULES = []
...
def teardown_module(module):
    ...
    settings.E-Commerce_DISCOUNT_MODULES = original_discount_modules
