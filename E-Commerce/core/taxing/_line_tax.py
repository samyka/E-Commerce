...
class LineTax(object):
    ...
    def from_tax(cls, tax, base_amount, **kwargs):
        ...
        :type cls: type
        :type tax: E-Commerce.core.models.Tax
...
class SourceLineTax(LineTax):
    def __init__(self, tax, name, amount, base_amount):
        ...
        :type base_amount: E-Commerce.utils.money.Money
        """
        assert isinstance(tax, E-Commerce.core.models.Tax)
        assert isinstance(name, six.text_type)
        assert isinstance(amount, E-Commerce.utils.money.Money)
        assert isinstance(base_amount, E-Commerce.utils.money.Money)
        self.tax = tax
        self.name = name
        self.amount = amount
