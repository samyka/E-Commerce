...
from E-Commerce.core.telemetry import is_opt_out
...
def test_telemetry_wizard_pane(rf, admin_user):
    with override_settings(E-Commerce_SETUP_WIZARD_PANE_SPEC=["E-Commerce.admin.modules.system.views.TelemetryWizardPane"]):
        shop = get_default_shop()
        ...
        assert "You are currently opted out of E-Commerce telemetry." in soup.text
