...
from E-Commerce.core.models import OrderLineType, Product, ShopProduct
...
class CartListView(DashboardViewMixin, CartViewMixin, ListView):
    template_name = 'E-Commerce/saved_carts/cart_list.jinja'
    context_object_name = 'carts'


class CartDetailView(DashboardViewMixin, CartViewMixin, DetailView):
    template_name = 'E-Commerce/saved_carts/cart_detail.jinja'
