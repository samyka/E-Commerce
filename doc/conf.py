...
"""
E-Commerce documentation build configuration file
"""
...
def initialize_django():
    os.environ['DJANGO_SETTINGS_MODULE'] = 'E-Commerce_workbench.settings'
...
def patch_for_introspection():
    import E-Commerce_introspection_helper
    E-Commerce_introspection_helper.enable_patches()
...
htmlhelp_basename = 'E-Commercedoc'
...
latex_documents = [
  ('index', 'E-Commerce.tex', 'E-Commerce Documentation',
...
man_pages = [
    ('index', 'E-Commerce', 'E-Commerce Documentation',
...
texinfo_documents = [
  ('index', 'E-Commerce', 'E-Commerce Documentation',
   'Shoop Commerce Ltd.', 'E-Commerce', 'One line description of project.',
   'Miscellaneous'),
]
