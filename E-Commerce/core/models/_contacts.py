...
from E-Commerce.core.pricing import PriceDisplayOptions
from E-Commerce.core.utils.users import (
...
from ._base import PolymorphicE-CommerceModel, TranslatableE-CommerceModel
...
class ContactGroup(TranslatableE-CommerceModel):
...
class Contact(PolymorphicE-CommerceModel):
    is_anonymous = False
    is_all_seeing = False
    ...
    shops = models.ManyToManyField("E-Commerce.Shop", blank=True, verbose_name=_('shops'), help_text=_(
