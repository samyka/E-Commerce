...
from E-Commerce.importer.importing import (
    DataImporter, ImporterExampleFile, ImportMetaBase
)
from E-Commerce.importer.utils import fold_mapping_name
...
class ProductMetaBase(ImportMetaBase):
    ...
    def handle_stocks(self, fields, sess):
        ...
        # E-Commerce only has 1 supplier support now so get first
...
class ProductImporter(DataImporter):
    ...
    help_template = "E-Commerce/default_importers/product_help.jinja"
    ...
    def get_example_file_content(cls, example_file, request):
        from E-Commerce.default_importer.samples import get_sample_file_content
