...
from E-Commerce.admin.modules.contacts.forms import (
...
from E-Commerce.utils.form_group import FormDef
...
class CompanyContactBaseFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            ...
            template_name="E-Commerce/admin/contacts/_edit_base_form.jinja",
            required=True,
