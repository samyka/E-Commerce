...
class AdminModule(object):
    ...
    def get_menu_entries(self, request):
        """
        :rtype: list[E-Commerce.admin.base.MenuEntry]
        """
        return ()

    def get_search_results(self, request, query):
        """
        :rtype: list[E-Commerce.admin.base.SearchResult]
        """
        return ()

    def get_dashboard_blocks(self, request):
        """
        :rtype: list[E-Commerce.admin.dashboard.DashboardBlock]
        """
        return ()
    ...
    def get_help_blocks(self, request, kind):
        ...
        :type kind: str
        :rtype: list[E-Commerce.admin.views.home.HelpBlock]
        """
        return ()
    ...
    def get_notifications(self, request):
        """
        :rtype: list[E-Commerce.admin.base.Notification]
        """
        return ()
    ...
    def get_activity(self, request, cutoff):
        ...
        :param request: Request
        :type request: django.http.request.HttpRequest
        :return: list[E-Commerce.admin.base.Activity]
        """
        return ()
...
class MenuEntry(BaseMenuEntry):
    def __init__(self, text, url, icon=None, category=None, ordering=99999, aliases=(), **kwargs):
        ...
        if "subcategory" in kwargs:
            warnings.warn(
                "subcategory attribute will be deprecated in E-Commerce 2.0 as unused for this util.",
                DeprecationWarning
            )
...
class Section(object):
    ...
    def visible_for_object(cls, obj, request=None):
        ...
        :type model object: e.g. E-Commerce.core.models.Order
    ...
    def get_context_data(cls, obj, request=None):
        ...
        :type object: e.g. E-Commerce.core.models.Order
        :type request: HttpRequest
