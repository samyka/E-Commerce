...
from E-Commerce.admin.modules.categories.views import CategoryEditView
from E-Commerce.admin.modules.shops.views import ShopEditView
from E-Commerce.apps.provides import override_provides
from E-Commerce.core import cache
from E-Commerce.front.utils.sorts_and_filters import get_configuration
from E-Commerce.testing.factories import get_default_category, get_default_shop
...
def test_sorts_and_filter_in_shop_edit(rf, admin_user):
    ...
    with override_settings(E-Commerce_ENABLE_MULTIPLE_SHOPS=False):
        with override_provides("front_extend_product_list_form", DEFAULT_FORM_MODIFIERS):
            ...
            assert get_configuration(shop=shop) == settings.E-Commerce_FRONT_DEFAULT_SORT_CONFIGURATION
            data = {
...
def test_sorts_and_filter_in_category_edit(rf, admin_user):
    ...
    with override_settings(E-Commerce_ENABLE_MULTIPLE_SHOPS=False):
        with override_provides("front_extend_product_list_form", DEFAULT_FORM_MODIFIERS):
            ...
            assert get_configuration(category=category) == settings.E-Commerce_FRONT_DEFAULT_SORT_CONFIGURATION
            data = {
