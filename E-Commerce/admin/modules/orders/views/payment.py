...
from E-Commerce.core.excs import NoPaymentToCreateException
from E-Commerce.core.models import Order, PaymentStatus
from E-Commerce.utils.money import Money


class OrderCreatePaymentView(UpdateView):
    model = Order
    template_name = "E-Commerce/admin/orders/create_payment.jinja"
