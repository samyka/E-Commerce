...
from E-Commerce_tests.notify.fixtures import (
...
def test_email_action():
    ...
    se = SendEmail({
        ...
        "from_email": {"constant": "from@E-Commerce.local"},
        "recipient": {"constant": "someone@E-Commerce.local"},
    ...
    msg = mail.outbox[0]
    assert msg.to == ['someone@E-Commerce.local']
    assert msg.from_email == 'from@E-Commerce.local'
