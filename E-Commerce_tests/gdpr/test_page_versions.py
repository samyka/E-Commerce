...
from E-Commerce.gdpr.models import GDPRSettings, GDPRUserConsentDocument, GDPRUserConsent
...
from E-Commerce.simple_cms.admin_module.views import PageEditView
