...
class AnonymizeContactToolbarButton(PostActionButton):
    def __init__(self, object, **kwargs):
        ...
        kwargs["value"] = "1"
        kwargs["post_url"] = reverse("E-Commerce_admin:gdpr.anonymize", kwargs=dict(pk=object.pk))
...
class DownloadDataToolbarButton(PostActionButton):
    def __init__(self, object, **kwargs):
        ...
        kwargs["value"] = "1"
        kwargs["extra_css_class"] = "dropdown-item"
        kwargs["post_url"] = reverse("E-Commerce_admin:gdpr.download_data", kwargs=dict(pk=object.pk))
