...
from E-Commerce.admin.form_part import (
    FormPart, FormPartsViewMixin, SaveFormPartsMixin, TemplatedFormDef
)
from E-Commerce.admin.modules.shops.forms import ContactAddressForm, ShopBaseForm
from E-Commerce.admin.shop_provider import set_shop
from E-Commerce.admin.toolbar import get_default_edit_toolbar
from E-Commerce.admin.utils.views import (
    check_and_raise_if_only_one_allowed, CreateOrUpdateView
)
from E-Commerce.admin.utils.wizard import onboarding_complete
...
class ShopBaseFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            "base",
            ShopBaseForm,
            template_name="E-Commerce/admin/shops/_edit_base_shop_form.jinja",
            required=True,
            kwargs={
...
class ContactAddressFormPart(FormPart):
    ...
    def get_form_defs(self):
        ...
        yield TemplatedFormDef(
            "address",
            ContactAddressForm,
            template_name="E-Commerce/admin/shops/_edit_contact_address_form.jinja",
            required=False,
...
class ShopEditView(SaveFormPartsMixin, FormPartsViewMixin, CreateOrUpdateView):
    model = Shop
    template_name = "E-Commerce/admin/shops/edit.jinja"
    ...
    def get_object(self, queryset=None):
        ...
        check_and_raise_if_only_one_allowed("E-Commerce_ENABLE_MULTIPLE_SHOPS", obj)
        return obj

    def get_toolbar(self):
        save_form_id = self.get_save_form_id()
        with_split_save = E-CommerceSettings.get_setting("E-Commerce_ENABLE_MULTIPLE_SHOPS")
...
class ShopSelectView(View):
    def get(self, request, *args, **kwargs):
        ...
        return HttpResponseRedirect(request.META.get("HTTP_REFERER", reverse("E-Commerce_admin:home")))
