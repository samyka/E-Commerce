...
from E-Commerce.front.utils.companies import company_registration_requires_approval
...
class PersonContactForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        field_properties = settings.E-Commerce_PERSON_CONTACT_FIELD_PROPERTIES
