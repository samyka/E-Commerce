...
from E-Commerce.notify.enums import (
    ConstantUse, TemplateUse, UNILINGUAL_TEMPLATE_LANGUAGE
)
from E-Commerce.notify.template import render_in_context, Template
from E-Commerce.utils.importing import cached_load
from E-Commerce.utils.text import snake_case, space_case
...
class Action(ScriptItem):
    ...
    def get_template(self, context):
        ...
        :rtype: E-Commerce.notify.template.Template
        """
...
class ScriptTemplate(six.with_metaclass(abc.ABCMeta)):
    ...
    :ivar E-Commerce.notify.Event event: the event class which will be used to trigger the notification
    ...
    def __init__(self, script_instance=None):
        """
        :param E-Commerce.notify.models.script.Script|None script_instance: script instance to change or None
        """
    ...
    def create_script(self, shop, form=None):
        ...
        :rtype: E-Commerce.notify.models.script.Script
        """
        pass
