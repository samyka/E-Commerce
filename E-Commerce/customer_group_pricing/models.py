...
from E-Commerce.core.utils.context_cache import bump_cache_for_product
from E-Commerce.utils.properties import MoneyPropped, PriceProperty


class CgpBase(models.Model):
    product = models.ForeignKey("E-Commerce.Product", related_name="+", on_delete=models.CASCADE, verbose_name=_("product"))
    shop = models.ForeignKey("E-Commerce.Shop", db_index=True, on_delete=models.CASCADE, verbose_name=_("shop"))
    group = models.ForeignKey(
        "E-Commerce.ContactGroup", db_index=True, on_delete=models.CASCADE, verbose_name=_("contact group"))
