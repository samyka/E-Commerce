...
def get_default_model_permissions(model):
    ...
    """
    warnings.warn(
        "get_default_model_permissions is deprecated in E-Commerce 2.0. Use human readable permission strings instead.",
        DeprecationWarning
    )
    permissions = set()
...
def get_missing_permissions(user, permissions):
    ...
    2. Check missing permissions using E-Commerce admin custom
...
def get_permission_object_from_string(permission_string):
    ...
    """
    warnings.warn(
        "get_permission_object_from_string is deprecated in E-Commerce 2.0. Django permission shouldn't be needed.",
        DeprecationWarning
    )
...
def get_permissions_for_module_url(admin_module, url_name):
    ...
    :type admin_module: E-Commerce.admin.AdminModule
