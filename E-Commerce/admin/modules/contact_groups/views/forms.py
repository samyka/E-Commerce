...
from E-Commerce.admin.forms.widgets import ContactChoiceWidget
from E-Commerce.admin.shop_provider import get_shop
from E-Commerce.core.models import Contact, ContactGroup, Shop
...
class ContactGroupBaseFormPart(FormPart):
    ...
    def get_form_defs(self):
        ...
        yield TemplatedFormDef(
            ...
            template_name="E-Commerce/admin/contact_groups/_edit_base_contact_group_form.jinja",
            required=True,
...
class ContactGroupMembersFormPart(FormPart):
    ...
    def get_form_defs(self):
        ...
        template_name = "E-Commerce/admin/contact_groups/_edit_members_form.jinja"
