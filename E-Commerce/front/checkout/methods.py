...
class MethodWidget(forms.Widget):
    ...
    def render(self, name, value, attrs=None):
        return mark_safe(
            render_to_string("E-Commerce/front/checkout/method_choice.jinja", {
...
class MethodsForm(forms.Form):
    ...
    def limit_method_fields(self):
        basket = self.basket  # type: E-Commerce.front.basket.objects.BaseBasket
...
class MethodsPhase(CheckoutPhaseViewMixin, FormView):
    ...
    template_name = "E-Commerce/front/checkout/methods.jinja"
