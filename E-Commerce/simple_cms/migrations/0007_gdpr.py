...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('E-Commerce_simple_cms', '0006_add_shop_constraints'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='target',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='log_entries', to='E-Commerce_simple_cms.Page', verbose_name='target'),
        ),
        migrations.AddField(
            model_name='pagelogentry',
            name='user',
