...
from E-Commerce.core.pricing import PriceDisplayOptions, Priceful
from E-Commerce.core.templatetags.E-Commerce_common import money, percent
from E-Commerce.core.utils.price_cache import (
    cache_many_price_info, cache_price_info, get_cached_price_info,
    get_many_cached_price_info
)
from E-Commerce.core.utils.prices import convert_taxness
...
def render_price_property(request, item, priceful, property_name='price'):
    ...
    :type priceful: E-Commerce.core.pricing.Priceful
...
def _get_priceful(request, item, quantity, supplier):
    ...
    :rtype: E-Commerce.core.pricing.Priceful|None
    """
    if supplier:
