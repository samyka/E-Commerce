...
def test_gdpr_admin_settings(client, admin_user):
    ...
    admin_settings_url = reverse("E-Commerce_admin:gdpr.settings")
    ...
    assert s.cookie_banner_content == settings.E-Commerce_GDPR_DEFAULT_BANNER_STRING
    assert s.cookie_privacy_excerpt == settings.E-Commerce_GDPR_DEFAULT_EXCERPT_STRING
