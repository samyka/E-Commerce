...
class TaskType(TranslatableModel):
    ...
    shop = models.ForeignKey("E-Commerce.Shop", verbose_name=_("shop"), related_name="task_types")
...
class Task(models.Model):
    shop = models.ForeignKey("E-Commerce.Shop", verbose_name=_("shop"), related_name="tasks")
