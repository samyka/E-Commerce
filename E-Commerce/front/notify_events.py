...
from E-Commerce.core.models import PaymentStatus, ShipmentStatus, ShippingStatus
...
from E-Commerce.notify.typology import Email, Enum, Language, Model, Phone
...
class PaymentCreated(Event):
    ...
    payment = Variable(_("Payment"), type=Model("E-Commerce.Payment"))
