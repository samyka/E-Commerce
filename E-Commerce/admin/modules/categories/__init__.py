...
class CategoryModule(AdminModule):
    ...
    breadcrumbs_menu_entry = MenuEntry(text=name, url="E-Commerce_admin:category.list", category=PRODUCTS_MENU_CATEGORY)
    ...
    def get_menu_entries(self, request):
        return [
            MenuEntry(
                ...
                url="E-Commerce_admin:category.list", category=PRODUCTS_MENU_CATEGORY, ordering=2
            )
        ]
    ...
    def get_help_blocks(self, request, kind):
        ...
        if has_permission(request.user, "category.new"):
            yield SimpleHelpBlock(
                ...
                icon_url="E-Commerce_admin/img/category.png",
    ...
    def get_model_url(self, object, kind, shop=None):
        return derive_model_url(Category, "E-Commerce_admin:category", object, kind)
