...
class Priceful(object):
     ...
     * ``base_unit_price`` (`~E-Commerce.core.pricing.Price`) and
     * ``discount_amount`` (`~E-Commerce.core.pricing.Price`)

    or both

     * ``price`` (`~E-Commerce.core.pricing.Price`) and
     * ``base_price`` (`~E-Commerce.core.pricing.Price`).

    You may also provide

     * ``tax_amount`` (`~E-Commerce.utils.money.Money`)
