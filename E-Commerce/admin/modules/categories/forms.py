...
from E-Commerce.admin.forms.widgets import QuickAddCategorySelect, TextEditorWidget
from E-Commerce.admin.shop_provider import get_shop
from E-Commerce.admin.utils.forms import filter_form_field_choices
from E-Commerce.core.models import (
    Category, CategoryStatus, Product, ShopProduct, ShopProductVisibility
)


class CategoryBaseForm(E-CommerceAdminForm):
    class Meta:
        model = Category
        fields = (
            "parent",
        ...
        widgets = {
            ...
            "parent": QuickAddCategorySelect(editable_model="E-Commerce.Category")
        }
