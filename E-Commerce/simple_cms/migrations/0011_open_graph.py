...
import E-Commerce.simple_cms.models
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('E-Commerce_simple_cms', '0010_add_render_title_and_template_name'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('og_type', enumfields.fields.EnumField(default='website', enum=E-Commerce.simple_cms.models.PageOpenGraphType, max_length=10, verbose_name='type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='E-Commerce_simple_cms.PageOpenGraph')),
            ],
            options={
                'verbose_name': 'page open graph Translation',
                'db_table': 'E-Commerce_simple_cms_pageopengraph_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
            },
        ...
        migrations.AddField(
            ...
            name='page',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='open_graph', to='E-Commerce_simple_cms.Page', verbose_name='page'),
        ),
