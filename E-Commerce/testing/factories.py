...
from E-Commerce.admin.utils.permissions import set_permissions_for_group
...
from E-Commerce.core.order_creator import OrderCreator, OrderSource
from E-Commerce.core.pricing import get_pricing_module
from E-Commerce.core.shortcuts import update_order_line_from_product
from E-Commerce.core.taxing.utils import stacked_value_added_taxes
from E-Commerce.default_tax.models import TaxRule
from E-Commerce.testing.text_data import random_title
...
class UserFactory(DjangoModelFactory):
    ...
    email = factory.Sequence(lambda n: 'user{0}@example.E-Commerce.com'.format(n))
...
class CompanyFactory(DjangoModelFactory):
    ...
    email = factory.Sequence(lambda n: 'company%d@example.E-Commerce.com' % n)
...
def get_shop(prices_include_tax=True, currency=DEFAULT_CURRENCY, identifier=None, enabled=False, **kwargs):
    ...
    # make sure that the currency is available throughout the E-Commerce
