...
class E-CommerceAPISchemaGenerator(SchemaGenerator):
    ...
    def get_serializer_fields(self, path, method, view):
        ...
        The attribute will be available when decorated with `E-Commerce.api.decorators.schema_serializer_class`.
        """
...
class SwaggerSchemaView(APIView):
    ...
    def get(self, request):
        generator = E-CommerceAPISchemaGenerator(title="E-Commerce API")
