...
import E-Commerce.core.utils.line_unit_mixin
...
LANGUAGE_CHOICES = [
    (code, code)
    for code in sorted(E-Commerce.core.fields.LanguageFieldMixin.LANGUAGE_CODES)
]


def ensure_default_currencies_exists(apps, schema_editor):
    Currency = apps.get_model("E-Commerce", "Currency")
...
class Migration(migrations.Migration):
    replaces = [
        ...
        ('E-Commerce', '0006_logmodels'),
        ('E-Commerce', '0007_shop_languages_config'),
        ('E-Commerce', '0008_blank_slugs_for_product'),
        ('E-Commerce', '0009_update_tax_name_max_length'),
        ('E-Commerce', '0010_update_managers'),
        ('E-Commerce', '0011_remove_product_category'),
        ('E-Commerce', '0012_contact_language'),
        ('E-Commerce', '0013_product_shipping_mode_default'),
        ('E-Commerce', '0014_order_status'),
        ('E-Commerce', '0015_shipment_type'),
        ('E-Commerce', '0016_currency'),
        ('E-Commerce', '0017_ensure_currencies_exists'),
        ('E-Commerce', '0018_visibility_defaults'),
        ('E-Commerce', '0019_order_total_limit_behavior_component'),
        ('E-Commerce', '0020_md_to_html'),
        ('E-Commerce', '0021_country_limit_behavior_component'),
        ('E-Commerce', '0022_add_favicon'),
        ('E-Commerce', '0023_category_menu_visibility'),
        ('E-Commerce', '0024_product_shop_description'),
        ('E-Commerce', '0025_product_variation_ordering'),
        ('E-Commerce', '0026_address_geolocation'),
        ('E-Commerce', '0027_modify_shop_fields'),
        ('E-Commerce', '0028_displayunit'),
        ('E-Commerce', '0029_personcontact_names'),
        ('E-Commerce', '0030_add_db_indices'),
        ('E-Commerce', '0031_basket'),
        ('E-Commerce', '0032_shop_product_fields'),
        ('E-Commerce', '0033_order_modified_date'),
        ('E-Commerce', '0034_shops_for_supplier'),
        ('E-Commerce', '0035_remove_shop_permissions'),
        ('E-Commerce', '0036_shop_contacts'),
        ('E-Commerce', '0037_modified_on_contact'),
        ('E-Commerce', '0038_order_date_index'),
        ('E-Commerce', '0039_alter_names'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    primary_key=True,
                    serialize=False)),
                ('identifier', E-Commerce.core.fields.InternalIdentifierField(
                    unique=True,
                    blank=False,
                    editable=False,
                    max_length=64,
                ...
                ('type', enumfields.fields.EnumIntegerField(
                    ...
                    verbose_name='type',
                    enum=E-Commerce.core.models.AttributeType,
                    default=20)),
                ('visibility_mode', enumfields.fields.EnumIntegerField(
                    ...
                    enum=E-Commerce.core.models.AttributeVisibility,
                    default=1)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', enumfields.fields.EnumIntegerField(
                    ...
                    enum=E-Commerce.utils.analog.LogEntryKind,
                    default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(
                    ...
                    db_index=True,
                    max_length=32,
                    default=E-Commerce.core.models._basket.generate_key)),
                ('created_on', models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    verbose_name='status',
                    enum=E-Commerce.core.models.CategoryStatus,
                    default=1)),
                ...
                ('visibility', enumfields.fields.EnumIntegerField(
                    ...
                    enum=E-Commerce.core.models.CategoryVisibility,
                    default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(
                    ...
                    db_index=True,
                    default=True)),
                ('_language', E-Commerce.core.fields.LanguageField(
                    help_text=
                ...
                ('merchant_notes', models.TextField(
                    help_text=
                    'Enter any private notes for this customer that are only accessible in E-Commerce admin.',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', enumfields.fields.EnumIntegerField(
                    ...
                    primary_key=True,
                    serialize=False,
                    enum=E-Commerce.core.models.CounterType)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra', jsonfield.fields.JSONField(
                    verbose_name='extra data', null=True, blank=True)),
                ('target', models.ForeignKey(
                    to='E-Commerce.CustomerTaxGroup',
                    related_name='log_entries',
                    verbose_name='target')),
                ('user', models.ForeignKey(
                    on_delete=django.db.models.deletion.PROTECT,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decimals', models.PositiveSmallIntegerField(
                    ...
                    verbose_name='decimal places',
                    default=0)),
                ('comparison_value', E-Commerce.core.fields.QuantityField(
                    help_text=
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_tablespace': '',
                'default_permissions': (),
                'db_table': 'E-Commerce_displayunit_translation',
                'managed': True,
            },),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            bases=(E-Commerce.core.models._base.ChangeProtected,
                   E-Commerce.core.utils.name_mixin.NameMixin, models.Model),),
        migrations.CreateModel(
            name='Manufacturer',
            fields=[
                ('id', models.AutoField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    default=0,
                    enum=E-Commerce.core.models.PaymentStatus)),
                ('shipping_status', enumfields.fields.EnumIntegerField(
                    verbose_name='shipping status',
                    db_index=True,
                    default=0,
                    enum=E-Commerce.core.models.ShippingStatus)),
                ...
                ('prices_include_tax', models.BooleanField(
                    verbose_name='prices include tax')),
                ('display_currency', E-Commerce.core.fields.CurrencyField(
                ...
                ('language', E-Commerce.core.fields.LanguageField(
                    verbose_name='language',
                    choices=LANGUAGE_CHOICES,
                    max_length=10,
                    blank=True)),
                ...
                ('billing_address', models.ForeignKey(
                    ...
                    to='E-Commerce.ImmutableAddress',
                    blank=True,
                    verbose_name='billing address',
                    on_delete=django.db.models.deletion.PROTECT,
                    null=True)),
                ('creator', E-Commerce.core.fields.UnsavedForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', enumfields.fields.EnumIntegerField(
                    ...
                    enum=E-Commerce.core.models.OrderLineType,
                    default=1)),
                ...
                ('extra_data', jsonfield.fields.JSONField(
                    verbose_name='extra data', null=True, blank=True)),
                ('quantity', E-Commerce.core.fields.QuantityField(
                    verbose_name='quantity',
                    decimal_places=9,
                    max_digits=36,
                    default=1)),
                ('base_unit_price_value', E-Commerce.core.fields.MoneyValueField(
                ...
                ('discount_amount_value', E-Commerce.core.fields.MoneyValueField(
                    ...
                    max_digits=36,
                    default=0)),
                ('order', E-Commerce.core.fields.UnsavedForeignKey(
                    on_delete=django.db.models.deletion.PROTECT,
                    to='E-Commerce.Order',
                    related_name='lines',
                    verbose_name='order')),
                ('parent_line', E-Commerce.core.fields.UnsavedForeignKey(
                    related_name='child_lines',
                    to='E-Commerce.OrderLine',
                    blank=True,
            ...
            bases=(E-Commerce.core.utils.line_unit_mixin.LineWithUnit,
                   E-Commerce.utils.properties.MoneyPropped, models.Model,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_value', E-Commerce.core.fields.MoneyValueField(
                    verbose_name='tax amount', decimal_places=9,
                    max_digits=36)),
                ('base_amount_value', E-Commerce.core.fields.MoneyValueField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    verbose_name='role',
                    enum=E-Commerce.core.models.OrderStatusRole,
                    default=0)),
                ('default', models.BooleanField(
                    help_text=
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foreign_amount_value', E-Commerce.core.fields.MoneyValueField(
                    decimal_places=9,
                    max_digits=36,
                    blank=True,
                    ...
                    null=True,
                    default=None)),
                ('foreign_currency', E-Commerce.core.fields.CurrencyField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode', enumfields.fields.EnumIntegerField(
                    verbose_name='mode',
                    enum=E-Commerce.core.models.ProductMode,
                    default=0)),
                ('stock_behavior', enumfields.fields.EnumIntegerField(
                    help_text=
                    'Set to stocked if inventory should be managed within E-Commerce.',
                    verbose_name='stock',
                    enum=E-Commerce.core.models.StockBehavior,
                    default=0)),
                ('shipping_mode', enumfields.fields.EnumIntegerField(
                    ...
                    enum=E-Commerce.core.models.ShippingMode,
                    default=1)),
                ('sku', models.CharField(
                    help_text=
                ...
                ('width', E-Commerce.core.fields.MeasurementField(
                    help_text=
                    ...
                    default=0)),
                ('height', E-Commerce.core.fields.MeasurementField(
                    help_text=
                    ...
                    default=0)),
                ('depth', E-Commerce.core.fields.MeasurementField(
                    help_text=
                    ...
                    default=0)),
                ('net_weight', E-Commerce.core.fields.MeasurementField(
                    help_text=
                    ...
                    default=0)),
                ('gross_weight', E-Commerce.core.fields.MeasurementField(
                    help_text=
            ...
            bases=(E-Commerce.core.taxing.TaxableItem,
                   E-Commerce.core.models._attributes.AttributableMixin,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ForeignKey(
                    verbose_name='attribute', to='E-Commerce.Attribute')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(
                    to='E-Commerce.ProductAttribute',
                    related_name='translations',
                    editable=False,
                    null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', enumfields.fields.EnumIntegerField(
                    verbose_name='type',
                    enum=E-Commerce.core.models.ProductCrossSellType)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    verbose_name='kind',
                    enum=E-Commerce.core.models.ProductMediaKind,
                    default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    default=1,
                    enum=E-Commerce.core.models.ProductVariationLinkStatus)),
                ('product', models.ForeignKey(
                    to='E-Commerce.Product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(verbose_name='name',
                                          max_length=128)),
                ('master', models.ForeignKey(
                    to='E-Commerce.ProductVariationVariable',
                    related_name='translations',
                    editable=False,
                    null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(
                    to='E-Commerce.ProductVariationVariableValue',
                    related_name='translations',
                    editable=False,
                    null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            bases=(E-Commerce.core.models._units._ShortNameToSymbol,
                   parler.models.TranslatableModelMixin, models.Model),),
        migrations.CreateModel(
            ...
            bases=(E-Commerce.core.models._units._ShortNameToSymbol, models.Model),
        ),
        migrations.CreateModel(
            name='SavedAddress',
            fields=[
                ...
                ('role', enumfields.fields.EnumIntegerField(
                    verbose_name='role',
                    enum=E-Commerce.core.models.SavedAddressRole,
                    default=1)),
                ('status', enumfields.fields.EnumIntegerField(
                    verbose_name='status',
                    enum=E-Commerce.core.models.SavedAddressStatus,
                    default=1)),
                ('title', models.CharField(
                    verbose_name='title', max_length=255, blank=True)),
                ('address', models.ForeignKey(
                    to='E-Commerce.MutableAddress',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', enumfields.fields.EnumIntegerField(
                    verbose_name='status',
                    enum=E-Commerce.core.models.ShipmentStatus,
                    default=0)),
                ('tracking_code', models.CharField(
                    verbose_name='tracking code', max_length=64, blank=True)),
                ('description', models.CharField(
                    verbose_name='description', max_length=255, blank=True)),
                ('volume', E-Commerce.core.fields.MeasurementField(
                    verbose_name='volume',
                    unit='m3',
                    decimal_places=9,
                    max_digits=36,
                    default=0)),
                ('weight', E-Commerce.core.fields.MeasurementField(
                    verbose_name='weight',
                    unit='kg',
                    decimal_places=9,
                    max_digits=36,
                ...
                ('type', enumfields.fields.EnumIntegerField(
                    verbose_name='type',
                    enum=E-Commerce.core.models.ShipmentType,
                    default=0)),
                ('order', models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', E-Commerce.core.fields.QuantityField(
                    ...
                    max_digits=36,
                    default=0)),
                ('unit_volume', E-Commerce.core.fields.MeasurementField(
                    verbose_name='unit volume',
                    unit='m3',
                    decimal_places=9,
                    max_digits=36,
                    default=0)),
                ('unit_weight', E-Commerce.core.fields.MeasurementField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', enumfields.fields.EnumIntegerField(
                    ...
                    verbose_name='status',
                    enum=E-Commerce.core.models.ShopStatus,
                    default=0)),
                ...
                ('currency', E-Commerce.core.fields.CurrencyField(
                    ...
                    verbose_name='currency',
                    max_length=4,
                    default=E-Commerce.core.models._shops._get_default_currency)),
                ('prices_include_tax', models.BooleanField(
                    help_text=
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', enumfields.fields.EnumIntegerField(
                    ...
                    enum=E-Commerce.core.models.ShopProductVisibility,
                    default=3)),
                ...
                ('visibility_limit', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    verbose_name='visibility limitations',
                    enum=E-Commerce.core.models.ProductVisibility,
                    default=1)),
                ('backorder_maximum', E-Commerce.core.fields.QuantityField(
                    help_text=
                    ...
                    null=True,
                    default=0)),
                ('purchase_multiple', E-Commerce.core.fields.QuantityField(
                    help_text=
                    ...
                    max_digits=36,
                    default=0)),
                ('minimum_purchase_quantity', E-Commerce.core.fields.QuantityField(
                    help_text=
                ...
                ('limit_payment_methods', models.BooleanField(
                    ...
                    default=False)),
                ('default_price_value', E-Commerce.core.fields.MoneyValueField(
                    help_text=
                    ...
                    null=True)),
                ('minimum_price_value', E-Commerce.core.fields.MoneyValueField(
                    help_text=
                ...
                ('primary_category', models.ForeignKey(
                    ...
                    on_delete=django.db.models.deletion.PROTECT,
                    null=True)),
                ('product', E-Commerce.core.fields.UnsavedForeignKey(
                    to='E-Commerce.Product',
                    related_name='shop_products',
                    verbose_name='product')),
            ...
            bases=(E-Commerce.utils.properties.MoneyPropped,
                   parler.models.TranslatableModelMixin, models.Model),),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_tablespace': '',
                'default_permissions': (),
                'db_table': 'E-Commerce_shopproduct_translation',
                'managed': True,
            },),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('physical_count', E-Commerce.core.fields.QuantityField(
                    verbose_name='physical stock count',
                    decimal_places=9,
                    editable=False,
                    max_digits=36,
                    default=0)),
                ('logical_count', E-Commerce.core.fields.QuantityField(
                    ...
                    default=0)),
                ('product', models.ForeignKey(
                    verbose_name='product', to='E-Commerce.Product')),
            ],),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', enumfields.fields.EnumIntegerField(
                    ...
                    enum=E-Commerce.core.models.SupplierType,
                    default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    primary_key=True,
                    serialize=False)),
                ('code', E-Commerce.core.fields.InternalIdentifierField(
                    unique=True,
                    blank=True,
                    max_length=64,
                    editable=False,
            ...
            bases=(E-Commerce.utils.properties.MoneyPropped,
                   E-Commerce.core.models._base.ChangeProtected,
                   parler.models.TranslatableModelMixin, models.Model),),
        migrations.CreateModel(
            name='TaxClass',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    primary_key=True,
                    serialize=False)),
                ('min_value', E-Commerce.core.fields.MeasurementField(
                    help_text=
                    ...
                    null=True,
                    default=0)),
                ('max_value', E-Commerce.core.fields.MeasurementField(
                    help_text=
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(
                    ...
                    blank=True)),
                ('master', models.ForeignKey(
                    to='E-Commerce.WeightBasedPriceRange',
                    related_name='translations',
                    editable=False,
                    null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('servicebehaviorcomponent_ptr', models.OneToOneField(
                    ...
                    primary_key=True,
                    serialize=False)),
                ('min_price_value', E-Commerce.core.fields.MoneyValueField(
                    verbose_name='min price value',
                    decimal_places=9,
                    null=True,
                    max_digits=36,
                    blank=True)),
                ('max_price_value', E-Commerce.core.fields.MoneyValueField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', enumfields.fields.EnumField(
                    ...
                    verbose_name='gender',
                    max_length=4,
                    enum=E-Commerce.core.models.Gender,
                    default='u')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_value', E-Commerce.core.fields.MoneyValueField(
                    ...
                    decimal_places=9,
                    max_digits=36)),
                ('waive_limit_value', E-Commerce.core.fields.MoneyValueField(
                    help_text=
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                verbose_name='supplier', to='E-Commerce.Supplier'),),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name='polymorphic_E-Commerce.serviceprovider_set+',
                editable=False,
                null=True),),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to='contenttypes.ContentType',
                related_name='polymorphic_E-Commerce.servicebehaviorcomponent_set+',
                editable=False,
                null=True),),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='product',
            field=E-Commerce.core.fields.UnsavedForeignKey(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to='contenttypes.ContentType',
                related_name='polymorphic_E-Commerce.contact_set+',
                editable=False,
                null=True),),
        migrations.AddField(
            model_name='contact',
        ...
        migrations.AddField(
            ...
            name='products',
            field=models.ManyToManyField(
                verbose_name='products', to='E-Commerce.Product', blank=True),),
        migrations.AddField(
            model_name='basket',
            name='shop',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rounding_mode', enumfields.fields.EnumField(
                    ...
                    max_length=50,
                    enum=E-Commerce.core.models._service_payment.RoundingMode,
        ...
        migrations.AddField(
            ...
            name='component',
            field=models.ForeignKey(
                to='E-Commerce.WeightBasedPricingBehaviorComponent',
                related_name='ranges'),),
        migrations.AddField(
            model_name='waivingcostbehaviorcomponenttranslation',
            name='master',
            field=models.ForeignKey(
                to='E-Commerce.WaivingCostBehaviorComponent',
                related_name='translations',
                editable=False,
                null=True),),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddField(
            ...
            name='master',
            field=models.ForeignKey(
                to='E-Commerce.FixedCostBehaviorComponent',
                related_name='translations',
                editable=False,
                null=True),),
        migrations.AlterUniqueTogether(
