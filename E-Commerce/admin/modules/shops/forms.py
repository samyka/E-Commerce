...
from E-Commerce.core.models import Currency, MutableAddress, Shop
from E-Commerce.core.settings_provider import E-CommerceSettings
from E-Commerce.core.utils.form_mixins import ProtectedFieldsMixin
...
class ShopBaseForm(ProtectedFieldsMixin, E-CommerceAdminForm):
...
class ShopWizardForm(E-CommerceAdminForm):
    class Meta:
        model = Shop
