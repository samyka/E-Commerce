...
from E-Commerce.admin.modules.contact_groups.views import ContactGroupEditView
from E-Commerce.admin.modules.contact_groups.views.forms import (
...
def check_for_delete(request, contact_group, can_delete):
    delete_url = reverse("E-Commerce_admin:contact_group.delete", kwargs={"pk": contact_group.pk})
