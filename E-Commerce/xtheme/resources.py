...
from E-Commerce.core.fields import TaggedJSONEncoder
...
class ResourceContainer(object):
    ...
    `~E-Commerce.xtheme.engine.XthemeTemplate` (akin to how `django-jinja`'s Template injects
...
def get_resource_container(context):
    ...
    :rtype: E-Commerce.xtheme.resources.ResourceContainer|None
    """
