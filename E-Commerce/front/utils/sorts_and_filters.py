...
from E-Commerce.xtheme import get_theme_cache_key
...
class ProductListFormModifier(six.with_metaclass(abc.ABCMeta)):
    ...
    def get_fields(self, request, category=None):
        ...
        :type category: E-Commerce.core.models.Category|None
    ...
    def sort_products(self, request, products, data):
        ...
        :type products: list[E-Commerce.code.models.Product]
        :param data: product list form data
        :type data: dict
        :return: List of products that might be sorted
        :rtype: list[E-Commerce.code.models.Product]
        """
        return products
    ...
    def filter_products(self, request, products, data):
        ...
        :rtype products: list[E-Commerce.core.models.Product]
        :param data: Data from ProductListForm
        :type data: dict
...
def get_form_field_label(identifier, default):
    return settings.E-Commerce_FRONT_OVERRIDE_SORTS_AND_FILTERS_LABELS_LOGIC.get(identifier, default)
