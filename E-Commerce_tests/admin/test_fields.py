...
from E-Commerce.admin.forms.fields import WeekdayField, WeekdaysSelectMultiple
from E-Commerce.admin.modules.product_types.views import ProductTypeEditView
from E-Commerce.core.models import Attribute, AttributeType, ProductType
