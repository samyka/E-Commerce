...
from E-Commerce.core.fields import HexColorField
from E-Commerce.core.models import Category, Product
from E-Commerce.core.models._base import E-CommerceModel, TranslatableE-CommerceModel
...
class Carousel(E-CommerceModel):
    shops = models.ManyToManyField("E-Commerce.Shop", related_name="carousels", verbose_name=_('shops'), help_text=_(
...
@python_2_unicode_compatible
class Slide(TranslatableE-CommerceModel):
    ...
    def get_link_url(self):
        ...
        if external_link:
            ...
            return reverse("E-Commerce:product", kwargs=dict(pk=self.product_link.pk, slug=self.product_link.slug))
        elif self.category_link:
            return reverse("E-Commerce:category", kwargs=dict(pk=self.category_link.pk, slug=self.category_link.slug))
        elif self.cms_page_link:
            return reverse("E-Commerce:cms_page", kwargs=dict(url=self.cms_page_link.url))
