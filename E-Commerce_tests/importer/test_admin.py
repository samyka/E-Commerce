...
def do_importing(sku, name, lang, shop, import_mode=ImportMode.CREATE_UPDATE, client=None):
    is_update = True
    import_path = reverse("E-Commerce_admin:importer.import")
    process_path = reverse("E-Commerce_admin:importer.import_process")
...
def test_download_examples(rf, admin_user):
    shop = get_default_shop()
    import_url = reverse("E-Commerce_admin:importer.import")
    ...
    from E-Commerce.importer.utils import get_importer, get_importer_choices
        ...
        if importer_cls.has_example_file():
            ...
            for example_file in importer_cls.example_files:
                ...
                download_url = "{}?importer={}&file_name={}".format(
                    reverse("E-Commerce_admin:importer.download_example"),
