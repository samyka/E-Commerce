...
from E-Commerce.utils.i18n import format_money, format_percent
from E-Commerce.utils.properties import MoneyProperty, MoneyPropped

from ._base import ChangeProtected, TranslatableE-CommerceModel


class Tax(MoneyPropped, ChangeProtected, TranslatableE-CommerceModel):
    ...
    def calculate_amount(self, base_amount):
        ...
        :type base_amount: E-Commerce.utils.money.Money
...
class TaxClass(TranslatableE-CommerceModel):
...
class CustomerTaxGroup(TranslatableE-CommerceModel):
    identifier = InternalIdentifierField(unique=True)
    translations = TranslatedFields(
        name=models.CharField(max_length=100, verbose_name=_('name'), help_text=_(
