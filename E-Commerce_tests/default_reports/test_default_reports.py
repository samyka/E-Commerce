...
from E-Commerce.default_reports.reports import (
...
from E-Commerce.reports.admin_module.views import ReportView
from E-Commerce.reports.forms import DateRangeChoices
from E-Commerce.reports.writer import get_writer_instance
...
from E-Commerce_tests.core.test_basic_order import create_order
from E-Commerce_tests.reports.test_reports import initialize_report_test
...
def test_new_customers_report(rf, admin_user, group_by):
    with override_provides("reports", ["E-Commerce.default_reports.reports.new_customers:NewCustomersReport"]):
        shop = get_default_shop()
