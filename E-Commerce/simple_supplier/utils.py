...
from E-Commerce.core.suppliers.base import StockAdjustmentType
from E-Commerce.simple_supplier.forms import (
...
def get_stock_information_html(supplier, product):
    ...
    :param supplier: E-Commerce Supplier
    :type supplier: E-Commerce.core.models.Supplier
    :param product: E-Commerce Product
    ...
    if "E-Commerce.notify" in settings.INSTALLED_APPS:
        context["alert_limit"] = True
    return render_to_string("E-Commerce/simple_supplier/admin/stock_information.jinja", context)
...
def get_stock_adjustment_div(request, supplier, product):
    ...
    if "E-Commerce.notify" in settings.INSTALLED_APPS:
        ...
        if not get_missing_permissions(request.user, ("notify.script.list",)):
            context["notify_url"] = reverse("E-Commerce_admin:notify.script.list")
        else:
            context["notify_url"] = ""
    return render_to_string("E-Commerce/simple_supplier/admin/add_stock_form.jinja", context=context, request=request)
