...
from E-Commerce.core.models import Product, ProductMode, ShopProduct, Supplier
from E-Commerce.front.utils.product import get_product_context
from E-Commerce.utils.excs import extract_messages, Problem


class ProductDetailView(DetailView):
    template_name = "E-Commerce/front/product/detail.jinja"
    model = Product
