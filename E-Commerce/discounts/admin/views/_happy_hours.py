...
from E-Commerce.admin.forms.fields import Select2MultipleField, WeekdayField
from E-Commerce.admin.forms.widgets import TimeInput
...
from E-Commerce.discounts.models import Discount, HappyHour, TimeRange
...
class HappyHourEditView(CreateOrUpdateView):
    ...
    template_name = "E-Commerce/discounts/edit.jinja"
    ...
    def get_toolbar(self):
        ...
        delete_url = (
            reverse_lazy("E-Commerce_admin:discounts_happy_hour.delete", kwargs={"pk": object.pk})
...
class HappyHourDeleteView(DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return HttpResponseRedirect(reverse_lazy("E-Commerce_admin:discounts_happy_hour.list"))
