...
from E-Commerce.notify.base import Action, Condition
from E-Commerce.notify.enums import StepConditionOperator, StepNext
from E-Commerce.utils.analog import BaseLogEntry
...
class Context(object):
    ...
    def from_variables(cls, shop=None, **variables):
        ...
        :rtype: E-Commerce.notify.script.Context
        """
    ...
    def from_event(cls, event, shop=None):
        ...
        :type event: E-Commerce.notify.Event
        :type shop: E-Commerce.Shop
        :rtype: E-Commerce.notify.script.Context
        """
