...
class RequestPasswordForm(RecoverPasswordForm):
    ...
    subject_template_name = "E-Commerce/admin/auth/recover_password_mail_subject.jinja"
    email_template_name = "E-Commerce/admin/auth/recover_password_mail_content.jinja"
    from_email = None
