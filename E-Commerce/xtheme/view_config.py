...
from E-Commerce.xtheme.layout.utils import get_layout_data_key, get_provided_layouts
...
class ViewConfig(object):
    ...
    def __init__(self, theme, shop, view_name, draft, global_type=False):
        ...
        :type theme: E-Commerce.xtheme.Theme|None
    ...
    def saved_view_config(self):
        ...
        :rtype: E-Commerce.xtheme.models.SavedViewConfig|None
        """
