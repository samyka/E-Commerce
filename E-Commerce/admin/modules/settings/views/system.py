...
from E-Commerce.admin.form_part import FormPartsViewMixin
from E-Commerce.admin.modules.settings.forms.system import OrderSettingsFormPart
...
class SystemSettingsView(FormPartsViewMixin, FormView):
    form_class = None
    template_name = "E-Commerce/admin/settings/edit.jinja"
    ...
    def save_form_parts(self, form):
        ...
        return redirect("E-Commerce_admin:settings.list")
