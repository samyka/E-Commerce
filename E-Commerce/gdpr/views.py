...
from E-Commerce.core.models import get_person_contact, Order
from E-Commerce.front.views.dashboard import DashboardViewMixin
from E-Commerce.gdpr.models import (
...
class GDPRCookieConsentView(View):
    def post(self, request, *args, **kwargs):
        ...
        if request.META.get("HTTP_REFERER"):
            ...
            redirect_url = force_text(reverse("E-Commerce:index"))
...
class GDPRCustomerDashboardView(DashboardViewMixin, TemplateView):
    template_name = "E-Commerce/gdpr/edit_customer_data.jinja"
...
class GDPRAnonymizeView(View):
    def post(self, request, *args, **kwargs):
        ...
        with atomic():
            from E-Commerce.tasks.models import TaskType
        ...
        return HttpResponseRedirect(reverse("E-Commerce:index"))
