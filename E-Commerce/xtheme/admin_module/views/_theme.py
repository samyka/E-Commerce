...
from E-Commerce.admin.toolbar import get_default_edit_toolbar, URLActionButton
...
from E-Commerce.xtheme._theme import (
...
class ThemeConfigView(FormView):
    ...
    """
    template_name = "E-Commerce/xtheme/admin/config.jinja"
    form_class = ActivationForm
...
class ThemeConfigDetailView(CreateOrUpdateView):
    ...
    """
    model = ThemeSettings
    template_name = "E-Commerce/xtheme/admin/config_detail.jinja"
    ...
    def get_success_url(self):
        return reverse("E-Commerce_admin:xtheme.config_detail", kwargs={
    ...
    def get_toolbar(self):
        ...
        toolbar.append(
            URLActionButton(
                ...
                icon="fa fa-magic",
                url=reverse("E-Commerce_admin:xtheme_snippet.list"),
