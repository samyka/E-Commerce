...
from E-Commerce.front.apps.carousel.admin_module.forms import (
...
class CarouselFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            self.name,
            self.form,
            template_name="E-Commerce/carousel/admin/_edit_base_form.jinja",
            required=True,
            kwargs={
...
class SlideFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            self.name,
            self.formset,
            template_name="E-Commerce/carousel/admin/_edit_slide_form.jinja",
            required=False,
...
class CarouselEditView(FormPartsViewMixin, SaveFormPartsMixin, CreateOrUpdateView):
    model = Carousel
    template_name = "E-Commerce/carousel/admin/edit.jinja"
    ...
    def get_toolbar(self):
        ...
        if save_form_id:
            return get_default_edit_toolbar(self, save_form_id, delete_url="E-Commerce_admin:carousel.delete")
