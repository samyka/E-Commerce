...
class RequestPasswordView(FormView):
    template_name = "E-Commerce/admin/auth/request_password.jinja"

    def get_form_class(self):
        from E-Commerce.admin.forms._auth import RequestPasswordForm
        return RequestPasswordForm

    def get_success_url(self):
        return "{}?email={}".format(reverse("E-Commerce_admin:recover_password"), self.request.POST.get("email"))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse("E-Commerce_admin:login"))


class ResetPasswordView(FormView):
    template_name = "E-Commerce/admin/auth/reset_password.jinja"
    success_url = reverse_lazy("E-Commerce_admin:login")
