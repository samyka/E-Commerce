...
from E-Commerce.admin.utils.views import get_create_or_change_title
from E-Commerce.notify.admin_module.forms import ScriptItemEditForm
from E-Commerce.notify.admin_module.utils import get_enum_choices_dict
from E-Commerce.notify.base import Action, Condition, Event
from E-Commerce.notify.enums import StepConditionOperator, StepNext
from E-Commerce.notify.models.script import Script
from E-Commerce.utils.text import snake_case
...
class ScriptAPI(object):
    def __init__(self, request, script):
        ...
        :param script: Script
        :type script: E-Commerce.notify.models.Script
        """
