...
from E-Commerce.core.models import Product, ProductCrossSell, ProductCrossSellType
from E-Commerce.front.template_helpers.general import (
    get_best_selling_products, get_newest_products,
    get_products_for_categories, get_random_products
)
from E-Commerce.front.template_helpers.product import map_relation_type
from E-Commerce.xtheme import TemplatedPlugin
from E-Commerce.xtheme.plugins.forms import GenericPluginForm, TranslatableField
from E-Commerce.xtheme.plugins.widgets import (
...
class ProductHighlightPlugin(TemplatedPlugin):
    ...
    template_name = "E-Commerce/xtheme/plugins/highlight_plugin.jinja"
    fields = [
...
class ProductCrossSellsPlugin(TemplatedPlugin):
    ...
    template_name = "E-Commerce/xtheme/plugins/cross_sells_plugin.jinja"
...
class ProductSelectionPlugin(TemplatedPlugin):
    ...
    template_name = "E-Commerce/xtheme/plugins/product_selection_plugin.jinja"
