...
from E-Commerce.front.utils.sorts_and_filters import ProductListFormModifier
...
def get_product_ids_for_query_str(request, query_str, limit, product_ids=[]):
    ...
    entry_query = get_compiled_query(query_str, settings.E-Commerce_SIMPLE_SEARCH_FIELDS)
...
def get_search_product_ids(request, query, limit=settings.E-Commerce_SIMPLE_SEARCH_LIMIT):
