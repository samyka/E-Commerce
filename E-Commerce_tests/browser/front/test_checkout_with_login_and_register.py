...
@override_settings(E-Commerce_REGISTRATION_REQUIRES_ACTIVATION=False)
@pytest.mark.urls('E-Commerce.testing.checkout_with_login_and_register_urls')
@pytest.mark.browser
...
@override_settings(E-Commerce_REGISTRATION_REQUIRES_ACTIVATION=False)
@pytest.mark.urls('E-Commerce.testing.single_page_checkout_with_login_and_register_conf')
@pytest.mark.browser
@pytest.mark.djangodb
...
def guest_ordering_test(browser, live_server):
    ...
    url = reverse("E-Commerce:checkout", kwargs={"phase": "checkout_method"})
