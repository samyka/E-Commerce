...
from E-Commerce.gdpr.utils import get_possible_consent_pages
...
class QuickAddPageSelect(QuickAddRelatedObjectSelect):
    url = reverse_lazy("E-Commerce_admin:simple_cms.page.new")
...
class GDPRSettingsForm(MultiLanguageModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "privacy_policy_page": QuickAddPageSelect(editable_model="E-Commerce_simple_cms.Page"),
...
class GDPRBaseFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            "base",
            GDPRSettingsForm,
            template_name="E-Commerce/admin/gdpr/edit_base_form_part.jinja",
            required=True,
            kwargs={
...
class GDPRCookieCategoryFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            self.name,
            self.formset,
            template_name="E-Commerce/admin/gdpr/edit_cookie_category_form_part.jinja",
            required=False,
            kwargs={
