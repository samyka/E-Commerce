...
from E-Commerce.core.order_creator import OrderCreator, OrderModifier, OrderSource
from E-Commerce.core.order_creator._source import LineSource
from E-Commerce.utils.analog import LogEntryKind
from E-Commerce.utils.numbers import nickel_round, parse_decimal_string
...
class JsonOrderCreator(object):
    ...
    def create_source_from_state(self, state, creator=None, ip_address=None, save=False, order_to_update=None):
        ...
        :type order_to_update: E-Commerce.core.models.Order|None
    ...
    def update_order_from_state(self, state, order_to_update, modified_by=None):
        ...
        :type state: dict
        :param order_to_update: Order object to edit
        :type order_to_update: E-Commerce.core.models.Order
        :return: The created order, or None if something failed along the way
        :rtype: Order|None
        """
