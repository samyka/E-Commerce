    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_tax_groups', models.ManyToManyField(blank=True, verbose_name='customer tax groups', to='E-Commerce.CustomerTaxGroup')),
                ('tax', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='E-Commerce.Tax', verbose_name='tax')),
                ('tax_classes', models.ManyToManyField(verbose_name='tax classes', help_text='Tax classes of the items to be taxed', to='E-Commerce.TaxClass')),
            ],
        ),
    ]
