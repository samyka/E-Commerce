...
from E-Commerce.importer._mapper import RelatedMapper
from E-Commerce.importer.exceptions import ImporterError
from E-Commerce.importer.importing.meta import ImportMetaBase
from E-Commerce.importer.importing.session import DataImporterRowSession
from E-Commerce.importer.utils import copy_update, fold_mapping_name
...
class DataImporter(object):
    ...
    def manually_match(self, imported_field_name, target_field_name):
        ...
        target_model, E-Commerce_field_name = target_field_name.split(":")
        mapping = self.mapping.get(E-Commerce_field_name)

        mapping["matcher"] = self.matcher
        mapping["setter"] = self.set_extra_match

        self.extra_matches[target_field_name] = imported_field_name
        self.mapping[E-Commerce_field_name] = mapping
        return self.mapping
