...
from E-Commerce.admin.modules.service_providers.views import ServiceProviderEditView
...
from E-Commerce.testing.models import PseudoPaymentProcessor
from E-Commerce.testing.utils import apply_all_middleware
...
@pytest.mark.parametrize("sp_model,type_param", [
    (None, None),
    (CustomCarrier, "E-Commerce.customcarrier"),
    (CustomPaymentProcessor, "E-Commerce.custompaymentprocessor")
])
    ...
    with override_settings(LANGUAGES=[("en", "en")]):
        ...
        if type_param:
            ...
            assert selected_type in [
                "E-Commerce.customcarrier", "E-Commerce.custompaymentprocessor",
                "E-Commerce_testing.pseudopaymentprocessor"
            ]
        ...
        if sp_model:
            ...
            if selected_type == "E-Commerce.custompaymentprocessor":
...
@pytest.mark.parametrize("type,extra_inputs", [
    ("E-Commerce.custompaymentprocessor", ["rounding_quantize"]),
    ("E-Commerce_testing.pseudopaymentprocessor", ["bg_color", "fg_color"])
])
