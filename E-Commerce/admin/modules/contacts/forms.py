...
from E-Commerce.core.fields import LanguageFormField
...
class ContactBaseFormMixin(object):
    ...
    def init_fields(self):
        self.fields["groups"] = forms.ModelMultipleChoiceField(
            ...
            required=False,
            widget=QuickAddContactGroupMultiSelect(attrs={"data-model": "E-Commerce.ContactGroup"}),
        ...
        if "tax_group" in self.fields:
            self.fields["tax_group"].widget = QuickAddTaxGroupSelect(editable_model="E-Commerce.CustomerTaxGroup")
