...
<https://github.com/E-Commerce/shoop/commits/v4.0.0>`__.

This is also the last release of Shoop, since the product name will
change to E-Commerce.  The same code base with "shoop" replaced by "E-Commerce"
will be released as E-Commerce 0.4 shortly after Shoop 4.0 release.
...
* Payment and shipping service API is refactored
  ...
  - See this `pull request
    <https://github.com/E-Commerce/E-Commerce-checkoutfi/pull/1/files>`__ as an
