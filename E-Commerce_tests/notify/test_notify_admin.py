...
from E-Commerce.notify.admin_module.forms import ScriptItemEditForm
from E-Commerce.notify.admin_module.views import ScriptEditView, script_item_editor
...
from E-Commerce_tests.notify.fixtures import ATestEvent, TEST_TEMPLATE_DATA
...
def test_notify_item_admin_form(rf, admin_user):
    ...
    script_item = SendEmail({
        ...
        "recipient": {"constant": "hello@E-Commerce.local"},
        "language": {"constant": "en"},
    })
    send_data = {
            "b_recipient_c": "konnichiwa@jp.E-Commerce.local",
            "b_language_c": "en",
            "b_message_c" : "Message",
    ...
    assert script_item.data["recipient"] == {"constant": "konnichiwa@jp.E-Commerce.local"}
