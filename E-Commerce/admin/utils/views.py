...
from E-Commerce.admin.modules.settings.view_settings import ViewSettings
...
from E-Commerce.admin.utils.forms import (
    add_form_errors_as_messages, get_possible_name_fields_for_model
)
from E-Commerce.admin.utils.picotable import Column, PicotableViewMixin
...
def check_and_raise_if_only_one_allowed(setting_name, obj):
    if E-CommerceSettings.get_setting(setting_name):
        return
...
class MassEditMixin(object):
    template_name = "E-Commerce/admin/mass_action/mass_edit.jinja"
    title = _("Mass Edit")
