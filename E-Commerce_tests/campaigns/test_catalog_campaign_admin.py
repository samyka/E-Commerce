...
from E-Commerce.campaigns.admin_module.form_parts import CatalogBaseFormPart
from E-Commerce.campaigns.admin_module.views import CatalogCampaignEditView
