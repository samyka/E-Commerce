...
from E-Commerce.campaigns.admin_module.sections import ProductCampaignsSection
from E-Commerce.campaigns.models.basket_conditions import ProductsInBasketCondition
