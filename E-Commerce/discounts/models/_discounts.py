...
from E-Commerce.core.fields import InternalIdentifierField, MoneyValueField
from E-Commerce.utils.properties import MoneyPropped
...
class Discount(models.Model, MoneyPropped):
    ...
    shops = models.ManyToManyField("E-Commerce.Shop", blank=True, verbose_name=_("shops"))
    supplier = models.ForeignKey(
        "E-Commerce.Supplier", related_name="supplier_discounts", null=True, blank=True,
    ...
    product = models.ForeignKey(
        "E-Commerce.Product", related_name="product_discounts", blank=True, null=True,
    ...
    category = models.ForeignKey(
        "E-Commerce.Category", related_name="category_discounts", blank=True, null=True,
        on_delete=models.CASCADE, verbose_name=_("category"),
        help_text=_("Select category for this discount."))
    contact = models.ForeignKey(
        "E-Commerce.Contact", related_name="contact_discounts", blank=True, null=True,
    ...
    contact_group = models.ForeignKey(
        "E-Commerce.ContactGroup", related_name="contact_group_discounts", blank=True, null=True,
