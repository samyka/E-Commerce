...
from E-Commerce.core.models._product_variation import hash_combination
...
from E-Commerce_tests.core.utils import modify
from E-Commerce_tests.utils import (
...
def test_product_categories(settings):
    with override_settings(E-Commerce_AUTO_SHOP_PRODUCT_CATEGORIES=True):
        shop_product = get_default_shop_product()
    ...
    with override_settings(E-Commerce_AUTO_SHOP_PRODUCT_CATEGORIES=False):
        shop_product.categories.clear()
        shop_product.primary_category = None
        shop_product.save()
