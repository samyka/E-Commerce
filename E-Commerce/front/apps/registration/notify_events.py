...
from E-Commerce.core.models import get_person_contact, PersonContact
from E-Commerce.notify.base import Event, Variable
from E-Commerce.notify.script_template.factory import \
    generic_send_email_script_template_factory
from E-Commerce.notify.typology import Boolean, Email, Model, URL
...
def send_user_registered_notification(user, request, **kwargs):
    ...
    if activation_key:
        activation_path = reverse('E-Commerce:registration_activate', args=(activation_key,))
