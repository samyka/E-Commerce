...
from E-Commerce.admin.modules.suppliers.forms import (
...
class SupplierBaseFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            "base",
            SupplierBaseForm,
            template_name="E-Commerce/admin/suppliers/_edit_base_form.jinja",
            required=True,
            kwargs={
...
class SupplierContactAddressFormPart(FormPart):
    ...
    def get_form_defs(self):
        ...
        yield TemplatedFormDef(
            ...
            template_name="E-Commerce/admin/suppliers/_edit_contact_address_form.jinja",
            required=False,
            kwargs={
...
class SupplierEditView(SaveFormPartsMixin, FormPartsViewMixin, CreateOrUpdateView):
    model = Supplier
    template_name = "E-Commerce/admin/suppliers/edit.jinja"
    ...
    def get_toolbar(self):
        ...
        delete_url = None
        if self.get_object():
            delete_url = reverse("E-Commerce_admin:supplier.delete", kwargs={"pk": self.get_object().pk})
    ...
    def get_object(self, queryset=None):
        ...
        check_and_raise_if_only_one_allowed("E-Commerce_ENABLE_MULTIPLE_SUPPLIERS", obj)
        return obj
