...
from E-Commerce.api.fields import FormattedDecimalField
...
from E-Commerce.core.utils.product_statistics import get_best_selling_product_info
...
class ClosestShopFilter(filters.BaseFilterBackend):
    ...
    Based of `E-Commerce.core.api.shop.NearbyShopsFilter`
    """
    def filter_queryset(self, request, queryset, view):
