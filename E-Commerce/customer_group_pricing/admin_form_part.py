...
class CustomerGroupPricingFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            ...
            template_name="E-Commerce/admin/customer_group_pricing/price_form_part.jinja",
            required=False,
...
class CustomerGroupPricingDiscountFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            ...
            template_name="E-Commerce/admin/customer_group_pricing/discount_form_part.jinja",
            required=False,
            kwargs={"product": self.object.product, "request": self.request}
        )
