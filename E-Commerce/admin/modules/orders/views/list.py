...
from E-Commerce.core.models import Order, OrderStatus, PaymentStatus, ShippingStatus
...
class OrderListView(PicotableListView):
    ...
    mass_actions = [
        ...
        "E-Commerce.admin.modules.orders.mass_actions:OrderDeliveryPdfAction",
    ]
    ...
    def get_toolbar(self):
        toolbar = Toolbar([
            NewActionButton.for_model(
                Order, url=reverse("E-Commerce_admin:order.new")
            ),
