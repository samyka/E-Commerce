    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', enumfields.fields.EnumIntegerField(db_index=True, verbose_name='status', enum=E-Commerce.xtheme.models.SavedViewConfigStatus)),
                ('_data', E-Commerce.core.fields.TaggedJSONField(db_column='data', default=dict, verbose_name='internal data')),
            ],
        ),
        migrations.CreateModel(
            name='ThemeSettings',
            fields=[
                ...
                ('data', E-Commerce.core.fields.TaggedJSONField(db_column='data', default=dict, verbose_name='data')),
            ],
        ),
    ]
