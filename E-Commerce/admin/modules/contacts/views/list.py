...
from E-Commerce.admin.modules.contacts.utils import request_limited
from E-Commerce.admin.shop_provider import get_shop
from E-Commerce.admin.toolbar import NewActionButton, SettingsActionButton, Toolbar
...
class ContactListView(PicotableListView):
    ...
    mass_actions = [
        ...
        "E-Commerce.admin.modules.contacts.mass_actions:EditContactGroupsAction",
    ]
    ...
    def get_toolbar(self):
        ...
        return Toolbar([
            NewActionButton.for_model(
                PersonContact, url=reverse("E-Commerce_admin:contact.new") + "?type=person"
            ),
            NewActionButton.for_model(
                CompanyContact, extra_css_class="btn-info", url=reverse("E-Commerce_admin:contact.new") + "?type=company"
            ),
            settings_button
        ], view=self)
    ...
    def get_object_abstract(self, instance, item):
        """
        :type instance: E-Commerce.core.models.Contact
        """
        bits = filter(None, [
