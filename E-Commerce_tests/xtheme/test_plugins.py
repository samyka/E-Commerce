...
from E-Commerce.core.models import CategoryStatus, CategoryVisibility
...
from E-Commerce.xtheme import resources
from E-Commerce.xtheme._theme import get_current_theme, override_current_theme_class
from E-Commerce.xtheme.layout import LayoutCell
from E-Commerce.xtheme.plugins.category_links import CategoryLinksPlugin
from E-Commerce.xtheme.plugins.image import ImageIDField, ImagePluginChoiceWidget
from E-Commerce.xtheme.plugins.products import (
    HighlightType, ProductHighlightPlugin, ProductSelectionPlugin,
    ProductsFromCategoryPlugin
)
from E-Commerce.xtheme.plugins.snippets import SnippetsPlugin
from E-Commerce.xtheme.plugins.social_media_links import SocialMediaLinksPlugin
from E-Commerce.xtheme.views.forms import LayoutCellFormGroup
from E-Commerce_tests.front.fixtures import get_jinja_context
