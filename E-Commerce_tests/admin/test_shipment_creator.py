...
from E-Commerce.admin.form_modifier import FormModifier
from E-Commerce.admin.modules.orders.views.shipment import (
    OrderCreateShipmentView, ShipmentForm
)
from E-Commerce.apps.provides import override_provides
from E-Commerce.core.excs import NoShippingAddressException
...
def test_extending_shipment_with_extra_fields(rf, admin_user):
    ...
    extend_form_class = "E-Commerce_tests.admin.test_shipment_creator.ShipmentFormModifierTest"
