...
from E-Commerce.utils import djangoenv

from . import data as content_data

# tries to import xtheme stuff
if djangoenv.has_installed("E-Commerce.xtheme"):
...
class BehaviorWizardForm(forms.Form):
    ...
    def save(self):
        ...
        if (self.is_valid() and self.cleaned_data["order_confirm_notification"] and
                djangoenv.has_installed("E-Commerce.notify") and not self._get_saved_script()):

            from E-Commerce.front.notify_events import OrderReceived
            from E-Commerce.notify.models.script import Script
...
class ContentWizardForm(forms.Form):
    ...
    def __init__(self, **kwargs):
        ...
        if djangoenv.has_installed("E-Commerce.simple_cms"):
        ...
        if djangoenv.has_installed("E-Commerce.xtheme"):
            from E-Commerce.xtheme.models import SavedViewConfig
    ...
    def save(self):
        ...
        if djangoenv.has_installed("E-Commerce.xtheme") and self.cleaned_data["configure_footer"]:
        ...
        for create_page, page_identifier in page_create_map:
            ...
            if create_page and page_identifier not in pages:
                ...
                Page.objects.create(
                    ...
                    url=page_identifier,
                    template_name=settings.E-Commerce_SIMPLE_CMS_DEFAULT_TEMPLATE,
