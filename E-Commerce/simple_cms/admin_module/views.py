...
from E-Commerce.admin.forms.widgets import TextEditorWidget
...
class PageBaseFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            self.name,
            PageForm,
            template_name="E-Commerce/simple_cms/admin/_edit_base_page_form.jinja",
            required=True,
            kwargs={
...
class PageEditView(SaveFormPartsMixin, FormPartsViewMixin, CreateOrUpdateView):
    model = Page
    template_name = "E-Commerce/simple_cms/admin/edit.jinja"
    ...
    def get_delete_url(self):
        url = None
        if self.object.pk:
            url = reverse_lazy("E-Commerce_admin:simple_cms.page.delete", kwargs={"pk": self.object.pk})
        return url
...
class PageDeleteView(DetailView):
    ...
    def get_success_url(self, *args, **kwargs):
        return reverse("E-Commerce_admin:simple_cms.page.list")
