...
from E-Commerce.xtheme import parsing, Theme
from E-Commerce.xtheme.editing import is_edit_mode, set_edit_mode
from E-Commerce.xtheme.view_config import Layout
...
def plugin_override():
    return override_provides("xtheme_plugin", [
        ...
        "E-Commerce_tests.xtheme.test_resources:ResourceInjectorPlugin"
    ])
