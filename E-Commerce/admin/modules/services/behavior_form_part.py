...
from E-Commerce.core.models import ServiceBehaviorComponent
from E-Commerce.utils.multilanguage_model_form import TranslatableModelForm
...
class BehaviorComponentFormPart(FormPart):
    ...
    template_name = "E-Commerce/admin/services/_edit_behavior_components_form.jinja"
