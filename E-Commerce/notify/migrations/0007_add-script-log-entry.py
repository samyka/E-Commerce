...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('E-Commerce_notify', '0006_shop_not_null'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='log_entries', to='E-Commerce_notify.Script', verbose_name='target')),
