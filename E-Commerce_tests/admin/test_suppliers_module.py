...
from E-Commerce.admin.modules.suppliers.views import (
    SupplierEditView, SupplierListView,
    SupplierDeleteView)
from E-Commerce.core.models import Supplier, SupplierType
from E-Commerce.testing import factories
from E-Commerce.testing.factories import get_default_supplier
...
def test_suppliers_delete(rf, admin_user):
    ...
    assert response.status_code == 302
    assert response.url == reverse("E-Commerce_admin:supplier.list")
