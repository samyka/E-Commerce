...
from E-Commerce.admin.utils.views import MassEditMixin
from E-Commerce.core.models import Category, Product, ShopProductVisibility
...
class ProductMassEditView(MassEditMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse("E-Commerce_admin:shop_product.list"))
