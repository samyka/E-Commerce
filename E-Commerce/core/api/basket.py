...
from E-Commerce.api.decorators import schema_serializer_class
from E-Commerce.api.fields import EnumField, FormattedDecimalField
from E-Commerce.api.mixins import PermissionHelperMixin
from E-Commerce.core.api.address import AddressSerializer
from E-Commerce.core.api.contacts import PersonContactSerializer
from E-Commerce.core.api.tax import SourceLineTaxSerializer, TaxSummarySerializer
from E-Commerce.core.basket import (
    get_basket_command_dispatcher, get_basket_order_creator
)
from E-Commerce.core.basket.storage import BasketCompatibilityError, get_storage
from E-Commerce.core.excs import ProductNotOrderableProblem
...
class BasketViewSet(PermissionHelperMixin, viewsets.GenericViewSet):
    ...
    def get_basket_shop(self):
        if settings.E-Commerce_ENABLE_MULTIPLE_SHOPS:
            shop_id = None
    ...
    def abandoned(self, request, *args, **kwargs):
        if settings.E-Commerce_BASKET_STORAGE_CLASS_SPEC != "E-Commerce.core.basket.storage:DatabaseBasketStorage":
