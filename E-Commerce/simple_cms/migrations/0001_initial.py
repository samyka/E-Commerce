    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, related_name='children', to='E-Commerce_simple_cms.Page', null=True, verbose_name='parent')),
            ],
            options={
                'verbose_name': 'page',
                'ordering': ('-id',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(related_name='translations', to='E-Commerce_simple_cms.Page', null=True, editable=False)),
            ],
            options={
                'db_tablespace': '',
                'default_permissions': (),
                ...
                'managed': True,
                'db_table': 'E-Commerce_simple_cms_page_translation',
            },
        ),
