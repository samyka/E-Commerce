...
from E-Commerce.admin.modules.shops.views.edit import ShopBaseForm
from django.test.utils import override_settings
from E-Commerce.core.models import ConfigurationItem, Shop, ShopStatus
from E-Commerce.testing.factories import (
    create_product, create_random_order, create_random_person, get_currency,
    get_default_shop, get_default_supplier
)
from E-Commerce_tests.utils import printable_gibberish, SmartClient
from E-Commerce_tests.utils.forms import get_form_data
...
def test_new_shop(rf, admin_user):
    with override_settings(E-Commerce_ENABLE_MULTIPLE_SHOPS=True):
        ...
        client.soup(reverse("E-Commerce_admin:shop.new"))
        payload = {
        ...
        response = client.post(reverse("E-Commerce_admin:shop.new"), data=payload)
...
def test_order_configuration(rf, admin_user):
    ...
    url = reverse("E-Commerce_admin:shop.edit", kwargs={"pk": shop.pk})
    ...
    assert length_field["value"] == str(settings.E-Commerce_REFERENCE_NUMBER_LENGTH)  # default value because nothing set yet
