    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_value', E-Commerce.core.fields.MoneyValueField(blank=True, decimal_places=9, default=None, max_digits=36, null=True, verbose_name='basket total amount')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AlterField(
            model_name='basketcampaign',
            name='shop',
            field=models.ForeignKey(help_text='The shop where the campaign is active.', on_delete=django.db.models.deletion.CASCADE, to='E-Commerce.Shop', verbose_name='shop'),
        ),
        migrations.AlterField(
            model_name='basketcampaign',
            name='start_datetime',
        ...
        migrations.AlterField(
            ...
            name='categories',
            field=models.ManyToManyField(related_name='_categoryproductsbasketcondition_categories_+', to='E-Commerce.Category', verbose_name='categories'),
        ),
        migrations.AlterField(
            model_name='categoryproductsbasketcondition',
            name='excluded_categories',
            field=models.ManyToManyField(blank=True, help_text="If the customer has even a single product in the basket from these categories this rule won't match thus the campaign cannot be applied to the basket.", related_name='_categoryproductsbasketcondition_excluded_categories_+', to='E-Commerce.Category', verbose_name='excluded categories'),
        ),
    ]
