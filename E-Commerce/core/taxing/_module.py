...
from E-Commerce.apps.provides import load_module
...
def get_tax_module():
    ...
    :rtype: E-Commerce.core.taxing.TaxModule
    """
    return load_module("E-Commerce_TAX_MODULE", "tax_module")()


def should_calculate_taxes_automatically():
    """
    If ``settings.E-Commerce_CALCULATE_TAXES_AUTOMATICALLY_IF_POSSIBLE``
    ...
    :rtype: bool
    """
    if not settings.E-Commerce_CALCULATE_TAXES_AUTOMATICALLY_IF_POSSIBLE:
        return False
...
class TaxModule(six.with_metaclass(abc.ABCMeta)):
    ...
    def _get_line_taxes(self, context, line):
        ...
        :type line: E-Commerce.core.order_creator.SourceLine
    ...
    def get_taxed_price(self, context, price, tax_class):
        ...
        :type tax_class: E-Commerce.core.models.TaxClass
