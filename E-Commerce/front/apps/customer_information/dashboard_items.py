...
class CustomerDashboardItem(DashboardItem):
    template_name = "E-Commerce/customer_information/customer_dashboard_item.jinja"
    title = _("Customer Information")
    icon = "fa fa-user"
    _url = "E-Commerce:customer_edit"
