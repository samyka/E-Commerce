...
def get_discount_modules():
    ...
    """
    return load_module_instances("E-Commerce_DISCOUNT_MODULES", "discount_module")
...
class DiscountModule(six.with_metaclass(abc.ABCMeta)):
    ...
    def discount_price(self, context, product, price_info):
        ...
        :type context: E-Commerce.core.pricing.PricingContext
        :param product: Product in question or its id
        :type product: E-Commerce.core.models.Product|int
        :param price_info: Price to discount
        :type price_info: E-Commerce.core.pricing.PriceInfo
    ...
    def discount_prices(self, context, products, price_infos):
        ...
        :type products: Iterable[E-Commerce.core.models.Product|int]
