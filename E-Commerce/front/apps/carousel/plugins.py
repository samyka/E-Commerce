...
from E-Commerce.xtheme.plugins.forms import TranslatableField

from .forms import CarouselConfigForm


class CarouselPlugin(TemplatedPlugin):
    identifier = "E-Commerce.front.apps.carousel.carousel"
    name = _("Carousel Plugin")
    template_name = "E-Commerce/carousel/carousel.jinja"
...
class BannerBoxPlugin(CarouselPlugin):
    identifier = "E-Commerce.front.apps.carousel.banner_box"
    name = _("Banner Box")
    editor_form_class = CarouselConfigForm
    fields = [
