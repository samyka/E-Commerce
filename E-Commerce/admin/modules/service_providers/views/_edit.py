...
from E-Commerce.admin.base import MenuEntry
...
from E-Commerce.core.utils.forms import FormInfoMap


class ServiceProviderEditView(CreateOrUpdateView):
    model = ServiceProvider
    template_name = "E-Commerce/admin/service_providers/edit.jinja"
    ...
    def get_success_url(self):
        return reverse("E-Commerce_admin:service_provider.edit", kwargs={"pk": self.object.pk})

    def get_toolbar(self):
        save_form_id = self.get_save_form_id()
        object = self.get_object()
        delete_url = reverse_lazy("E-Commerce_admin:service_provider.delete", kwargs={"pk": object.pk})
