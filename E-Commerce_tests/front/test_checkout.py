...
from E-Commerce.core.models import get_person_contact, AnonymousContact
from E-Commerce.core.utils.forms import MutableAddressForm
from E-Commerce.front.checkout.addresses import AddressesPhase
from E-Commerce.front.checkout.confirm import ConfirmForm
...
from E-Commerce_tests.front.utils import FieldTestProvider
...
@override_settings(E-Commerce_ADDRESS_HOME_COUNTRY="FI")
...
def test_required_address_fields():
    with override_settings(E-Commerce_ADDRESS_FIELD_PROPERTIES={}):
        form = MutableAddressForm()
...
class AddressesOnlyCheckoutView(BaseCheckoutView):
    phase_specs = ['E-Commerce.front.checkout.addresses:AddressesPhase']
...
def test_confirm_form_field_provides(rf):
    with override_provides("checkout_confirm_form_field_provider", ["E-Commerce_tests.front.utils.FieldTestProvider"]):
