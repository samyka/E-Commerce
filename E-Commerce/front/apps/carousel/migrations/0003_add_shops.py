...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='carousel',
            name='shops',
            field=models.ManyToManyField(help_text='Select which shops you would like the carousel to be visible in.', related_name='carousels', to='E-Commerce.Shop', verbose_name='shops'),
        ),
