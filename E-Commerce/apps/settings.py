...
def get_known_settings():
    """
    Get all settings known to E-Commerce.
...
def validate_templates_configuration():
    ...
    E-Commerce's admin and default frontend require some Django-Jinja configuration, so
    ...
    for template_engine in django.conf.settings.TEMPLATES:
        ...
        if "DjangoTemplates" in backend:
            raise ImproperlyConfigured(
                ...
                "before Django-Jinja. This configuration will not work correctly with E-Commerce."
            )
    ...
    raise ImproperlyConfigured(
        ...
        "See the E-Commerce or Django-Jinja documentation on more information how to configure things correctly."
    )
