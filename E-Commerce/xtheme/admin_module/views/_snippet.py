...
from E-Commerce.admin.utils.picotable import Column, TextFilter
from E-Commerce.admin.utils.views import CreateOrUpdateView, PicotableListView
from E-Commerce.apps.provides import get_provide_objects
from E-Commerce.core import cache
from E-Commerce.xtheme.admin_module.widgets import CodeEditorWidget
from E-Commerce.xtheme.models import Snippet
from E-Commerce.xtheme.resources import GLOBAL_SNIPPETS_CACHE_KEY
...
class SnippetForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from E-Commerce.xtheme.resources import LOCATION_INFO
        location_choices = [
...
class SnippetEditView(CreateOrUpdateView):
    ...
    template_name = "E-Commerce/xtheme/admin/snippet_edit.jinja"
    ...
    def get_toolbar(self):
        ...
        if save_form_id:
            ...
            if self.object and self.object.pk:
                delete_url = reverse_lazy("E-Commerce_admin:xtheme_snippet.delete", kwargs={"pk": self.object.pk})
...
class SnippetDeleteView(BaseDeleteView):
    model = Snippet
    success_url = reverse_lazy("E-Commerce_admin:xtheme_snippet.list")
