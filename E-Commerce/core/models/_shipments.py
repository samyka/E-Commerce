...
from E-Commerce.core.models import E-CommerceModel
from E-Commerce.core.signals import shipment_deleted
...
class Shipment(E-CommerceModel):
    ...
    def set_received(self, purchase_prices=None, created_by=None):
        ...
        :type purchase_prices: dict[E-Commerce.shop.models.Product, decimal.Decimal]
...
class ShipmentProduct(E-CommerceModel):
