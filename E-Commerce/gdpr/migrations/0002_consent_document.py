...
def forwards_func(apps, schema_editor):
    ...
    """
    user_consent_document_model = apps.get_model("E-Commerce_gdpr", "GDPRUserConsentDocument")
    gdpr_user_consent_model = apps.get_model("E-Commerce_gdpr", "GDPRUserConsent")
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='E-Commerce_simple_cms.Page')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, editable=False, to='E-Commerce_gdpr.GDPRUserConsentDocument', verbose_name='consent documents'
            )
        ),
