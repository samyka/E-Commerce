...
from E-Commerce.admin.base import AdminModule, MenuEntry, Notification, SearchResult
from E-Commerce.admin.menu import ORDERS_MENU_CATEGORY, STOREFRONT_MENU_CATEGORY
...
from E-Commerce.core.models import Order, OrderStatus, OrderStatusRole


class OrderModule(AdminModule):
    name = _("Orders")
    breadcrumbs_menu_entry = MenuEntry(name, url="E-Commerce_admin:order.list")

    def get_urls(self):
        return [
            admin_url(
                "^orders/(?P<pk>\d+)/create-shipment/(?P<supplier_pk>\d+)/$",
                "E-Commerce.admin.modules.orders.views.OrderCreateShipmentView",
                name="order.create-shipment"
            ),
            admin_url(
                "^shipments/(?P<pk>\d+)/delete/$",
                "E-Commerce.admin.modules.orders.views.ShipmentDeleteView",
                name="order.delete-shipment"
            ),
            admin_url(
                "^orders/(?P<pk>\d+)/create-payment/$",
                "E-Commerce.admin.modules.orders.views.OrderCreatePaymentView",
                name="order.create-payment"
            ),
            admin_url(
                "^orders/(?P<pk>\d+)/delete-payment/$",
                "E-Commerce.admin.modules.orders.views.OrderDeletePaymentView",
                name="order.delete-payment"
            ),
            admin_url(
                "^orders/(?P<pk>\d+)/set-paid/$",
                "E-Commerce.admin.modules.orders.views.OrderSetPaidView",
                name="order.set-paid"
            ),
            admin_url(
                "^orders/(?P<pk>\d+)/set-status/$",
                "E-Commerce.admin.modules.orders.views.OrderSetStatusView",
                name="order.set-status"
            ),
            admin_url(
                "^orders/(?P<pk>\d+)/new-log-entry/$",
                "E-Commerce.admin.modules.orders.views.NewLogEntryView",
                name="order.new-log-entry"
            ),
            admin_url(
                "^orders/(?P<pk>\d+)/update-admin-comment/$",
                "E-Commerce.admin.modules.orders.views.UpdateAdminCommentView",
                name="order.update-admin-comment"
            ),
            admin_url(
                "^orders/(?P<pk>\d+)/create-refund/$",
                "E-Commerce.admin.modules.orders.views.OrderCreateRefundView",
                name="order.create-refund"
            ),
            admin_url(
                "^orders/(?P<pk>\d+)/create-refund/full-refund$",
                "E-Commerce.admin.modules.orders.views.OrderCreateFullRefundView",
                name="order.create-full-refund"
            ),
            admin_url(
                "^orders/(?P<pk>\d+)/$",
                "E-Commerce.admin.modules.orders.views.OrderDetailView",
                name="order.detail"
            ),
            admin_url(
                "^orders/new/$",
                "E-Commerce.admin.modules.orders.views.OrderEditView",
                name="order.new"
            ),
            admin_url(
                "^orders/(?P<pk>\d+)/edit/$",
            ...
            admin_url(
                "^orders/$",
                "E-Commerce.admin.modules.orders.views.OrderListView",
                name="order.list"
            ...
            admin_url(
                ...
                "E-Commerce.admin.modules.orders.views.OrderAddressEditView",
    ...
    def get_menu_entries(self, request):
        return [
            MenuEntry(
                text=_("Orders"),
                icon="fa fa-inbox",
                url="E-Commerce_admin:order.list",
    ...
    def get_model_url(self, object, kind, shop=None):
        return derive_model_url(Order, "E-Commerce_admin:order", object, kind)
...
class OrderStatusModule(AdminModule):
    name = _("Order Status")
    breadcrumbs_menu_entry = MenuEntry(name, url="E-Commerce_admin:order_status.list")
    ...
    def get_menu_entries(self, request):
        return [
            MenuEntry(
                text=_("Order Status"),
                icon="fa fa-inbox",
                url="E-Commerce_admin:order_status.list",
    ...
    def get_model_url(self, object, kind, shop=None):
        return derive_model_url(OrderStatus, "E-Commerce_admin:order_status", object, kind)
