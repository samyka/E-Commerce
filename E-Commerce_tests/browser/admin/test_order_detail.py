...
from E-Commerce.admin.modules.orders.views.addresses import ADDRESS_EDITED_LOG_IDENTIFIER
...
from E-Commerce.testing.factories import create_empty_order, get_default_shop
...
def change_addresses(live_server, browser, order):
    edit_url = reverse("E-Commerce_admin:order.edit-addresses", kwargs={"pk": order.pk})
...
def set_status(browser, order, status):
    ...
    form_action = reverse("E-Commerce_admin:order.set-status", kwargs={"pk": order.pk})
