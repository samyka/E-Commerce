...
from E-Commerce.core.models import Order, ProductMode
...
class OrderListView(DashboardViewMixin, OrderViewMixin, django.views.generic.ListView):
    template_name = 'E-Commerce/personal_order_history/order_list.jinja'
    context_object_name = 'orders'


class OrderDetailView(DashboardViewMixin, OrderViewMixin, django.views.generic.DetailView):
    template_name = 'E-Commerce/personal_order_history/order_detail.jinja'
...
class ReorderView(View):
    def get(self, request, *args, **kwargs):
        try:
            ...
            return HttpResponseRedirect(reverse("E-Commerce:show-order", kwargs=kwargs))
        ...
        return HttpResponseRedirect(reverse("E-Commerce:basket"))
