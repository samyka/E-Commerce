...
from E-Commerce.admin.form_part import FormPart, TemplatedFormDef
from E-Commerce.admin.modules.products.forms import (
    SimpleVariationChildForm, SimpleVariationChildFormSet,
    VariableVariationChildrenForm, VariationVariablesDataForm
)
from E-Commerce.admin.toolbar import PostActionButton
from E-Commerce.core.models import ProductMode, ProductVariationVariable
...
class VariationChildrenFormPart(ProductChildrenBaseFormPart):
    ...
    def get_form_defs(self):
        ...
        if product.mode in self.invalid_modes:
            ...
            template_name = "E-Commerce/admin/products/variation/_variable_variation_children.jinja"
        else:
            form = formset_factory(SimpleVariationChildForm, SimpleVariationChildFormSet, extra=5, can_delete=True)
            template_name = "E-Commerce/admin/products/variation/_simple_variation_children.jinja"
...
class VariationVariablesFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            ...
            template_name="E-Commerce/admin/products/variation/_variation_variables.jinja",
            required=False,
...
class ProductVariationView(ProductParentBaseView):
    template_name = "E-Commerce/admin/products/variation/edit.jinja"
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if self.object.variation_parent_id:
            ...
            return HttpResponseRedirect(
                reverse("E-Commerce_admin:shop_product.edit_variation", kwargs={"pk": self.object.variation_parent_id})
            )
