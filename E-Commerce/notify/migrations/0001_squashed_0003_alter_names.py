...
class Migration(migrations.Migration):
    replaces = [
        ('E-Commerce_notify', '0001_initial'),
        ('E-Commerce_notify', '0002_notify_script_template'),
        ('E-Commerce_notify', '0003_alter_names'),
    ]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient_type', enumfields.fields.EnumIntegerField(
                    ...
                    enum=E-Commerce.notify.enums.RecipientType)),
                ...
                ('priority', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    enum=E-Commerce.notify.enums.Priority)),
