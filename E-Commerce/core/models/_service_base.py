...
from E-Commerce.core.fields import InternalIdentifierField
from E-Commerce.core.pricing import PriceInfo

from ._base import (
    PolymorphicE-CommerceModel, PolymorphicTranslatableE-CommerceModel,
    PolyTransModelBase, TranslatableE-CommerceModel
)
from ._product_shops import ShopProduct
from ._shops import Shop


class ServiceProvider(PolymorphicTranslatableE-CommerceModel):
    """
    ...
    def create_service(self, choice_identifier, **kwargs):
        ...
        :rtype: E-Commerce.core.models.Service
        """
    ...
    def get_effective_name(self, service, source):
        ...
        :type service: E-Commerce.core.models.Service
        :type source: E-Commerce.core.order_creator.OrderSource
        :rtype: str
        """
        return service.name
...
class Service(TranslatableE-CommerceModel):
    """
    ...
    def provider(self):
        """
        :rtype: E-Commerce.core.models.ServiceProvider
        """
    ...
    def get_effective_name(self, source):
        ...
        for `~E-Commerce.core.models.ServiceProvider.get_effective_name`
...
class ServiceCost(object):
    ...
    def __init__(
        ...
        :type price: E-Commerce.core.pricing.Price
        :type description: str|None
        :type tax_class: E-Commerce.core.models.TaxClass|None
        :type base_price: E-Commerce.core.pricing.Price|None
        """
...
class ServiceBehaviorComponent(PolymorphicE-CommerceModel):
    ...
    def get_delivery_time(self, service, source):
        ...
        :type service: Service
        :type source: E-Commerce.core.order_creator.OrderSource
        :rtype: E-Commerce.utils.dates.DurationRange|None
        """
        return None


_translatable_model = (
    PolymorphicTranslatableE-CommerceModel if django.VERSION >= (1, 11)
    else TranslatableE-CommerceModel)
