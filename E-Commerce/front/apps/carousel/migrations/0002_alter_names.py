...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='slide',
            name='category_link',
            field=models.ForeignKey(blank=True, help_text='Set the product category page that should be shown when this slide is clicked, if any.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='E-Commerce.Category', verbose_name='category link'),
        ),
        migrations.AlterField(
            model_name='slide',
            name='cms_page_link',
            field=models.ForeignKey(blank=True, help_text='Set the web page that should be shown when the slide is clicked, if any.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='E-Commerce_simple_cms.Page', verbose_name='cms page link'),
        ),
        migrations.AlterField(
            model_name='slide',
            name='ordering',
        ...
        migrations.AlterField(
            model_name='slide',
            name='product_link',
            field=models.ForeignKey(blank=True, help_text='Set the product detail page that should be shown when this slide is clicked, if any.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='E-Commerce.Product', verbose_name='product link'),
        ),
        migrations.AlterField(
            model_name='slide',
            name='target',
            field=enumfields.fields.EnumIntegerField(default=0, enum=E-Commerce.front.apps.carousel.models.LinkTargetType, help_text='Set this to current if clicking on this slide should open a new browser tab.', verbose_name='link target'),
        ),
        migrations.AlterField(
