...
import E-Commerce.front.apps.carousel.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('animation', enumfields.fields.EnumIntegerField(help_text='Animation type for cycling slides.', enum=E-Commerce.front.apps.carousel.models.CarouselMode, verbose_name='animation', default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', enumfields.fields.EnumIntegerField(verbose_name='link target', enum=E-Commerce.front.apps.carousel.models.LinkTargetType, default=0)),
                ...
                ('category_link', models.ForeignKey(to='E-Commerce.Category', related_name='+', null=True, verbose_name='category link', blank=True)),
                ('cms_page_link', models.ForeignKey(to='E-Commerce_simple_cms.Page', related_name='+', null=True, verbose_name='cms page link', blank=True)),
                ('product_link', models.ForeignKey(to='E-Commerce.Product', related_name='+', null=True, verbose_name='product link', blank=True)),
            ],
            options={
