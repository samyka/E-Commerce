...
from E-Commerce.core.models import ProductMode, Shop, ShopProduct
...
class ProductListView(PicotableListView):
    ...
    related_objects = [
        ("product", "E-Commerce.core.models:Product"),
    ]

    mass_actions = [
        "E-Commerce.admin.modules.products.mass_actions:VisibleMassAction",
        "E-Commerce.admin.modules.products.mass_actions:InvisibleMassAction",
    ...
    def __init__(self):
        ...
        if settings.E-Commerce_ENABLE_MULTIPLE_SUPPLIERS and not get_suppliers_column(self.default_columns):
    ...
    def get_primary_image(self, instance):
        ...
        return "<img src='%s'>" % static("E-Commerce_admin/img/no_image_thumbnail.png")
