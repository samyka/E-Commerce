...
import E-Commerce.notify.enums
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient_type', enumfields.fields.EnumIntegerField(verbose_name='recipient type', default=1, enum=E-Commerce.notify.enums.RecipientType)),
                ('created_on', models.DateTimeField(verbose_name='created on', auto_now_add=True)),
                ('message', models.CharField(verbose_name='message', editable=False, max_length=140, default='')),
                ('identifier', E-Commerce.core.fields.InternalIdentifierField(max_length=64, null=True, unique=False, editable=False, blank=True)),
                ('priority', enumfields.fields.EnumIntegerField(verbose_name='priority', db_index=True, default=2, enum=E-Commerce.notify.enums.Priority)),
