...
class ProductChildrenFormPart(ProductChildrenBaseFormPart):
    ...
    def get_form_defs(self):
        ...
        if product.mode in self.invalid_modes:
            ...
            template_name = "E-Commerce/admin/products/package/_package_children.jinja"
...
class ProductPackageView(ProductParentBaseView):
    template_name = "E-Commerce/admin/products/package/edit.jinja"
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if parent:
            ...
            return HttpResponseRedirect(
                reverse("E-Commerce_admin:shop_product.edit_package", kwargs={"pk": parent.id})
            )
