...
from E-Commerce.testing.factories import get_address
...
def test_home_country_in_address():
    with override("fi"):
        ...
        with override_settings(E-Commerce_ADDRESS_HOME_COUNTRY="US"):
            assert "Suomi" in str(finnish_address), "When home is not Finland, Finland appears in address string"
        with override_settings(E-Commerce_ADDRESS_HOME_COUNTRY="FI"):
