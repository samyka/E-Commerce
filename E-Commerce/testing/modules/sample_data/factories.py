...
from E-Commerce.testing.modules.sample_data import SAMPLE_IMAGES_BASE_DIR
...
def create_sample_product(name, description, business_segment, image_file, shop):
    ...
    # configure prices
    if "E-Commerce.customer_group_pricing" in settings.INSTALLED_APPS:
...
def create_sample_carousel(carousel_data, business_segment, shop):
    if 'E-Commerce.front.apps.carousel' not in settings.INSTALLED_APPS:
        return
