...
from E-Commerce.core.pricing import Price, Priceful, TaxfulPrice, TaxlessPrice
from E-Commerce.core.taxing import should_calculate_taxes_automatically, TaxableItem
from E-Commerce.core.utils.line_unit_mixin import LineWithUnit
from E-Commerce.utils.decorators import non_reentrant
from E-Commerce.utils.i18n import is_existing_language
...
class OrderSource(object):
    ...
    def smart_product_count(self):
        ...
        `~E-Commerce.core.models.UnitInteface.allow_bare_number`) and its
...
class SourceLine(TaxableItem, Priceful, LineWithUnit):
    ...
    def taxes(self):
        ...
        :rtype: list[E-Commerce.core.taxing.LineTax]
        """
