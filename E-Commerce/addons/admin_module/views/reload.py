...
from E-Commerce.addons.manager import get_enabled_addons
from E-Commerce.addons.reloader import get_reload_method_classes
from E-Commerce.apps.settings import reload_apps
...
class ReloadView(FormView):
    template_name = "E-Commerce/admin/addons/reload.jinja"
