...
from E-Commerce.front.utils import cache as cache_utils
from E-Commerce.front.utils.companies import allow_company_registration
from E-Commerce.front.utils.product_statistics import get_best_selling_product_info
from E-Commerce.front.utils.translation import get_language_choices
from E-Commerce.front.utils.user import is_admin_user
from E-Commerce.front.utils.views import cache_product_things
from E-Commerce.utils.importing import cached_load
from E-Commerce.utils.mptt import get_cached_trees
from E-Commerce.utils.translation import cache_translations_for_tree


def get_login_form(request, id_prefix="quick-login"):
    # Getting the form from the Login view
    form = cached_load("E-Commerce_LOGIN_VIEW")(request=request).get_form(id_prefix=id_prefix)
    return form
...
def _get_listed_products(context, n_products, ordering=None,    # noqa (C901)
    ...
    :rtype: list[E-Commerce.core.models.Product]
    """
...
def get_admin_edit_url(context, intance_or_model):
    from E-Commerce.admin.template_helpers.E-Commerce_admin import model_url
...
def get_powered_by_content(context):
    return settings.E-Commerce_FRONT_POWERED_BY_CONTENT
