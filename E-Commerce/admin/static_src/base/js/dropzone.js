...
function activateDropzone($dropzone, attrs={}) {
    ...
    const uploadUrl = $data.upload_url || window.E-CommerceAdminConfig.browserUrls.media;
    const browsable = (window.E-CommerceAdminConfig.browserUrls["media"] && $data.browsable && $data.browsable !== "False");
