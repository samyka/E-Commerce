...
from E-Commerce.admin.urls import login
...
from E-Commerce.front.middleware import E-CommerceFrontMiddleware
from E-Commerce.front.views.index import IndexView
from E-Commerce.testing.factories import create_random_company, get_default_shop
...
def check_request_attribute_basics(request):
    ...
    assert isinstance(request.basket, E-Commerce.front.basket.objects.BaseBasket)
