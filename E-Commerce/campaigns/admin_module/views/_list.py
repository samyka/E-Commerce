...
class CatalogCampaignListView(CampaignListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["toolbar"] = Toolbar([
            NewActionButton("E-Commerce_admin:catalog_campaign.new", text=_("Create new Catalog Campaign")),
            settings_button
        ], view=self)
        return context
...
class BasketCampaignListView(CampaignListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_superuser:
            ...
            settings_button = None
        context["toolbar"] = Toolbar([
            NewActionButton("E-Commerce_admin:basket_campaign.new", text=_("Create new Basket Campaign")),
            settings_button
        ], view=self)
        return context
