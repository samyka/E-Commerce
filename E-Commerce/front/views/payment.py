...
from E-Commerce.core.models import Order, PaymentUrls
...
def get_payment_urls(request, order):
    ...
    return PaymentUrls(
        payment_url=absolute_url_for("E-Commerce:order_process_payment"),
        return_url=absolute_url_for("E-Commerce:order_process_payment_return"),
        cancel_url=absolute_url_for("E-Commerce:order_payment_canceled"),
    )
...
class ProcessPaymentView(DetailView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if mode == "payment":
            ...
            self.template_name = "E-Commerce/front/order/payment_canceled.jinja"
        ...
        return redirect("E-Commerce:order_complete", pk=order.pk, key=order.key)
