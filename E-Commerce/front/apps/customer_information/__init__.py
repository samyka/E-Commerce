...
class AppConfig(E-Commerce.apps.AppConfig):
    name = __name__
    verbose_name = _('E-Commerce Frontend - Customer Information Editing')
    label = 'E-Commerce_front.customer_information'
    ...
    provides = {
        ...
        "notify_event": [
            "E-Commerce.front.apps.customer_information.notify_events:CompanyAccountCreated"
        ]
    }
