...
from E-Commerce.importer.admin_module.forms import ImportForm, ImportSettingsForm
from E-Commerce.importer.transforms import transform_file
from E-Commerce.importer.utils import (
...
class ImportProcessView(TemplateView):
    template_name = "E-Commerce/importer/admin/import_process.jinja"
    importer = None
    ...
    def post(self, request, *args, **kwargs):
        ...
        if not prepared:
            return redirect(reverse("E-Commerce_admin:importer.import"))
        try:
            with atomic():
        ...
        self.template_name = "E-Commerce/importer/admin/import_process_complete.jinja"
...
class ImportView(FormView):
    template_name = "E-Commerce/importer/admin/import.jinja"
