...
from E-Commerce.core.models import ProductVisibility, ShopProductVisibility
from E-Commerce.front.apps.simple_search.forms import get_search_product_ids
from E-Commerce.front.apps.simple_search.views import SearchView
