...
from E-Commerce.front.apps.auth.views import LoginView
from E-Commerce.front.apps.registration.views import RegistrationNoActivationView
...
class CheckoutMethodPhase(CheckoutPhaseViewMixin, LoginView):
    ...
    template_name = "E-Commerce/front/checkout/checkout_method.jinja"
...
class RegisterPhase(CheckoutPhaseViewMixin, RegistrationNoActivationView):
    identifier = "register"
    title = _("Register")
    template_name = "E-Commerce/front/checkout/register.jinja"
