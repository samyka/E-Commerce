...
request_finished.connect(_clear_versions_for_request, dispatch_uid="E-Commerce.core.cache._clear_versions_for_request")
...
def get_cache_duration(cache_key):
    ...
    duration = settings.E-Commerce_CACHE_DURATIONS.get(namespace)
    if duration is None:
        duration = DEFAULT_CACHE_DURATIONS.get(namespace, settings.E-Commerce_DEFAULT_CACHE_DURATION)
    return duration
