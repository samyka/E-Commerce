    ...
    class CategoryFormPart(FormPart):
        ...
        def get_form_defs(self):
            ...
            yield TemplatedFormDef(
                ...
                template_name="E-Commerce/autoform/admin/autoform.jinja",
                required=False
            )
...
defined in the ``CategoryFormPart``: ``E-Commerce/autoform/admin/autoform.jinja``
...
way of extending the functionality of your E-Commerce.
