...
from E-Commerce.core.models import Order, OrderLine, OrderLineType, ShopProduct
from E-Commerce.core.order_creator.signals import (
...
from E-Commerce.core.utils.users import real_user_or_none
from E-Commerce.utils.deprecation import RemovedFromE-CommerceWarning
from E-Commerce.utils.numbers import bankers_round
...
class OrderProcessor(object):
    ...
    def source_line_to_order_lines(self, order, source_line):
        ...
        :type order: E-Commerce.core.models.Order
        :param order: The order
        :type source_line: E-Commerce.core.order_creator.SourceLine
    ...
    def create_package_children(self, order_line):
        ...
        # :type parent_product: E-Commerce.core.models.Product
    ...
    def __init__(self, request=None):
        ...
        if request is not None:
            warnings.warn(
                ...
                RemovedFromE-CommerceWarning, stacklevel=2)
