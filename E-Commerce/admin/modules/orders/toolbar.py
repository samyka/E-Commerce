...
from E-Commerce.core.models import OrderStatus
...
class OrderDetailToolbar(Toolbar):
    ...
    def _build_edit_button(self):
        self.append(URLActionButton(
            ...
            url=reverse("E-Commerce_admin:order.edit", kwargs={"pk": self.order.pk}),
...
class CreatePaymentAction(DropdownItem):
    def __init__(self, object, **kwargs):
        kwargs["url"] = reverse("E-Commerce_admin:order.create-payment", kwargs={"pk": object.pk})
...
class SetPaidAction(PostActionDropdownItem):
    def __init__(self, object, **kwargs):
        kwargs["post_url"] = reverse("E-Commerce_admin:order.set-paid", kwargs={"pk": object.pk})
...
class CreateRefundAction(DropdownItem):
    def __init__(self, object, **kwargs):
        kwargs["url"] = reverse("E-Commerce_admin:order.create-refund", kwargs={"pk": object.pk})
...
class EditAddresses(DropdownItem):
    def __init__(self, object, **kwargs):
        kwargs["url"] = reverse("E-Commerce_admin:order.edit-addresses", kwargs={"pk": object.pk})
