...
from E-Commerce.reports.utils import parse_date_range
from E-Commerce.reports.writer import get_writer_names
...
class E-CommerceReportForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(E-CommerceReportForm, self).__init__(*args, **kwargs)

    def get_report_instance(self, request=None):
        """
        :rtype: E-Commerce.reports.reporter.base.E-CommerceReportBase
        """
        from E-Commerce.reports.report import get_report_class
...
class BaseReportForm(E-CommerceReportForm):
