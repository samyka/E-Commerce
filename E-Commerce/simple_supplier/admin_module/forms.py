...
from E-Commerce.core.models import Product, Supplier
from E-Commerce.simple_supplier.module import SimpleSupplierModule
from E-Commerce.simple_supplier.utils import (
    ...
    def get_form_defs(self):
        if self.object.pk:  # Don't yield form if product is in new mode
            yield TemplatedFormDef(
                ...
                template_name="E-Commerce/simple_supplier/admin/product_form_part.jinja",
                required=False,
