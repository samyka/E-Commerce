...
def update_module_attributes(object_names, module_name):
    ...
    Use case for this function in E-Commerce is to hide the actual location
...
class E-CommerceUtilsAppConfig(E-Commerce.apps.AppConfig):
    name = __name__
    verbose_name = _("E-Commerce Utilities")
    label = "E-Commerce_utils"


default_app_config = __name__ + ".E-CommerceUtilsAppConfig"
