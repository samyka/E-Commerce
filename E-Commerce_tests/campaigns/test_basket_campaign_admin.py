...
from E-Commerce.campaigns.admin_module.form_parts import BasketBaseFormPart
from E-Commerce.campaigns.admin_module.forms import FreeProductLineForm
from E-Commerce.campaigns.admin_module.views import BasketCampaignEditView
from E-Commerce.campaigns.models.campaigns import BasketCampaign
from E-Commerce.campaigns.models.basket_conditions import BasketTotalProductAmountCondition
from E-Commerce.campaigns.models.basket_effects import BasketDiscountAmount
from E-Commerce.testing.factories import get_default_shop, get_default_product
...
def test_rules_and_effects(rf, admin_user):
    ...
    with override_settings(LANGUAGES=[("en", "en")]):
        ...
        with override_provides(
                "campaign_basket_condition", ["E-Commerce.campaigns.admin_module.forms:BasketTotalProductAmountConditionForm"]):
            with override_provides(
                    "campaign_basket_discount_effect_form", ["E-Commerce.campaigns.admin_module.forms:BasketDiscountAmountForm"]):
                with override_provides("campaign_basket_line_effect_form", []):
