...
from E-Commerce.core.fields import CurrencyField, MoneyValueField, TaggedJSONField
from E-Commerce.core.models import Contact, PersonContact, Product, Shop
