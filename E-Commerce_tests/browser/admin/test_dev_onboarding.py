...
from E-Commerce.core.models import AnonymousContact, Product, Shop, Supplier
...
def test_dev_onboarding(browser, admin_user, live_server, settings):
    ...
    click_element(browser, "div[data-identifier='candy_pink'] button[data-theme='E-Commerce.themes.classic_gray']")
    click_element(browser, "button[name='next']")
    ...
    wait_until_condition(browser, lambda x: x.is_text_present("Welcome to E-Commerce!"))
