...
import E-Commerce.core.models._service_payment
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='rounding_mode',
            field=enumfields.fields.EnumField(enum=E-Commerce.core.models._service_payment.RoundingMode, help_text='Rounding mode for cash payment.', max_length=50, verbose_name='rounding mode', default='ROUND_HALF_UP'),
        ),
        migrations.AddField(
            model_name='custompaymentprocessor',
