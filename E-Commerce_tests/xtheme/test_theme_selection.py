...
from E-Commerce.apps.provides import get_provide_objects, override_provides
from E-Commerce.testing.factories import get_default_shop
from E-Commerce.xtheme import set_current_theme
from E-Commerce.xtheme.models import ThemeSettings
from E-Commerce.xtheme.testing import override_current_theme_class
from E-Commerce_tests.xtheme.utils import get_jinja2_engine
...
def test_theme_selection():
    ...
    with override_current_theme_class(), override_provides("xtheme", [
        ...
        "E-Commerce_tests.xtheme.utils:H2G2Theme",
    ]):
