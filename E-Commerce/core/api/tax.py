...
from E-Commerce.core.api.front_orders import OrderLineSerializer
from E-Commerce.core.models import OrderLineTax, Tax, TaxClass
...
class TaxSummarySerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        from E-Commerce.core.taxing._tax_summary import TaxSummaryLine
