...
from E-Commerce.admin.modules.products.mass_actions import InvisibleMassAction
from E-Commerce.admin.modules.products.views import (
    ProductListView, ProductMassEditView
)
from E-Commerce.core.models import Product, ShopProductVisibility
