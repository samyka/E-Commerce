...
from E-Commerce.admin.utils.forms import add_form_errors_as_messages
...
from E-Commerce.core.models import Order, Product, Shipment
...
class OrderCreateShipmentView(ModifiableViewMixin, UpdateView):
    model = Order
    template_name = "E-Commerce/admin/orders/create_shipment.jinja"
    ...
    def create_shipment(self, order, product_quantities, shipment):
        ...
        :type shipment: E-Commerce.core.models.Shipment
