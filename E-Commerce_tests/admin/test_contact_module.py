...
from E-Commerce.admin.modules.contacts import ContactModule
from E-Commerce.admin.modules.contacts.views.detail import ContactDetailView
from E-Commerce.admin.modules.contacts.views.list import ContactListView
