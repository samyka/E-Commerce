...
from E-Commerce.admin.signals import object_created, object_saved
...
from E-Commerce.utils.i18n import (
...
class OrderEditView(CreateOrUpdateView):
    model = Order
    template_name = "E-Commerce/admin/orders/create.jinja"
    ...
    def get_config(self):
        ...
        return {
            "shops": shops,
            "countryDefault": settings.E-Commerce_ADDRESS_HOME_COUNTRY,
    ...
    def _handle_finalize(self, request):
        ...
        return JsonResponse({
            ...
            "url": reverse("E-Commerce_admin:order.detail", kwargs={"pk": order.pk})
        })
