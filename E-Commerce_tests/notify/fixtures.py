...
from E-Commerce.notify.base import Action, Event, Variable
...
from E-Commerce.notify.template import Template
from E-Commerce.notify.typology import Language, Model, Text
