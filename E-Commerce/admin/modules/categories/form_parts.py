...
from E-Commerce.admin.modules.categories.forms import (
...
class CategoryBaseFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            "base",
            CategoryBaseForm,
            template_name="E-Commerce/admin/categories/_edit_base_form.jinja",
            required=True,
...
class CategoryProductFormPart(FormPart):
    ...
    def get_form_defs(self):
        ...
        yield TemplatedFormDef(
            ...
            CategoryProductForm,
            template_name="E-Commerce/admin/categories/_edit_products_form.jinja",
            required=True,
