...
from E-Commerce.campaigns.models.campaigns import CatalogCampaign
from E-Commerce.campaigns.models.catalog_filters import (
    CategoryFilter, ProductFilter, ProductTypeFilter
)
from E-Commerce.campaigns.models.context_conditions import (
    ContactGroupCondition
)
from E-Commerce.campaigns.models.product_effects import (
...
@override_settings(E-Commerce_DISCOUNT_MODULES=["customer_group_discount", "catalog_campaigns"])
...
def test_admin_order_with_campaign(rf, admin_user):
    with override_settings(E-Commerce_DISCOUNT_MODULES=["customer_group_discount", "catalog_campaigns"]):
        request, shop, group = initialize_test(rf, False)
