...
from E-Commerce.core.models import get_company_contact, get_person_contact
from E-Commerce.front.apps.registration.forms import CompanyRegistrationForm
from E-Commerce.front.template_helpers import urls
...
def activation_complete(request):
    ...
    if urls.has_url('E-Commerce:customer_edit'):
...
def registration_complete(request):
    if settings.E-Commerce_REGISTRATION_REQUIRES_ACTIVATION:
        messages.success(
...
class CompanyRegistrationView(RegistrationViewMixin, default_views.RegistrationView):
    template_name = "E-Commerce/registration/company_register.jinja"
    ...
    def dispatch(self, request, *args, **kwargs):
        if not allow_company_registration(request.shop):
            return redirect("E-Commerce:registration_register")
...
class ActivationView(default_views.ActivationView):
    template_name = "E-Commerce/registration/activation_failed.jinja"

    def get_success_url(self, *args, **kwargs):
        return ('E-Commerce:registration_activation_complete', (), {})
