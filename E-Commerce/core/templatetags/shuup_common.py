...
"""
Common helpers for E-Commerce templates.

.. note::

   In addition to these, also the price rendering tags from
   `E-Commerce.core.templatetags.prices` module are available.
"""
...
def money(amount, digits=None, widen=0):
    ...
    :type amount: E-Commerce.utils.money.Money
