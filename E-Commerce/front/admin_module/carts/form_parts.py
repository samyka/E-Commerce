...
CART_UPDATE_DELAY_CONF_KEY = "E-Commerce_front_cart_update_delay"
...
class CartDelayConfigurationForm(forms.Form):
    E-Commerce_front_cart_update_delay = forms.IntegerField(
        required=False,
        min_value=0,
...
class CartDelayFormPart(FormPart):
    ...
    def get_form_defs(self):
        ...
        initial = {"E-Commerce_front_cart_update_delay":  get_cart_delay_hours(self.object)}
        yield TemplatedFormDef(
            name=self.name,
            form_class=self.form,
            template_name="E-Commerce/front/admin/cart_delay.jinja",
            required=False,
    ...
    def form_valid(self, form):
        ...
        set_cart_delay_hours(self.object, data.get("E-Commerce_front_cart_update_delay"))
