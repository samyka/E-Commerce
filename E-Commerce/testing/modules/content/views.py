...
from E-Commerce.admin.views.wizard import TemplatedWizardFormDef, WizardPane
...
class ContentWizardPane(WizardPane):
    ...
    """
    identifier = "content"
    icon = "E-Commerce_admin/img/configure.png"
    ...
    def valid(self):
        ...
        return (djangoenv.has_installed("E-Commerce.simple_cms") or djangoenv.has_installed("E-Commerce.xtheme") or
                djangoenv.has_installed("E-Commerce.notify"))

    @property
    def text(self):
        cms_xtheme_installed = (djangoenv.has_installed("E-Commerce.simple_cms") or djangoenv.has_installed("E-Commerce.xtheme"))
        notify_installed = djangoenv.has_installed("E-Commerce.notify")
    ...
    def get_form_defs(self):
        ...
        if djangoenv.has_installed("E-Commerce.simple_cms") or djangoenv.has_installed("E-Commerce.xtheme"):
            form_defs.append(
                TemplatedWizardFormDef(
                    name="content",
                    template_name="E-Commerce/admin/content/wizard.jinja",
        ...
        if djangoenv.has_installed("E-Commerce.notify") and djangoenv.has_installed("E-Commerce.front"):
            form_defs.append(
                TemplatedWizardFormDef(
                    name="behaviors",
                    template_name="E-Commerce/admin/content/wizard.jinja",
