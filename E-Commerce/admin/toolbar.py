...
from E-Commerce.admin.utils.str_utils import camelcase_to_snakecase
...
class SettingsActionButton(URLActionButton):
    ...
    def for_model(cls, model, **kwargs):
        ...
        :rtype: E-Commerce.admin.toolbar.SettingsActionButton|None
        """
...
class NewActionButton(URLActionButton):
    ...
    def for_model(cls, model, **kwargs):
        ...
        :param model: Model class
        :rtype: E-Commerce.admin.toolbar.NewActionButton|None
        """
...
class Toolbar(list):
    ...
    def render(self, request):
        ...
        yield '<div class="E-Commerce-toolbar">'
