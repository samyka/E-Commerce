...
from E-Commerce.admin.forms.fields import PercentageField
...
from E-Commerce.core.models import Category, ContactGroup, Supplier
from E-Commerce.discounts.admin.widgets import (
    QuickAddAvailabilityExceptionMultiSelect, QuickAddCouponCodeSelect,
    QuickAddHappyHourMultiSelect
)
from E-Commerce.discounts.models import (
...
class DiscountForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "category": QuickAddCategorySelect(editable_model="E-Commerce.Category"),
            "contact_group": QuickAddContactGroupSelect(editable_model="E-Commerce.ContactGroup"),
...
class DiscountEditView(CreateOrUpdateView):
    ...
    template_name = "E-Commerce/discounts/discount_edit.jinja"
    ...
    def get_toolbar(self):
        ...
        delete_url = (
            reverse_lazy("E-Commerce_admin:discounts.delete", kwargs={"pk": object.pk})
