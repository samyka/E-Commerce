...
class TaxedPrice(object):
    ...
    .. attribute:: taxful
       ...
       (`~E-Commerce.core.pricing.TaxfulPrice`)
    ...
    .. attribute:: taxes
       ...
       (`list[E-Commerce.core.taxing.LineTax]`)
    ...
    def __init__(self, taxful, taxless, taxes=None):
        ...
        :type taxful: E-Commerce.core.pricing.TaxfulPrice
        :param taxful: Price including taxes.
        :type taxless: E-Commerce.core.pricing.TaxlessPrice
        :param taxless: Pretax price.
        :type taxes: list[E-Commerce.core.taxing.LineTax]|None
