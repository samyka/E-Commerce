...
class Price(Money):
    ...
    will raise an :obj:`~E-Commerce.utils.numbers.UnitMixupError`.

    In addition to `includes_tax` info, Prices are Money and know their
    `~E-Commerce.utils.numbers.UnittedDecimal.value` and
    `~E-Commerce.utils.money.Money.currency`.  To get the bare Money amount
