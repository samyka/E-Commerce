...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='attribute',
            name='type',
            field=enumfields.fields.EnumIntegerField(default=20, enum=E-Commerce.core.models.AttributeType, help_text='The attribute data type. Attribute values can be set on the product editor page.', verbose_name='type'),
        ),
        migrations.AlterField(
            model_name='attribute',
            name='visibility_mode',
            field=enumfields.fields.EnumIntegerField(default=1, enum=E-Commerce.core.models.AttributeVisibility, help_text='Select the attribute visibility setting. Attributes can be shown on the product detail page or can be used to enhance product search results.', verbose_name='visibility mode'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='basket',
            name='currency',
            field=E-Commerce.core.fields.CurrencyField(max_length=4, verbose_name='currency'),
        ),
        migrations.AlterField(
            model_name='basket',
            name='customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customer_core_baskets', to='E-Commerce.Contact', verbose_name='customer'),
        ),
        migrations.AlterField(
            model_name='basket',
            name='data',
            field=E-Commerce.core.fields.TaggedJSONField(verbose_name='data'),
        ),
        migrations.AlterField(
            model_name='basket',
            name='deleted',
        ...
        migrations.AlterField(
            model_name='basket',
            name='key',
            field=models.CharField(db_index=True, default=E-Commerce.core.models._basket.generate_key, max_length=32, unique=True, verbose_name='key'),
        ),
        migrations.AlterField(
            model_name='basket',
            name='orderer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='orderer_core_baskets', to='E-Commerce.PersonContact', verbose_name='orderer'),
        ),
        migrations.AlterField(
            model_name='basket',
            name='persistent',
        ...
        migrations.AlterField(
            model_name='basket',
            name='products',
            field=models.ManyToManyField(blank=True, to='E-Commerce.Product', verbose_name='products'),
        ),
        migrations.AlterField(
            model_name='basket',
            name='shop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='E-Commerce.Shop', verbose_name='shop'),
        ),
        migrations.AlterField(
            model_name='basket',
            name='taxful_total_price_value',
            field=E-Commerce.core.fields.MoneyValueField(blank=True, decimal_places=9, default=0, max_digits=36, null=True, verbose_name='taxful total price'),
        ),
        migrations.AlterField(
            model_name='basket',
            name='taxless_total_price_value',
            field=E-Commerce.core.fields.MoneyValueField(blank=True, decimal_places=9, default=0, max_digits=36, null=True, verbose_name='taxless total price'),
        ),
        migrations.AlterField(
            model_name='basket',
            name='title',
        ...
        migrations.AlterField(
            model_name='category',
            name='parent',
            field=mptt.fields.TreeForeignKey(blank=True, help_text='If your category is a sub-category of another category, you can link them here.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='E-Commerce.Category', verbose_name='parent category'),
        ),
        migrations.AlterField(
            model_name='category',
            name='shops',
            field=models.ManyToManyField(blank=True, help_text='You can select which shops the category is visible in.', related_name='categories', to='E-Commerce.Shop', verbose_name='shops'),
        ),
        migrations.AlterField(
            model_name='category',
            name='status',
            field=enumfields.fields.EnumIntegerField(db_index=True, default=1, enum=E-Commerce.core.models.CategoryStatus, help_text='Here you can choose whether or not you want the category to be visible in your store.', verbose_name='status'),
        ),
        migrations.AlterField(
            model_name='category',
            name='visibility',
            field=enumfields.fields.EnumIntegerField(db_index=True, default=1, enum=E-Commerce.core.models.CategoryVisibility, help_text='You can choose to limit who sees your category based on whether they are logged in or if they are  part of a customer group.', verbose_name='visibility limitations'),
        ),
        migrations.AlterField(
            model_name='category',
            name='visibility_groups',
            field=models.ManyToManyField(blank=True, help_text='Select the customer groups you would like to be able to see the category. These groups are defined in Contacts Settings - Contact Groups.', related_name='visible_categories', to='E-Commerce.ContactGroup', verbose_name='visible for groups'),
        ),
        migrations.AlterField(
            model_name='category',
        ...
        migrations.AlterField(
            model_name='contact',
            name='merchant_notes',
            field=models.TextField(blank=True, help_text='Enter any private notes for this customer that are only accessible in E-Commerce admin.', verbose_name='merchant notes'),
        ),
        migrations.AlterField(
            model_name='contact',
            name='modified_on',
        ...
        migrations.AlterField(
            model_name='contact',
            name='shops',
            field=models.ManyToManyField(blank=True, help_text='Inform which shops have access to this contact.', to='E-Commerce.Shop', verbose_name='shops'),
        ),
        migrations.AlterField(
            model_name='contact',
            name='suffix',
        ...
        migrations.AlterField(
            ...
            field=E-Commerce.core.fields.QuantityField(decimal_places=9, default=1, help_text='Value to use when displaying unit prices.  E.g. if the display unit is g and the comparison value is 100, then unit prices are shown per 100g, like: $2.95 per 100g.', max_digits=36, validators=[E-Commerce.core.models._units.validate_positive_not_zero], verbose_name='comparison value'),
        ),
        migrations.AlterField(
            model_name='displayunit',
            name='decimals',
        ...
        migrations.AlterField(
            model_name='displayunit',
            name='internal_unit',
            field=models.ForeignKey(help_text='The sales unit that this display unit is linked to.', on_delete=django.db.models.deletion.CASCADE, related_name='display_units', to='E-Commerce.SalesUnit', verbose_name='internal unit'),
        ),
        migrations.AlterField(
            model_name='displayunit',
            name='ratio',
            field=E-Commerce.core.fields.QuantityField(decimal_places=9, default=1, help_text='Size of the display unit in internal unit.  E.g. if internal unit is kilogram and display unit is gram, ratio is 0.001.', max_digits=36, validators=[E-Commerce.core.models._units.validate_positive_not_zero], verbose_name='ratio'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='price_value',
            field=E-Commerce.core.fields.MoneyValueField(decimal_places=9, help_text='The fixed cost to apply to this service.', max_digits=36),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='groups',
            field=models.ManyToManyField(help_text='The contact groups for which this service is available.', to='E-Commerce.ContactGroup', verbose_name='groups'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=E-Commerce.core.fields.MoneyValueField(blank=True, decimal_places=9, max_digits=36, null=True, verbose_name='max price value'),
        ),
        migrations.AlterField(
            model_name='ordertotallimitbehaviorcomponent',
            name='min_price_value',
            field=E-Commerce.core.fields.MoneyValueField(blank=True, decimal_places=9, max_digits=36, null=True, verbose_name='min price value'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='paymentmethod',
            name='shop',
            field=models.ForeignKey(help_text='The shop for this service.', on_delete=django.db.models.deletion.CASCADE, to='E-Commerce.Shop', verbose_name='shop'),
        ),
        migrations.AlterField(
            model_name='paymentmethod',
            name='tax_class',
            field=models.ForeignKey(help_text='The tax class to use for this service. Tax classes are defined in Settings - Tax Classes.', on_delete=django.db.models.deletion.PROTECT, to='E-Commerce.TaxClass', verbose_name='tax class'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='personcontact',
            name='gender',
            field=enumfields.fields.EnumField(default='u', enum=E-Commerce.core.models.Gender, help_text='The gender of the contact.', max_length=4, verbose_name='gender'),
        ),
        migrations.AlterField(
            model_name='personcontact',
            name='last_name',
        ...
        migrations.AlterField(
            model_name='product',
            name='depth',
            field=E-Commerce.core.fields.MeasurementField(decimal_places=9, default=0, help_text='Set the measured depth or length of your product or product packaging. This will provide customers with your product size and help with calculating shipping costs.', max_digits=36, unit='mm', verbose_name='depth (mm)'),
        ),
        migrations.AlterField(
            model_name='product',
            name='gross_weight',
            field=E-Commerce.core.fields.MeasurementField(decimal_places=9, default=0, help_text='Set the measured gross Weight of your product WITH its packaging. This will help with calculating shipping costs.', max_digits=36, unit='g', verbose_name='gross weight (g)'),
        ),
        migrations.AlterField(
            model_name='product',
            name='gtin',
        ...
        migrations.AlterField(
            model_name='product',
            name='height',
            field=E-Commerce.core.fields.MeasurementField(decimal_places=9, default=0, help_text='Set the measured height of your product or product packaging. This will provide customers with your product size and help with calculating shipping costs.', max_digits=36, unit='mm', verbose_name='height (mm)'),
        ),
        migrations.AlterField(
            model_name='product',
            name='manufacturer',
            field=models.ForeignKey(blank=True, help_text='Select a manufacturer for your product. These are defined in Products Settings - Manufacturers', null=True, on_delete=django.db.models.deletion.PROTECT, to='E-Commerce.Manufacturer', verbose_name='manufacturer'),
        ),
        migrations.AlterField(
            model_name='product',
            name='net_weight',
            field=E-Commerce.core.fields.MeasurementField(decimal_places=9, default=0, help_text='Set the measured weight of your product WITHOUT its packaging. This will provide customers with your product weight.', max_digits=36, unit='g', verbose_name='net weight (g)'),
        ),
        migrations.AlterField(
            model_name='product',
            name='sales_unit',
            field=models.ForeignKey(blank=True, help_text='Select a sales unit for your product. This is shown in your store front and is used to determine whether the product can be purchased using fractional amounts. Sales units are defined in Products - Sales Units.', null=True, on_delete=django.db.models.deletion.PROTECT, to='E-Commerce.SalesUnit', verbose_name='sales unit'),
        ),
        migrations.AlterField(
            model_name='product',
            name='shipping_mode',
            field=enumfields.fields.EnumIntegerField(default=1, enum=E-Commerce.core.models.ShippingMode, help_text='Set to shipped if the product requires shipment.', verbose_name='shipping mode'),
        ),
        migrations.AlterField(
            model_name='product',
            name='sku',
        ...
        migrations.AlterField(
            model_name='product',
            name='stock_behavior',
            field=enumfields.fields.EnumIntegerField(default=0, enum=E-Commerce.core.models.StockBehavior, help_text='Set to stocked if inventory should be managed within E-Commerce.', verbose_name='stock'),
        ),
        migrations.AlterField(
            model_name='product',
            name='tax_class',
            field=models.ForeignKey(help_text='Select a tax class for your product. The tax class is used to determine which taxes to apply to your product. Tax classes are defined in Settings - Tax Classes. The rules by which taxes are applied are defined in Settings - Tax Rules.', on_delete=django.db.models.deletion.PROTECT, to='E-Commerce.TaxClass', verbose_name='tax class'),
        ),
        migrations.AlterField(
            model_name='product',
            name='type',
            field=models.ForeignKey(help_text='Select a product type for your product. These allow you to configure custom attributes to help with classification and analysis.', on_delete=django.db.models.deletion.PROTECT, related_name='products', to='E-Commerce.ProductType', verbose_name='product type'),
        ),
        migrations.AlterField(
            model_name='product',
            name='width',
            field=E-Commerce.core.fields.MeasurementField(decimal_places=9, default=0, help_text='Set the measured width of your product or product packaging. This will provide customers with your product size and help with calculating shipping costs.', max_digits=36, unit='mm', verbose_name='width (mm)'),
        ),
        migrations.AlterField(
            model_name='productmedia',
            name='kind',
            field=enumfields.fields.EnumIntegerField(db_index=True, default=1, enum=E-Commerce.core.models.ProductMediaKind, help_text='Select what type the media is. It can either be a normal file, part of the documentation, or a sample.', verbose_name='kind'),
        ),
        migrations.AlterField(
            model_name='productmedia',
            name='ordering',
        ...
        migrations.AlterField(
            model_name='productmedia',
            name='shops',
            field=models.ManyToManyField(help_text='Select which shops you would like the product media to be visible in.', related_name='product_media', to='E-Commerce.Shop', verbose_name='shops'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='attributes',
            field=models.ManyToManyField(blank=True, help_text='Select attributes that go with your product type. These are defined in Products Settings – Attributes.', related_name='product_types', to='E-Commerce.Attribute', verbose_name='attributes'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='shop',
            name='currency',
            field=E-Commerce.core.fields.CurrencyField(default=E-Commerce.core.models._shops._get_default_currency, help_text='The primary shop currency. This is the currency used when selling your products.', max_length=4, verbose_name='currency'),
        ),
        migrations.AlterField(
            model_name='shop',
            name='domain',
        ...
        migrations.AlterField(
            model_name='shop',
            name='status',
            field=enumfields.fields.EnumIntegerField(default=0, enum=E-Commerce.core.models.ShopStatus, help_text='Your shop status. Disable your shop if it is no longer in use.', verbose_name='status'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='backorder_maximum',
            field=E-Commerce.core.fields.QuantityField(blank=True, decimal_places=9, default=0, help_text='The number of units that can be purchased after the product is out of stock. Set to blank for product to be purchasable without limits.', max_digits=36, null=True, verbose_name='backorder maximum'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='categories',
            field=models.ManyToManyField(blank=True, help_text='Add secondary categories for your product. These are other categories that your product fits under and that it can be found by in your store.', related_name='shop_products', to='E-Commerce.Category', verbose_name='categories'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='default_price_value',
            field=E-Commerce.core.fields.MoneyValueField(blank=True, decimal_places=9, help_text='This is the default individual base unit (or multi-pack) price of the product. All discounts or coupons will be based off of this price.', max_digits=36, null=True, verbose_name='default price'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='display_unit',
            field=models.ForeignKey(blank=True, help_text='Unit for displaying quantities of this product', null=True, on_delete=django.db.models.deletion.CASCADE, to='E-Commerce.DisplayUnit', verbose_name='display unit'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
        ...
        migrations.AlterField(
            ...
            field=E-Commerce.core.fields.MoneyValueField(blank=True, decimal_places=9, help_text='This is the default price that the product cannot go under in your store, despite coupons or discounts being applied. This is useful to make sure your product price stays above cost.', max_digits=36, null=True, verbose_name='minimum price'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='minimum_purchase_quantity',
            field=E-Commerce.core.fields.QuantityField(decimal_places=9, default=1, help_text='Set a minimum number of products needed to be ordered for the purchase. This is useful for setting bulk orders and B2B purchases.', max_digits=36, verbose_name='minimum purchase'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='payment_methods',
            field=models.ManyToManyField(blank=True, help_text='Select the payment methods you would like to limit the product to using. These are defined in Settings - Payment Methods.', related_name='payment_products', to='E-Commerce.PaymentMethod', verbose_name='payment methods'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='primary_category',
            field=models.ForeignKey(blank=True, help_text='Choose the primary category for your product. This will be the main category for classification in the system. Your product can be found under this category in your store. Categories are defined in Products Settings - Categories.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='primary_shop_products', to='E-Commerce.Category', verbose_name='primary category'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='purchase_multiple',
            field=E-Commerce.core.fields.QuantityField(decimal_places=9, default=0, help_text='Set this if the product needs to be purchased in multiples. For example, if the purchase multiple is set to 2, then customers are required to order the product in multiples of 2.', max_digits=36, verbose_name='purchase multiple'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='shipping_methods',
            field=models.ManyToManyField(blank=True, help_text='Select the shipping methods you would like to limit the product to using. These are defined in Settings - Shipping Methods.', related_name='shipping_products', to='E-Commerce.ShippingMethod', verbose_name='shipping methods'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='shop_primary_image',
            field=models.ForeignKey(blank=True, help_text='Click this to set this image as the primary display image for your product.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='primary_image_for_shop_products', to='E-Commerce.ProductMedia', verbose_name='primary image'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='suppliers',
            field=models.ManyToManyField(blank=True, help_text='List your suppliers here. Suppliers can be found in Product Settings - Suppliers.', related_name='shop_products', to='E-Commerce.Supplier', verbose_name='suppliers'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='visibility',
            field=enumfields.fields.EnumIntegerField(db_index=True, default=3, enum=E-Commerce.core.models.ShopProductVisibility, help_text='Select if you want your product to be seen and found by customers. <p>Not visible: Product will not be shown in your store front or found in search.</p><p>Searchable: Product will be shown in search but not listed on any category page.</p><p>Listed: Product will be shown on category pages but not shown in search results.</p><p>Always Visible: Product will be shown in your store front and found in search.</p>', verbose_name='visibility'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='visibility_groups',
            field=models.ManyToManyField(blank=True, help_text='Select the groups you would like to make your product visible for. These groups are defined in Contacts Settings - Contact Groups.', related_name='visible_products', to='E-Commerce.ContactGroup', verbose_name='visible for groups'),
        ),
        migrations.AlterField(
            model_name='shopproduct',
            name='visibility_limit',
            field=enumfields.fields.EnumIntegerField(db_index=True, default=1, enum=E-Commerce.core.models.ProductVisibility, help_text='Select whether you want your product to have special limitations on its visibility in your store. You can make products visible to all, visible to only logged in users, or visible only to certain customer groups.', verbose_name='visibility limitations'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='supplier',
            name='shops',
            field=models.ManyToManyField(blank=True, help_text='You can select which shops the supplier is available to.', related_name='suppliers', to='E-Commerce.Shop', verbose_name='shops'),
        ),
        migrations.AlterField(
            model_name='supplier',
            name='stock_managed',
        ...
        migrations.AlterField(
            model_name='supplier',
            name='type',
            field=enumfields.fields.EnumIntegerField(default=1, enum=E-Commerce.core.models.SupplierType, help_text='The supplier type indicates whether the products are supplied through an internal supplier or an external supplier.', verbose_name='supplier type'),
        ),
        migrations.AlterField(
            model_name='tax',
            name='enabled',
        ...
        migrations.AlterField(
            ...
            name='price_value',
            field=E-Commerce.core.fields.MoneyValueField(decimal_places=9, help_text='The cost to apply to this service if the total price is below the waive limit.', max_digits=36),
        ),
        migrations.AlterField(
            model_name='waivingcostbehaviorcomponent',
            name='waive_limit_value',
            field=E-Commerce.core.fields.MoneyValueField(decimal_places=9, help_text='The total price of products at which this service cost is waived.', max_digits=36),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='max_value',
            field=E-Commerce.core.fields.MeasurementField(blank=True, decimal_places=9, default=0, help_text='The maximum weight, in grams, before this price no longer applies.', max_digits=36, null=True, unit='g', verbose_name='max weight (g)'),
        ),
        migrations.AlterField(
            model_name='weightbasedpricerange',
            name='min_value',
            field=E-Commerce.core.fields.MeasurementField(blank=True, decimal_places=9, default=0, help_text='The minimum weight, in grams, for this price to apply.', max_digits=36, null=True, unit='g', verbose_name='min weight (g)'),
        ),
        migrations.AlterField(
            model_name='weightbasedpricerange',
            name='price_value',
            field=E-Commerce.core.fields.MoneyValueField(decimal_places=9, help_text='The cost to apply to this service when the weight criteria is met.', max_digits=36),
        ),
        migrations.AlterField(
