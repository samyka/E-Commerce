...
from E-Commerce.core.models import PersonContact, Shop
from E-Commerce.gdpr.models import GDPRSettings
from E-Commerce.gdpr.utils import ensure_gdpr_privacy_policy, \
    create_initial_required_cookie_category, is_documents_consent_in_sync
from E-Commerce.gdpr.views import GDPRCookieConsentView, GDPRPolicyConsentView
