    ...
    def get_form_defs(self):
        ...
        return [
            TemplatedWizardFormDef(
                name=self.base_name,
                template_name="E-Commerce/admin/service_providers/_wizard_service_provider_base_form.jinja",
                extra_js="E-Commerce/admin/service_providers/_wizard_script.jinja",
...
class CarrierWizardPane(ServiceWizardFormPartMixin, WizardPane):
    ...
    icon = "E-Commerce_admin/img/shipping.png"
...
class PaymentWizardPane(ServiceWizardFormPartMixin, WizardPane):
    ...
    icon = "E-Commerce_admin/img/payment.png"
