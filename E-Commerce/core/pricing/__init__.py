...
"""
E-Commerce modular product pricing functionality.

The pricing module in use is declared by the
:obj:`~E-Commerce.core.settings.E-Commerce_PRICING_MODULE` setting.  The
default is a pricing module that always prices everything to be free.
The base distribution contains :obj:`E-Commerce.customer_group_pricing`, which is an
...
(:class:`~E-Commerce.core.models.Product` objects contain the
convenience methods
:func:`~E-Commerce.core.models.Product.get_price_info`,
:func:`~E-Commerce.core.models.Product.get_price`,
and :func:`~E-Commerce.core.models.Product.get_base_price`
