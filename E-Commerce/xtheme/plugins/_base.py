...
from E-Commerce.utils.text import space_case
...
class Plugin(object):
    """
    A plugin that can be instantiated within a `E-Commerce.xtheme.layout.LayoutCell`.
    ...
    def get_translated_value(self, key, default=None, language=None):
        ...
        This is the protocol that `E-Commerce.xtheme.plugins.forms.TranslatableField` uses.
