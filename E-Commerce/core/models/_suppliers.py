...
from E-Commerce.core.modules import ModuleInterface
from E-Commerce.utils.analog import define_log_model

from ._base import TranslatableE-CommerceModel
...
class Supplier(ModuleInterface, TranslatableE-CommerceModel):
    default_module_spec = "E-Commerce.core.suppliers:BaseSupplierModule"
    ...
    def get_orderability_errors(self, shop_product, quantity, customer):
        ...
        :type shop_product: E-Commerce.core.models.ShopProduct
        :param quantity: Quantity to order
        :type quantity: decimal.Decimal
        :param contect: Ordering contact.
        :type contect: E-Commerce.core.models.Contact
    ...
    def get_stock_statuses(self, product_ids):
        ...
        :rtype: dict[int, E-Commerce.core.stocks.ProductStockStatus]
        """
    ...
    def get_stock_status(self, product_id):
        ...
        :type product_id: int
        :rtype: E-Commerce.core.stocks.ProductStockStatus
        """
