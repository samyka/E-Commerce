...
from E-Commerce.core.models import get_company_contact, get_person_contact, SavedAddress
from E-Commerce.testing.factories import get_address, get_default_shop
...
def test_addressbook_no_address(regular_user):
    ...
    addressbook_url = reverse("E-Commerce:address_book")
...
def test_addressbook_addresses_create_and_edit(regular_user):
    ...
    new_address_url = reverse("E-Commerce:address_book_new")
    ...
    edit_url = reverse("E-Commerce:address_book_edit", kwargs={"pk": sa.pk})
...
def delete_address(regular_user):
    ...
    delete_url = reverse("E-Commerce:address_book_delete", kwargs={"pk":sa.pk})
