...
from E-Commerce.admin.utils.picotable import Column, DateRangeFilter, TextFilter
from E-Commerce.admin.utils.views import CreateOrUpdateView, PicotableListView
from E-Commerce.discounts.models import AvailabilityException, Discount
...
class AvailabilityExceptionEditView(CreateOrUpdateView):
    ...
    def get_toolbar(self):
        ...
        delete_url = (
            reverse_lazy("E-Commerce_admin:discounts_availability_exception.delete", kwargs={"pk": object.pk})
...
class AvailabilityExceptionDeleteView(DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return HttpResponseRedirect(reverse_lazy("E-Commerce_admin:discounts_availability_exception.list"))
