...
class TaxModule(AdminModule):
    ...
    def get_menu_entries(self, request):
        ...
        return [
            ...
            MenuEntry(
                ...
                icon="fa fa-pie-chart",
                url="E-Commerce_admin:customer_tax_group.list",
                category=category,
                ordering=2
            ),
            MenuEntry(
                text=_("Tax Classes"),
                icon="fa fa-pie-chart",
                url="E-Commerce_admin:tax_class.list",
                category=category,
                ordering=3
            )
        ]
    ...
    def get_model_url(self, object, kind, shop=None):
        return (
            derive_model_url(Tax, "E-Commerce_admin:tax", object, kind) or
            derive_model_url(TaxClass, "E-Commerce_admin:tax_class", object, kind) or
            derive_model_url(CustomerTaxGroup, "E-Commerce_admin:customer_tax_group", object, kind)
        )
