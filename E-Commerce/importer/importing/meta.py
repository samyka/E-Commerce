...
from E-Commerce.importer.utils import get_global_aliases
...
class ImportMetaBase(object):
    ...
    This is dictionary that contains list of values:
        {E-Commerce_field: [expected_fields]}
    ...
    def presave_hook(self, row_session):
        ...
        :type row_session: E-Commerce.importer.importing.session.DataImporterRowSession
        :return: None
        """
        pass
