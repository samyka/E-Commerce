...
from E-Commerce.core import telemetry


class TelemetryView(TemplateView):
    template_name = "E-Commerce/admin/system/telemetry.jinja"
    ...
    def get_form_defs(self):
        ...
        form_defs.append(
            TemplatedWizardFormDef(
                ...
                template_name="E-Commerce/admin/system/telemetry_wizard.jinja",
