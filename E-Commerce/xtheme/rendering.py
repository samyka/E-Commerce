...
from E-Commerce.core.fields.tagged_json import TaggedJSONEncoder
from E-Commerce.xtheme._theme import get_current_theme
from E-Commerce.xtheme.editing import is_edit_mode, may_inject
from E-Commerce.xtheme.layout.utils import get_layout_data_key
from E-Commerce.xtheme.utils import get_html_attrs
from E-Commerce.xtheme.view_config import ViewConfig
...
class PlaceholderRenderer(object):
    ...
    def _render_row(self, write, layout, y, row):
        ...
        :type row: E-Commerce.xtheme.view_config.LayoutRow
        """
        row_attrs = {
    ...
    def _render_cell(self, write, layout, x, cell):
        ...
        :type x: int
        :param cell: Cell
        :type cell: E-Commerce.xtheme.view_config.LayoutCell
        """
        classes = ["xt-ph-cell"]
