...
from E-Commerce.admin.modules.services.base_form_part import (
    PaymentMethodBaseFormPart, ShippingMethodBaseFormPart
)
from E-Commerce.admin.modules.services.behavior_form_part import \
...
class ServiceEditView(SaveFormPartsMixin, FormPartsViewMixin, CreateOrUpdateView):
    ...
    template_name = "E-Commerce/admin/services/edit.jinja"
