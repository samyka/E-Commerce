...
from E-Commerce.api.permissions import PermissionLevel
...
def test_reset_authenticated_user_password(admin_user):
    ...
    response = client.post("/api/E-Commerce/front/password/", content_type="application/json", data=data)
...
def test_reset_password_request(admin_user):
    ...
    response = client.post(
        "/api/E-Commerce/front/password/reset/",
        content_type="application/json",
