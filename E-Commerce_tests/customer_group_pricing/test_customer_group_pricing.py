...
from E-Commerce.core.models import AnonymousContact, ContactGroup
from E-Commerce.core.pricing import get_pricing_module
from E-Commerce.core.utils.price_cache import get_cached_price_info, cache_price_info
from E-Commerce.customer_group_pricing.models import CgpDiscount, CgpPrice
from E-Commerce.customer_group_pricing.module import CustomerGroupPricingModule
...
pytestmark = pytest.mark.skipif("E-Commerce.customer_group_pricing" not in settings.INSTALLED_APPS,
                                reason="customer_group_pricing not installed")

original_pricing_module = settings.E-Commerce_PRICING_MODULE


def setup_module(module):
    settings.E-Commerce_PRICING_MODULE = "customer_group_pricing"


def teardown_module(module):
    settings.E-Commerce_PRICING_MODULE = original_pricing_module
