...
class ProductTypeModule(AdminModule):
    ...
    breadcrumbs_menu_entry = MenuEntry(name, url="E-Commerce_admin:product_type.list")
    ...
    def get_menu_entries(self, request):
        return [
            MenuEntry(
                ...
                icon="fa fa-asterisk",
                url="E-Commerce_admin:product_type.list",
    ...
    def get_model_url(self, object, kind, shop=None):
        return derive_model_url(ProductType, "E-Commerce_admin:product_type", object, kind)
