...
from E-Commerce.testing.themes import E-CommerceTestingTheme
from E-Commerce.testing.themes.plugins import HighlightTestPlugin
from E-Commerce.xtheme import templated_plugin_factory, TemplatedPlugin
from E-Commerce.xtheme.testing import override_current_theme_class
from E-Commerce_tests.utils import printable_gibberish
from E-Commerce_tests.xtheme.utils import get_jinja2_engine, plugin_override


def test_plugin_choices():
    with plugin_override():
        theme = E-CommerceTestingTheme(shop=get_default_shop())
