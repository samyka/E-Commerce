...
from E-Commerce.core.fields import MoneyValueField, QuantityField
...
from E-Commerce.utils.properties import PriceProperty
...
def _get_currency():
    ...
    return settings.E-Commerce_HOME_CURRENCY
...
class StockAdjustment(models.Model):
    product = models.ForeignKey(
        "E-Commerce.Product", related_name="stock_adjustments", on_delete=models.CASCADE, verbose_name=_("product"))
    supplier = models.ForeignKey("E-Commerce.Supplier", on_delete=models.CASCADE, verbose_name=_("supplier"))
...
class StockCount(models.Model):
    ...
    product = models.ForeignKey(
        "E-Commerce.Product", related_name="simple_supplier_stock_count",
        editable=False, on_delete=models.CASCADE, verbose_name=_("product"))
    supplier = models.ForeignKey(
        "E-Commerce.Supplier", editable=False, on_delete=models.CASCADE, verbose_name=_("supplier"))
