...
from E-Commerce.core.models import get_company_contact_for_shop_staff
...
def stop_impersonating(request):
    ...
    login(request, user)
    return HttpResponseRedirect(reverse("E-Commerce_admin:user.detail", args=[auth_user_id]))
