...
from E-Commerce.admin.breadcrumbs import BreadcrumbedView
...
from E-Commerce.campaigns.admin_module.form_parts import (
...
from E-Commerce.campaigns.admin_module.forms import CouponForm
from E-Commerce.campaigns.admin_module.utils import get_formparts_for_provide_key
from E-Commerce.campaigns.models.campaigns import (
    BasketCampaign, CatalogCampaign, Coupon
)


class CampaignEditView(SaveFormPartsMixin, FormPartsViewMixin, CreateOrUpdateView):
    template_name = "E-Commerce/campaigns/admin/edit_campaigns.jinja"
...
class CatalogCampaignEditView(BreadcrumbedView, CampaignEditView):
    ...
    parent_url = "E-Commerce_admin:catalog_campaign.list"
...
class BasketCampaignEditView(BreadcrumbedView, CampaignEditView):
    ...
    parent_url = "E-Commerce_admin:basket_campaign.list"
...
class CouponEditView(BreadcrumbedView, CreateOrUpdateView):
    model = Coupon
    template_name = "E-Commerce/campaigns/admin/edit_coupons.jinja"
    form_class = CouponForm
    context_object_name = "coupon"
    add_form_errors_as_messages = True
    parent_name = _("Coupon")
    parent_url = "E-Commerce_admin:coupon.list"
