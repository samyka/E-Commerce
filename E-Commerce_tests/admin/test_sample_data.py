...
from E-Commerce.testing.modules.sample_data import manager
from E-Commerce.testing.modules.sample_data.data import BUSINESS_SEGMENTS
from E-Commerce.testing.modules.sample_data.forms import ConsolidateObjectsForm
from E-Commerce.testing.modules.sample_data.views import ConsolidateSampleObjectsView
from E-Commerce.admin.views.dashboard import DashboardView
from E-Commerce.admin.views.wizard import WizardView
from E-Commerce.core.models import AnonymousContact, Category, Product, Shop
from E-Commerce.front.apps.carousel.models import Carousel, Slide
...
def test_sample_data_wizard_pane(rf, admin_user, settings):
    settings.E-Commerce_SETUP_WIZARD_PANE_SPEC = [
        "E-Commerce.testing.modules.sample_data.views.SampleObjectsWizardPane"
    ]
