...
from E-Commerce.campaigns.utils.campaigns import get_total_price_of_products
from E-Commerce.core.fields import MoneyValueField
from E-Commerce.core.models import PolymorphicE-CommerceModel
from E-Commerce.core.pricing import PricingContext


class BasketDiscountEffect(PolymorphicE-CommerceModel):
    identifier = None
    model = None
