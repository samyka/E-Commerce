    ...
    def post(self, request):
        ...
        if script_template_class:
            ...
            if script_template.get_form():
                return redirect("E-Commerce_admin:notify.script-template-config", id=identifier)
            else:
                ...
                return redirect("E-Commerce_admin:notify.script.list")
        else:
...
class ScriptTemplateConfigView(FormView):
    ...
    success_url = "E-Commerce_admin:notify.script.list"
