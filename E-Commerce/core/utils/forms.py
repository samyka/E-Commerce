...
from E-Commerce.core.models import Contact, ImmutableAddress, MutableAddress
...
class MutableAddressForm(forms.ModelForm):
    ...
    def __init__(self, **kwargs):
        ...
        if not kwargs.get("instance"):
            # Set default country
            self.fields["country"].initial = settings.E-Commerce_ADDRESS_HOME_COUNTRY

        field_properties = settings.E-Commerce_ADDRESS_FIELD_PROPERTIES
...
class RecoverPasswordForm(forms.Form):
    ...
    subject_template_name = "E-Commerce/user/recover_password_mail_subject.jinja"
    email_template_name = "E-Commerce/user/recover_password_mail_content.jinja"
    from_email = None
    ...
    def process_user(self, user_to_recover):
        ...
        email.content_subtype = settings.E-Commerce_AUTH_EMAIL_CONTENT_SUBTYPE
        email.send()
        return True
