...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('E-Commerce_simple_cms', '0009_remove_page_page_type'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='page',
            name='template_name',
            field=models.TextField(default='E-Commerce/simple_cms/page.jinja', max_length=500, verbose_name='Template path'),
        ),
