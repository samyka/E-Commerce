...
from E-Commerce.core.models import ProductMedia
from E-Commerce.utils.dates import try_parse_datetime
from E-Commerce.utils.i18n import format_money, get_locally_formatted_datetime
from E-Commerce.utils.importing import load
from E-Commerce.utils.money import Money
from E-Commerce.utils.objects import compact
from E-Commerce.utils.serialization import ExtendedJSONEncoder
...
class PicotableViewMixin(object):
    ...
    related_objects = []
    template_name = "E-Commerce/admin/base_picotable.jinja"
...
class PicotableMassAction(object):
    ...
    Examples:
    * `E-Commerce.admin.modules.orders.mass_actions.CancelOrderAction`
    * `E-Commerce.admin.modules.products.mass_actions.VisibleMassAction`
    """
    label = _("Mass Action")
...
class PicotableFileMassAction(PicotableMassAction):
    ...
    Examples:
    * `E-Commerce.admin.modules.orders.mass_actions.OrderConfirmationPdfAction`
    * `E-Commerce.admin.modules.products.mass_actions.FileResponseAction`
    """
    def process(self, request, ids):
        """
...
class PicotableRedirectMassAction(PicotableMassAction):
    ...
    Examples:
    * `E-Commerce.admin.modules.contacts.mass_actions.EditContactsAction`
    * `E-Commerce.admin.modules.products.mass_actions.EditProductAttributesAction`
    """
    redirect_url = None
