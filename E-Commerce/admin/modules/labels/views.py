...
from E-Commerce.admin.utils.picotable import Column
...
class LabelForm(E-CommerceAdminForm):
    class Meta:
        model = Label
        exclude = ()
...
class LabelEditView(CreateOrUpdateView):
    ...
    template_name = "E-Commerce/admin/labels/edit.jinja"
    context_object_name = "label"

    def get_toolbar(self):
        object = self.get_object()
        delete_url = (
            reverse_lazy("E-Commerce_admin:label.delete", kwargs={"pk": object.pk})
...
class LabelDeleteView(DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return HttpResponseRedirect(reverse_lazy("E-Commerce_admin:label.list"))
