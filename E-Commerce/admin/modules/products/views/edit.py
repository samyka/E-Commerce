...
class ProductBaseFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            "base",
            ProductBaseForm,
            template_name="E-Commerce/admin/products/_edit_base_form.jinja",
            required=True,
            kwargs={
        ...
        yield TemplatedFormDef(
            "base_extra",
            forms.Form,
            template_name="E-Commerce/admin/products/_edit_extra_base_form.jinja",
            required=False
        )
...
class ShopProductFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            "shop%d" % self.shop.pk,
            ShopProductForm,
            template_name="E-Commerce/admin/products/_edit_shop_form.jinja",
            required=True,
            kwargs={
        ...
        yield TemplatedFormDef(
            ...
            forms.Form,
            template_name="E-Commerce/admin/products/_edit_extra_shop_form.jinja",
            required=False
        )
...
class ProductAttributeFormPart(FormPart):
    ...
    def get_form_defs(self):
        ...
        yield TemplatedFormDef(
            ...
            template_name="E-Commerce/admin/products/_edit_attribute_form.jinja",
            required=False,
...
class BaseProductMediaFormPart(FormPart):
    def get_form_defs(self):
        ...
        yield TemplatedFormDef(
            self.name,
            self.formset,
            template_name="E-Commerce/admin/products/_edit_media_form.jinja",
            required=False,
...
class ProductEditView(SaveFormPartsMixin, FormPartsViewMixin, CreateOrUpdateView):
    ...
    template_name = "E-Commerce/admin/products/edit.jinja"
