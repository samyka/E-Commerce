...
from E-Commerce.admin.modules.products.views.list import ProductListView
...
from E-Commerce.core.models import ShopProduct, ShopProductVisibility
...
class EditProductAttributesAction(PicotableRedirectMassAction):
    ...
    redirect_url = reverse("E-Commerce_admin:shop_product.mass_edit")
