...
class AdminFieldRenderer(FieldRenderer):
    ...
    def append_to_field(self, html):
        ...
        edit_button = template_loader.render_to_string("E-Commerce/admin/forms/widgets/edit_button.jinja", {"field": self})
        help_text = template_loader.render_to_string("E-Commerce/admin/forms/widgets/help_text.jinja", {"field": self})
