...
from E-Commerce.order_printouts.utils import PrintoutDeliveryExtraInformation
from E-Commerce.order_printouts.admin_module.views import (
...
def test_adding_extra_fields_to_the_delivery(rf):
    ...
    with override_provides("order_printouts_delivery_extra_fields", [
        "E-Commerce_tests.order_printouts.test_printouts:PrintoutTestDeliveryExtraFields",
    ]):
