...
from E-Commerce.front.providers import (
    FormDefinition, FormDefProvider, FormFieldDefinition, FormFieldProvider
)
from E-Commerce.gdpr.forms import CompanyAgreementForm
...
def get_gdpr_settings(request):
    if not has_installed("E-Commerce.gdpr") or not request:
        return None
    ...
    def get_fields(self, **kwargs):
        ...
        for page in get_active_consent_pages(request.shop):
            ...
            field = forms.BooleanField(
                ...
                ).format(reverse("E-Commerce:cms_page", kwargs=dict(url=page.url)), page.title)),
                required=True,
