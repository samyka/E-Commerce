...
from E-Commerce.testing.modules.sample_data.factories import (
    create_sample_carousel, create_sample_category, create_sample_product
)
from E-Commerce.testing.modules.sample_data.forms import (
...
from E-Commerce.core.models import Category, Product, Shop
...
class ConsolidateSampleObjectsView(FormView):
    ...
    template_name = "E-Commerce/admin/sample_data/consolidate_samples.jinja"
    ...
    def form_valid(self, form):
        ...
        # uninstall carousel
        if 'E-Commerce.front.apps.carousel' in settings.INSTALLED_APPS and \
        ...
        return HttpResponseRedirect(reverse("E-Commerce_admin:dashboard"))
    ...
    def get_form_defs(self):
        return [
            TemplatedWizardFormDef(
                ...
                template_name="E-Commerce/admin/sample_data/wizard.jinja",
                kwargs={
                    "shop": self.object
                }
            )
