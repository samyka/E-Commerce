...
from E-Commerce.core.models import AnonymousContact, Shipment, ShopProductVisibility
...
from E-Commerce.testing.receivers import shop_product_orderability_check
