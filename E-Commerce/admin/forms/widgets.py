...
from E-Commerce.admin.utils.forms import flatatt_filter
from E-Commerce.admin.utils.urls import get_model_url, NoModelUrl
...
class FileDnDUploaderWidget(Widget):
    def __init__(self, attrs=None, kind=None, upload_path="/", clearable=False,
        ...
        if not upload_url:
            upload_url = reverse_lazy("E-Commerce_admin:media.upload")
...
class QuickAddSupplierMultiSelect(QuickAddRelatedObjectMultiSelect):
    url = reverse_lazy("E-Commerce_admin:supplier.new")
    model = "E-Commerce.Supplier"


class QuickAddCategoryMultiSelect(QuickAddRelatedObjectMultiSelect):
    url = reverse_lazy("E-Commerce_admin:category.new")
    model = "E-Commerce.Category"
...
class QuickAddProductTypeSelect(QuickAddRelatedObjectSelect):
    url = reverse_lazy("E-Commerce_admin:product_type.new")
    model = "E-Commerce.ProductType"


class QuickAddTaxGroupSelect(QuickAddRelatedObjectSelect):
    url = reverse_lazy("E-Commerce_admin:customer_tax_group.new")
    model = "E-Commerce.CustomerTaxGroup"


class QuickAddTaxClassSelect(QuickAddRelatedObjectSelect):
    url = reverse_lazy("E-Commerce_admin:tax_class.new")


class QuickAddSalesUnitSelect(QuickAddRelatedObjectSelect):
    url = reverse_lazy("E-Commerce_admin:sales_unit.new")


class QuickAddDisplayUnitSelect(QuickAddRelatedObjectSelect):
    url = reverse_lazy("E-Commerce_admin:display_unit.new")


class QuickAddManufacturerSelect(QuickAddRelatedObjectSelect):
    url = reverse_lazy("E-Commerce_admin:manufacturer.new")
    model = "E-Commerce.Manufacturer"


class QuickAddPaymentMethodsSelect(QuickAddRelatedObjectMultiSelect):
    url = reverse_lazy("E-Commerce_admin:payment_method.new")


class QuickAddShippingMethodsSelect(QuickAddRelatedObjectMultiSelect):
    url = reverse_lazy("E-Commerce_admin:shipping_method.new")


class QuickAddUserMultiSelect(QuickAddRelatedObjectMultiSelect):
    url = reverse_lazy("E-Commerce_admin:user.new")


class QuickAddContactGroupSelect(QuickAddRelatedObjectSelect):
    url = reverse_lazy("E-Commerce_admin:contact_group.new")
...
class QuickAddLabelMultiSelect(QuickAddRelatedObjectMultiSelect):
    url = reverse_lazy("E-Commerce_admin:label.new")
