...
class ShippingMethodModule(ServiceModule):
    ...
    view_template = "E-Commerce.admin.modules.services.views.ShippingMethod%sView"
    name_template = "shipping_method.%s"
    menu_entry_url = "E-Commerce_admin:shipping_method.list"
    menu_ordering = 4
    url_name_prefix = "E-Commerce_admin:shipping_method"
    icon = "fa fa-truck"

    breadcrumbs_menu_entry = MenuEntry(text=name, url="E-Commerce_admin:shipping_method.list")
...
class PaymentMethodModule(ServiceModule):
    ...
    view_template = "E-Commerce.admin.modules.services.views.PaymentMethod%sView"
    name_template = "payment_method.%s"
    menu_entry_url = "E-Commerce_admin:payment_method.list"
    menu_ordering = 5
    url_name_prefix = "E-Commerce_admin:payment_method"
    icon = "fa fa-money"

    breadcrumbs_menu_entry = MenuEntry(text=name, url="E-Commerce_admin:payment_method.list")
