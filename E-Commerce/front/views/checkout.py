...
from E-Commerce.front.checkout import CheckoutProcess, VerticalCheckoutProcess
...
class BaseCheckoutView(View):
    url_namespace = 'E-Commerce:checkout'
    phase_specs = []
    ...
    def get_phase_url(self, phase):
        ...
        :type phase: E-Commerce.front.checkout.CheckoutPhaseViewMixin
        :rtype: str
        """
