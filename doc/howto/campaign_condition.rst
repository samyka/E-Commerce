...
When E-Commerce determines if a product should have a
discounted price, it looks for the
`DiscountModules <E-Commerce.core.pricing.DiscountModule>` in the system.
...
.. code-block:: python
    ...
    from E-Commerce.campaigns.models import ContextCondition
...
.. code-block:: python
    ...
    from E-Commerce.campaigns.admin_module.forms._base.BaseRuleModelForm
...
doesn't already exist. Like many things in E-Commerce, functionality can be
