...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('E-Commerce', '0048_contactgroup_pricedisplay'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shops', models.ManyToManyField(blank=True, to='E-Commerce.Shop', verbose_name='shops')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='discounts_coupon_usages', to='E-Commerce.Order')),
            ],
        ),
        migrations.CreateModel(
            name='Discount',
            fields=[
                ...
                ('identifier', E-Commerce.core.fields.InternalIdentifierField(blank=True, editable=False, max_length=64, null=True, unique=True)),
                ('created_on', models.DateTimeField(auto_now_add=True, verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, verbose_name='modified on')),
                ...
                ('discounted_price_value', E-Commerce.core.fields.MoneyValueField(blank=True, decimal_places=9, help_text='Discounted product price for this discount.', max_digits=36, null=True, verbose_name='discounted price')),
                ('discount_amount_value', E-Commerce.core.fields.MoneyValueField(blank=True, decimal_places=9, help_text='Discount amount value for this discount.', max_digits=36, null=True, verbose_name='discount amount')),
                ...
                ('category', models.ForeignKey(blank=True, help_text='Select category for this discount.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='category_discounts', to='E-Commerce.Category', verbose_name='category')),
                ('contact', models.ForeignKey(blank=True, help_text='Select contact for this discount.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contact_discounts', to='E-Commerce.Contact', verbose_name='contact')),
                ('contact_group', models.ForeignKey(blank=True, help_text='Select contact group for this discount.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contact_group_discounts', to='E-Commerce.ContactGroup', verbose_name='contact group')),
            ...
            bases=(models.Model, E-Commerce.utils.properties.MoneyPropped),
        ),
        migrations.CreateModel(
            name='HappyHour',
            fields=[
                ...
                ('shops', models.ManyToManyField(blank=True, db_index=True, to='E-Commerce.Shop', verbose_name='shops')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='discount',
            name='product',
            field=models.ForeignKey(blank=True, help_text='Select product for this discount.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_discounts', to='E-Commerce.Product', verbose_name='product'),
        ),
        migrations.AddField(
            model_name='discount',
            name='shops',
            field=models.ManyToManyField(blank=True, to='E-Commerce.Shop', verbose_name='shops'),
        ),
    ]
