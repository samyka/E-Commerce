...
from E-Commerce.admin.dashboard import DashboardContentBlock, get_activity
from E-Commerce.admin.menu import get_menu_entry_categories
from E-Commerce.admin.module_registry import (
...
from E-Commerce.testing.factories import get_default_shop, get_default_staff_user
from E-Commerce.testing.utils import apply_request_middleware
from E-Commerce.utils.excs import Problem
from E-Commerce_tests.admin.fixtures.test_module import ATestModule, ARestrictedTestModule
from E-Commerce_tests.utils import empty_iterable
from E-Commerce_tests.utils.faux_users import (
    AnonymousUser, AuthenticatedUser, StaffUser, SuperUser
)
from E-Commerce_tests.utils.templates import \
...
def test_module_loading_and_urls():
    with replace_modules([
        ATestModule,
        "E-Commerce_tests.admin.fixtures.test_module:ATestModule"
    ]):
...
def test_modules_in_core_admin_work(rf, admin_user):
    ...
    request = apply_request_middleware(rf.get("/"), user=admin_user)
    with replace_modules(E-CommerceAdminAppConfig.provides["admin_module"]):
