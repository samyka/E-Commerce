...
from E-Commerce.discounts.models import CouponCode, Discount
...
class CouponCodeEditView(CreateOrUpdateView):
    ...
    def get_toolbar(self):
        ...
        delete_url = (
            reverse_lazy("E-Commerce_admin:discounts_coupon_codes.delete", kwargs={"pk": object.pk})
...
class CouponCodeDeleteView(DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return HttpResponseRedirect(reverse_lazy("E-Commerce_admin:discounts_coupon_codes.list"))
