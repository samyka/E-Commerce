...
from E-Commerce.notify.script_template.generic import GenericSendEmailScriptTemplate
...
def generic_send_email_script_template_factory(identifier, event, name, description, help_text, initial=None):
    ...
    :param E-Commerce.notify.Event event: the event class which will be used to trigger the notification
