...
from E-Commerce.core.models import ProductVariationVariable, ProductVariationVariableValue, ProductMode
...
def test_variation_redirect(client):
    ...
    parent_url = reverse('E-Commerce:product', kwargs=dict(pk=parent.pk, slug=parent.slug))
